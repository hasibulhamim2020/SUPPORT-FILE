										...
										?>
											...
											$gr_tot_bank_pay+=$tot_bank_pay;
												...
												<th><?php echo $gr_tot_bank_pay;?></th>
												 ...
												 <?php  $tot_avail_rec_ho=$cash_opening_headoffice+$gr_tot_cash_ho_rec;
											$tot_avail_rec_fac=$cash_opening_factory+$gr_tot_cash_fac_rec; 
												  $tot_avail_rec_ctg=$cash_opening_ctg+$gr_tot_cash_ctg_rec; 
												 $tot_avail_rec_bank=$total_opening_bank+$gr_tot_bank_rec;
												 ?> 
