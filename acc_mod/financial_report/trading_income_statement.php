...
$title='Income Statement Trading';
...
$sql = "select l.acc_sub_sub_class, sum(j.cr_amt-j.dr_amt) as sales_amt from acc_sub_sub_class s, ledger_group l, accounts_ledger a, journal j
 where s.id=l.acc_sub_sub_class and l.group_id=a.ledger_group_id and a.ledger_id=j.ledger_id and  j.jv_date between '".$fdate."' and '".$tdate."' and l.group_id=311002 group by l.acc_sub_sub_class";
$query = db_query($sql);
...
$sql = "select a.ledger_group_id, sum(j.dr_amt-j.cr_amt) as cogs_amt_local
 from ledger_group l, accounts_ledger a, journal j 
 where l.group_id=a.ledger_group_id and a.ledger_id=j.ledger_id and j.jv_date between '".$fdate."' and '".$tdate."' and l.acc_sub_sub_class in (421) and l.group_id=315056";
$query = db_query($sql);
while($data=mysqli_fetch_object($query)){
$total_cogs_amt_local=$data->cogs_amt_local;
}

 
$total_cogs_amt= $total_cogs_amt_local;
...
$sql = "select l.acc_sub_sub_class, sum(j.cr_amt-j.dr_amt) as sales_amt from acc_sub_sub_class s, ledger_group l, accounts_ledger a, journal j
 where s.id=l.acc_sub_sub_class and l.group_id=a.ledger_group_id and a.ledger_id=j.ledger_id and  j.jv_date between '".$cfdate."' and '".$ctdate."' and l.group_id=311002 group by l.acc_sub_sub_class";
$query = db_query($sql);
while($data=mysqli_fetch_object($query)){
...
$sql = "select a.ledger_group_id, sum(j.dr_amt-j.cr_amt) as ls_consumption_amt
 from ledger_group l, accounts_ledger a, journal j 
 where l.group_id=a.ledger_group_id and a.ledger_id=j.ledger_id and j.jv_date between '".$cfdate."' and '".$ctdate."' and l.acc_sub_sub_class in (421) and l.group_id=315056";
$query = db_query($sql);
while($data=mysqli_fetch_object($query)){
$tot_cogs_amt_local=$data->ls_consumption_amt;
}
$material_cost_cmss=($rm_opening_cm+$purchase_amt_cm)-$rm_closing_cm;
$total_cogs_amt_cm=$tot_cogs_amt_local;
...
$sql1="select ss.id, ss.sub_sub_class_name,g.group_id from acc_sub_sub_class ss,ledger_group g where g.acc_sub_sub_class=ss.id and g.group_id=311002 and ss.acc_sub_class='".$info_sub1->id."' and ss.id=311  order by ss.id";
...
<td align="right"><a href="local_sales_details.php?show=show&fdate=<?=$_REQUEST['fdate']?>&tdate=<?=$_REQUEST['tdate']?>" target="_blank">
...
<tr> 
		 ...
		 <a href="financial_transaction_ledger.php?show=show&fdate=<?=$_REQUEST['fdate']?>&tdate=<?=$_REQUEST['tdate']?>&group_id=315056" target="_blank"><?=number_format($total_cogs_amt,2);?>	</a></td>
...
<?php
 ...
 $sql2="select ss.id, ss.sub_sub_class_name from acc_sub_sub_class ss where ss.acc_sub_class='".$info_sub2->id."'  and ss.id not in (315,4110,418) order by ss.id";
...
<?php
 ...
 $sql2="select ss.id, ss.sub_sub_class_name from acc_sub_sub_class ss where  ss.id in (418) order by ss.id";
...
?>
		 ...
		 <a href="financial_transaction_group.php?show=show&fdate=<?=$_REQUEST['fdate']?>&tdate=<?=$_REQUEST['tdate']?>&acc_sub_sub_class=<?=$data2->id?>" target="_blank">
		 <?=number_format($expenses_amt[$data2->id],2); $tot_finance_exp +=$expenses_amt[$data2->id];?></a></td>
									      <td align="right"><a href="financial_transaction_group.php?show=show&amp;fdate=<?=$_REQUEST['cfdate']?>&amp;tdate=<?=$_REQUEST['ctdate']?>&amp;acc_sub_sub_class=<?=$data2->id?>" target="_blank">
                                            <?=number_format($expenses_amt_cm[$data2->id],2); $tot_tot_finance_exp_cm +=$expenses_amt_cm[$data2->id];?>
									        </a></td>
									  </tr>
...
$sql1="select ss.id, ss.sub_sub_class_name from acc_sub_sub_class ss where id!=322 and ss.acc_sub_class=32  order by ss.id";
...
<?=number_format($sales_amt[$data1->id],2); $tot_finance_income +=$sales_amt[$data1->id];?></a></td>
									  <td align="right"><a href="financial_transaction_group.php?show=show&amp;fdate=<?=$_REQUEST['cfdate']?>&amp;tdate=<?=$_REQUEST['ctdate']?>&amp;acc_sub_sub_class=<?=$data1->id?>" target="_blank">
                                        <?=number_format($sales_amt_cm[$data1->id],2); $tot_finance_income_cm +=$sales_amt_cm[$data1->id];?>
									    </a></td>
									  </tr>
