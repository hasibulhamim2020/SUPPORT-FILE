  ...
  <tr>
    ...
    <td><div class="left_report">
		    ...
		    From Date :                                       </td>
                                        ...
                                        <td width="50%" align="left"> <input type="text" name="tdate" id="tdate"  value="<? if($_POST['tdate']!='') echo $_POST['tdate']; else echo date('Y-m-d')?>" />
...
$sql = "select a.ledger_group_id, sum(j.dr_amt-j.cr_amt) as opening_rm from ledger_group l, accounts_ledger a, journal j 
...
<?php
  ...
  $sql="select l.group_id, l.group_name from ledger_group l where l.acc_sub_sub_class=411 order by l.group_id";
