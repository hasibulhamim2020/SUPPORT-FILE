...
?>									<table id="grp" width="100%" border="1" cellspacing="0" cellpadding="0">
										...
										<tr>
										    ...
										    <th width="24%" align="center" bgcolor="#82D8CF" style="color:#000000;"><div align="center"><?=date("d M, Y",strtotime($_REQUEST['ctdate']))?></div></th>
										</tr>
										<tr>
...
<?=number_format($asset_amt[$data1->id],2); $tot_asset_amt +=$asset_amt[$data1->id];?></a></td>
									  <td align="right"><a href="financial_transaction_group_closing.php?show=show&amp;fdate=<?=$_REQUEST['cfdate']?>&amp;tdate=<?=$_REQUEST['ctdate']?>&amp;acc_sub_sub_class=<?=$data1->id?>" target="_blank">
...
?>
		 ...
		 <?=number_format($liability_amt[$data2->id],2); $equity_amt +=$liability_amt[$data2->id];?></a></td>
									      <td align="right"><a href="financial_transaction_group_closing.php?show=show&amp;fdate=<?=$_REQUEST['cfdate']?>&amp;tdate=<?=$_REQUEST['ctdate']?>&amp;acc_sub_sub_class=<?=$data2->id?>" target="_blank">
...
<? }?>	<tr>
		 ...
		 <a href="financial_changes_equity.php?show=show&fdate=<?=$_REQUEST['fdate']?>&tdate=<?=$_REQUEST['tdate']?>" target="_blank"><?=number_format($net_retained_earnings,2);?>	</a></td>
									      <td align="right"><a href="financial_changes_equity.php?show=show&amp;fdate=<?=$_REQUEST['cfdate']?>&amp;tdate=<?=$_REQUEST['ctdate']?>" target="_blank">
...
?>
		 ...
		 <?=number_format($liability_amt[$data3->id],2); $tot_liability_amt +=$liability_amt[$data3->id];?></a></td>
									      <td align="right"><a href="financial_transaction_group_closing.php?show=show&amp;fdate=<?=$_REQUEST['cfdate']?>&amp;tdate=<?=$_REQUEST['ctdate']?>&amp;acc_sub_sub_class=<?=$data3->id?>" target="_blank">
