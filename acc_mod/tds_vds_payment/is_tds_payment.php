...
$res='select sum(j.cr_amt-j.dr_amt) as tds_amt,j.tr_no as system_invoice_no,j.sub_ledger,s.sub_ledger_name,v.invoice_no,invoice_date,j.group_for from journal j left join general_sub_ledger s on s.sub_ledger_id=j.sub_ledger left join is_invoice_master v on v.system_invoice_no=j.tr_no where j.ledger_id="'.$tds_payable.'" and j.jv_date between "'.$_POST['fdate'].'" and "'.$_POST['tdate'].'" and j.tr_from in ("is_invoice_receive") group by j.tr_no,j.sub_ledger';
...
$narration = 'Inter Sale TDS Payment. Invoice No.'.$data->invoice_no;
...
$narration = "Inter Sale TDS Payable. Invoice No.".$data->invoice_no."";
...
//add_to_journal($proj_id, $jv_no, $jv_date, $credit_ledger, $narration, 0, $total_tds, $tr_from, $tr_no,$credit_sub_ledger,$tr_id,$cc_code,$group,$entry_by,$entry_at);
	...
	$delete_query ="delete from secondary_journal where tr_from='is_tds_payment' and jv_no =".$jv_no." ";
...
<div class="form-container_large">
                ...
                <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4">
                    ...
                    <div class="form-group row m-0">
                        ...
                        <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0">
                            ...
                            <input type="text" name="fdate" id="fdate" value="<?=($_POST['fdate']!='')?$_POST['fdate']:date('Y-m-01')?>" style="width:;" />
                    ...
                    <div class="form-group row m-0">
                        ...
                        <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0">
                            ...
                            <input type="text" name="tdate" id="tdate" value="<?=($_POST['tdate']!='')?$_POST['tdate']:date('Y-m-d')?>" style="width:;" />
  ...
  $res='select sum(j.cr_amt-j.dr_amt) as tds_amt,j.tr_no,j.sub_ledger,s.sub_ledger_name,v.invoice_no,invoice_date,s.sub_ledger_id from journal j left join general_sub_ledger s on s.sub_ledger_id=j.sub_ledger left join is_invoice_master v on v.system_invoice_no=j.tr_no where j.ledger_id="'.$tds_payable.'" and j.jv_date between "'.$_POST['fdate'].'" and "'.$_POST['tdate'].'" and j.tr_from in ("is_invoice_receive") and j.checked="NO"  '.$comcon.'  group by j.tr_no,j.sub_ledger';
            ...
            $query = db_query($res);
				    ...
				    $paid_amount = find_a_field('journal','sum(dr_amt)','ledger_id="'.$tds_payable.'" and sub_ledger="'.$row->sub_ledger_id.'" and tr_no="'.$row->tr_no.'" and tr_from="is_tds_payment"');
