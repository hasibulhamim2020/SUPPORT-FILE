...
<?php }?>
        ...
        <div class="col-sm-5">
            <form class="n-form" action="" method="post" enctype="multipart/form-data" name="form1" id="form1" onsubmit="return check()">
                ...
                <div class="form-group row m-0 pl-3 pr-3">
                    <label for="group_name" class="req-input col-sm-3 pl-0 pr-0 col-form-label "> Cost Center:</label>
                    <div class="col-sm-9 p-0">
                ...
                <div class="form-group row m-0 pl-3 pr-3">
                    <label for="group_name" class="col-sm-3 pl-0 pr-0 col-form-label">Cost Category: </label>
                    <div class="col-sm-9 p-0">
