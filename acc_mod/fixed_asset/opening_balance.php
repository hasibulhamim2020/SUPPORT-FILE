...
$j_sql="select ledger_id,cr_amt,dr_amt,narration from journal where tr_from='Opening' and group_for ='".$_SESSION['user']['group']."' and ledger_id like '1%' or ledger_id like '2%'";
