...
auto_complete_from_db('item_info','concat(finish_goods_code,"-",item_name)','item_id','1 and product_nature="Salable" and finish_goods_code>0 and finish_goods_code<5000','item_id');?>
    ...
    <div class="d-flex justify-content-center">
        <form class="n-form1 pt-4" action="fixed_asset_master_report.php" method="post" name="form1" target="_blank" id="form1">
                ...
                <div class="col-sm-7">
                    <div class="form-group row m-0 mb-1 pl-3 pr-3">
                        ...
                        <div class="col-sm-8 p-0">
                            <select name="ledger_group" id="ledger_group" class="form-control" >

                                <option></option>



                                <? foreign_relation('ledger_group','group_id','group_name',$ledger_group,'acc_sub_sub_class in (111) order by group_id');?>
