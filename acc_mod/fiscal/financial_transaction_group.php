...
<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="financial_transaction_ledger.php?show=show&fdate=<?=$_REQUEST['fdate']?>&tdate=<?=$_REQUEST['tdate']?>&group_id=<?=$data1->group_id?>" target="_blank" style="color:#000000;">
	 <?=$data1->group_name;?></a></td>
			...
			<td align="right"><? $transection_balance=$dr_amt[$data1->group_id]-$cr_amt[$data1->group_id]; $tot_transection_balance +=$transection_balance;
