...
foreign_relation('general_sub_ledger','sub_ledger_id','sub_ledger_name',$sub_ledger_id,"1 and group_for='".$_SESSION['user']['group']."'  order by sub_ledger_id");
	  ...
	  $sub_ledger_name_get[$srow->sub_ledger_id]=$srow->sub_ledger_name;
							...
							$total_sql = "select sum(a.dr_amt),sum(a.cr_amt) from journal a,accounts_ledger b".$d_table." where a.ledger_id=b.ledger_id and a.group_for='".$_SESSION['user']['group']."' and a.jv_date between '$fdate' AND '$tdate' and a.ledger_id like '$sledger_id' ".$cc_con.$d_where.$v_type;
							...
							$c="select sum(a.dr_amt)-sum(a.cr_amt) from journal a,accounts_ledger b".$d_table." where a.ledger_id=b.ledger_id and a.group_for='".$_SESSION['user']['group']."' and a.jv_date<'$fdate' and a.ledger_id like '$sledger_id'  ".$cc_con.$d_where.$v_type.$sub_ledger_con;
		 ...
		 from journal a,accounts_ledger b".$d_table." where a.ledger_id=b.ledger_id and a.group_for='".$_SESSION['user']['group']."' and a.jv_date between '$fdate' AND '$tdate' ".$sub_ledger_con.$cc_con.$v_type." and a.ledger_id like '$sledger_id' ".$d_where;
...
{
    $link="general_voucher_print_view_from_journal.php?c=".rawurlencode(url_encode($c_id)) . "&v=" .rawurlencode(url_encode($data[8]));
    echo "<a href='$link' target='_blank'>" .$data[8]. "</a>";
}

elseif($data[4]=='Sales')
{
    $link="sales_sec_print_view.php?c=".rawurlencode(url_encode($c_id)) ."&v=" .rawurlencode(url_encode($data[8]));
...
{
    $link="purchase_sec_print_view.php?c=".rawurlencode(url_encode($c_id)) ."&v=" .rawurlencode(url_encode($data[8]));
    echo "<a href='$link' target='_blank'>".$data[7]."</a>";
}
...
elseif($data[4]=='FOC')
{
    $link="foc_sec_print_view.php?c=".rawurlencode(url_encode($c_id))."&v=".rawurlencode(url_encode($data[8]));
    echo "<a href='$link' target='_blank'>".$data[7]."</a>";
}

elseif($data[4]=='SCHEME')
{
    $link="scheme_sec_print_view.php?c=".rawurlencode(url_encode($c_id))."&v=".rawurlencode(url_encode($data[8]));
    echo "<a href='$link' target='_blank'>".$data[7]."</a>";
}

elseif($data[4]=='DirectPurchase' || $data[4]=='Issue' || $data[4]=='Production Receive' || $data[4]=='Goods Return')
{
    $link="general_voucher_print_view_from_journal.php?c=".rawurlencode(url_encode($c_id))."&v=".rawurlencode(url_encode($data[8]));
    echo "<a href='$link' target='_blank'>" .$data[8]. "</a>";
}
...
{
    $link="provision_jv_print_view.php?c=".rawurlencode(url_encode($c_id))."&v=".rawurlencode(url_encode($data[8]));
    echo "<a href='$link' target='_blank'>".$data[7]."</a>";
}

elseif($data[4]=='Purchase Return')
{
    $link="prr_sec_print_view.php?c=".rawurlencode(url_encode($c_id))."&v=".rawurlencode(url_encode($data[8]));
    echo "<a href='$link' target='_blank'>" .$data[8]. "</a>";
}
