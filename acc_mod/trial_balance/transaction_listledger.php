...
?>
						  ...
						  <option value="">Select Type</option>
                                      ...
                                      <tr>
                                        ...
                                        <td colspan="2" align="left"><select name="cc_code" id="cc_code" style="width:250px;" >
							  ...
							  <tr>
								...
								<th width="32%" align="center">Acc Name</th>
								<th width="26%" align="center">Particulars</th>
								<th width="5%" align="center">Type</th>
								<th width="4%" height="20" align="center">Debit</th>
								<th width="4%" align="center">Credit</th>
								<th width="13%" align="center">Balance</th>
								</tr>
<?php
if(isset($_REQUEST['show']))
{
  ...
  <tr <?=($xx%2==0)?' bgcolor="#EDEDF4"':'';$xx++;?>>
	...
	{
		$link="inventory_journal_print_view.php?jv_no=".rawurlencode(url_encode($data[8]));
		echo "<a href='$link' target='_blank'>".$data[8]."</a>";
	}
	
	elseif($data[4]=='Spare Parts Sales')
	{
		$link="general_voucher_print_view_from_journal.php?jv_no=".rawurlencode(url_encode($data[8]));
		echo "<a href='$link' target='_blank'>".$data[7]."</a>";
	}
	...
	{
		$link="provision_jv_print_view.php?jv_no=".rawurlencode(url_encode($data[8]));
		echo "<a href='$link' target='_blank'>".$data[7]."</a>";
	}
