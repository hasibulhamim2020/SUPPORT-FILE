	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	  <tr>
	    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="1%"><img src="../../../logo/<?=$_SESSION['proj_id']?>.png" style="width:100px; height:100px;"/></td>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#00CC00">
  <tr>
	...
	<? if($jv->tr_from=='Sales'){?>
	<a target="_blank" class="jvbutton" href="../../warehouse_mod/wo/sales_invoice_print_view.php?c=<?php echo rawurlencode(url_encode($c_id)); ?>&v=<?php echo rawurlencode(url_encode($jv->tr_no)); ?>">Invoice View # <?=$jv->tr_no;?> </a>	
	<? }?>
	
	<? if($jv->tr_from=='Sales Return'){?>
	<a target="_blank" class="jvbutton" href="../../sales_mod/C2C/sales_return_print_view.php?v_no=<?=$jv->tr_id;?>">SR View # <?=$jv->tr_no;?> </a>	
	<? }?>
	
	<? if($jv->tr_from=='Purchase'){?>
	<a target="_blank" class="jvbutton" href="../../warehouse_mod/po_receiving/chalan_view2.php?c=<?php echo rawurlencode(url_encode($c_id)); ?>&v=<?php echo rawurlencode(url_encode($jv->tr_no)); ?>">GRN View # <?=$jv->tr_no;?> </a>
	<? }?>
	...
	<a target="_blank" class="jvbutton" href="../../bill_mod/bill/invoice_print_view.php?bill_no=<?=$jv->tr_no;?>">Invoice View # <?=$jv->tr_no;?> </a>	
	<? }?>	</td>
