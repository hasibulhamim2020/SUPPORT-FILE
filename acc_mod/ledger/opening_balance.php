...
$j_sql="select ledger_id,cr_amt,dr_amt,narration from journal where tr_from='Opening' and group_for ='".$_SESSION['user']['group']."' ";
//and ledger_id like '1%' or ledger_id like '2%' change by jobaraj 2-11-2023
...
var strURL="opening_balance_ajax.php?item_id="+item_id+"&cr="+cr+"&dr="+dr+"&opdate="+opdate+"&narration="+narration+"&flag="+flag;
...
value="<?=find_a_field('opening_date','start_date','1');?>"  required autocomplete="off" readonly=""/>
						</div>
					</div>
