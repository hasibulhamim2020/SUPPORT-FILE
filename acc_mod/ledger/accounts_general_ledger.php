...
unset($$unique);
header("Location: accounts_general_ledger.php");
}
...
<?php }?>
		...
		<form class="n-form setup-fixed" action="" method="post" enctype="multipart/form-data" name="form1" id="form1" onsubmit="return check()">
                ...
                <div class="form-group row m-0 pl-3 pr-3 p-1">
                    <label for="group_name" class="req-input col-sm-5 pl-0 pr-0 col-form-label "> General Ledger: </label>
                ...
                <div class="form-group row m-0 pl-3 pr-3 p-1">
                    ...
                    <div class="col-sm-7 p-0">
							...
							<select name="acc_class" required id="acc_class"  tabindex="2" onchange="getData2('acc_sub_class_ajax.php', 'sub_class', this.value, document.getElementById('acc_class').value);">
										<option></option>
	...
	foreign_relation('ledger_group a','a.group_id','CONCAT(a.group_id, ": ", a.group_name)',$ledger_group_id,'1');
	?>
                    					</select></span>
                    </div>
                </div>
				...
				<div class="form-group row m-0 pl-3 pr-3 p-1">
                    <label for="group_name" class="col-sm-5 pl-0 pr-0 col-form-label "> GL Code : </label>
                    <div class="col-sm-7 p-0">
																<span id="acc_group">
										<input type="text" name="manual_ledger_id" id="manual_ledger_id" value="<?=$manual_ledger_id?>"  tabindex="2">
										</span>
                    </div>
                </div>
