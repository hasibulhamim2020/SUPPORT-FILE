    ...
    <div class="row">
         <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 col-6 setup-left">
			...
			<h4 align="center" class="n-form-titel1">Search Cost Center</h4>
					...
					<div class="form-group row m-0 pl-3 pr-3">
                        <label for="group_for" class="col-sm-3 pl-0 pr-0 col-form-label">Cost Center Name:</label>
                        <div class="col-sm-9 p-0">
								<select name="center_name" required id="center_name" style="float:left;" tabindex="7">
						  <? foreign_relation('cost_center','id','center_name',$center_name,'group_for="'.$_SESSION['user']['group'].'"');?>
...
$con .='and a.id = "'.$_POST['center_name'].'" ';
