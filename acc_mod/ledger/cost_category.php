        ...
        <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 col-6 setup-left">
			...
			<h4 align="center" class="n-form-titel1">Search Cost Category</h4>
					...
					<div class="form-group row m-0 pl-3 pr-3">
                        ...
                        <div class="col-sm-9 p-0">
								<select name="category_name" required id="category_name" style="float:left;" tabindex="7">
						  <? foreign_relation('cost_category','id','category_name',$category_name,'group_for="'.$_SESSION['user']['group'].'"');?>
...
$con .='and a.id = "'.$_POST['category_name'].'" ';
