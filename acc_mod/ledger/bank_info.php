...
$title='Bank Sub Ledger';			// Page Name and Page Title
...
function createSubLedger($code,$name,$tr_from,$tr_id,$ledger_id,$type,$group_for){
 ...
 $insert = 'insert into general_sub_ledger set sub_ledger_id="'.$code.'",sub_ledger_name="'.$name.'",tr_from="'.$tr_from.'",tr_id="'.$tr_id.'",ledger_id="'.$ledger_id.'",type="Cash at Bank",entry_at="'.date('Y-m-d H:i:s').'",entry_by="'.$_SESSION['user']['id'].'",group_for="'.$group_for.'"';
db_query($insert);
return db_insert_id();
...
$custome_codes = find_a_field('general_sub_ledger','max(sub_ledger_id)','1');
if($custome_codes>0){
...
$_POST['account_code'] = $custome_code;
...
$_POST['ledger_group_id']=$_POST['ledger_id'];
$cy_id  = find_a_field('acc_bank_info','max(acc_bank_info)','1'); //find_a_field('accounts_ledger','max(ledger_sl)','ledger_group_id='.$_POST['ledger_group_id'])+1;
...
createSubLedger($custome_code,$_POST['ledger_name'],'Bank',$_POST[$unique],$_POST['ledger_id'] ,$_POST['dealer_type'],$_POST['group_for']);
}
      ...
      <div class="row">
        <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 pt-1 pb-1">
          <div class="form-group row m-0">
            <label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 vendor_label_text d-flex justify-content-start align-items-center pr-1 bg-form-titel-text req-input">Sub Ledger Name:</label>
        ...
        <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 pt-1 pb-1">
          <div class="form-group row m-0">
            <label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 vendor_label_text d-flex justify-content-start align-items-center pr-1 bg-form-titel-text req-input">Acc Number:</label>
            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0">
        ...
        <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 pt-1 pb-1">
          <div class="form-group row m-0">
            <label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 vendor_label_text d-flex justify-content-start align-items-center pr-1 bg-form-titel-text req-input">A/C Ledger:</label>
            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0">
            			<? if ($account_code==0) {?>
