...
$_SESSION['csrf_token'] = bin2hex(random_bytes(32));
	if ($_SESSION['tr_no']['Receipt_cash'] > 0) {
		...
		if ($_SESSION['jv_no']['Receipt_cash'] > 0) {
			...
			add_to_sec_journal(
				$proj_id,$j_data->jv_no,$j_data->jv_date,
				$sub_led->ledger_id,$detail,$_POST['t_amount'],'0',$tr_from,$j_data->tr_no,
$j_data->relavent_cash_head,'','0',$j_data->group_for,$j_data->user_id,'',$j_data->received_from,$j_data->bank,
$j_data->cheq_no,$j_data->cheq_date,$j_data->relavent_cash_head,$checked,$j_data->type,
$j_data->employee_id,$j_data->remarks,'0');
			}
						...
						<div class="row pb-1">
							...
							<div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 pr-0">
								...
								<div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 pl-0">
									<div class="form-group row m-0 pb-1">
										<label
											class="col-sm-5 col-md-5 col-lg-5 col-xl-5 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text  font-size12">Receive Mode:</label>
										<div class="col-sm-7 col-md-7 col-lg-7 col-xl-7 p-0 pr-2 ">
...
<td style="padding:1px;">
  <a href="general_voucher_print_view_for_draft.php?c=<?=rawurlencode(url_encode($c_id));?>&v=<?=rawurlencode(url_encode($dataa[4]));?>" target="_blank">
