...
<tr align="center">
  ...
  <td width="20%"><?php echo $_SESSION['data'.($j*6+1)];?></td>
  <td width="20%"><?php echo $_SESSION['data'.($j*6+2)];?></td>
  <td width="11%"><?php echo $_SESSION['data'.($j*6+3)];?></td>
  <td width="11%"><?php echo $_SESSION['data'.($j*6+4)];?></td>
  <td width="11%"><?php echo $_SESSION['data'.($j*6+5)];?></td>
  <td width="16%"><?php echo $_SESSION['data'.($j*6+6)];?></td>
</tr>
<?php }?>