...
<table  width="100%" border="1" align="left"  style="border-collapse:collapse; border:1px solid #caf5a5;" cellpadding="0" cellspacing="2">
                      <tr>
                        <td align="center" style="background-color: #0099FF;"><strong>Item Code</strong></td>
                        <td align="center" style="background-color: #0099FF;"><table width="100%" border="1" cellspacing="0" cellpadding="0">
                          <tr>
<td align="center" style="background-color: #0099FF; width=42%"><strong>Item Name</strong></td>
<td align="center" style="background-color: #0099FF; width=10%"><strong>In Stk</strong></td>
<td align="center" style="background-color: #0099FF; width=9%"><strong>UnDel</strong></td>
<td align="center" style="background-color: #0099FF; width=9%"><strong>Price</strong></td>
<td align="center" style="background-color: #0099FF; width=9%"><strong>Crt Qty</strong></td>
<td align="center" style="background-color: #0099FF; width=9%"><strong>Pcs</strong></td>
<td align="center" style="background-color: #0099FF; width=12%"><strong>Total</strong></td>
                          </tr>
                        </table></td>
                        <td rowspan="2" align="center" style="background-color: #FF0000;">
						  <div class="button">
...
<tr>
  <td style="background-color:#CCCCCC;"><span id="do"><table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
