...
<div class="form-container_large">
  <form action="" method="post" name="codz" id="codz">
    <table width="80%" border="0" align="center">
      ...
      <tr>
        <td align="right" style="background-color: #00bfff;"><strong>Date Interval :</strong></td>
        <td width="1" style="background-color: #00bfff;"><strong>
          <input type="text" name="fdate" id="fdate" class="from-control"   value="<?=($_POST['fdate']!='')?$_POST['fdate']:date('Y-m-01')?>" autocomplete="off"/>
        </strong></td>
        <td align="center" style="background-color: #00bfff;"><strong> -to- </strong></td>
        <td width="1" style="background-color: #00bfff;"><strong>
