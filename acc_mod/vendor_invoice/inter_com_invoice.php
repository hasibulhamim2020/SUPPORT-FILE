...
$title='Inter Purchase  List for Invoice';
    ...
    <form action="" method="post" name="codz" id="codz">
        ...
        <div class="container-fluid pt-5 p-0 ">
            ...
            if($_POST['fdate']!=''&&$_POST['tdate']!='')
                ...
                $con .= 'and pr.pi_date between "'.$_POST['fdate'].'" and "'.$_POST['tdate'].'"';
             ...
             $res='select  a.req_no,a.req_no,pr.pi_no, DATE_FORMAT(pr.pi_date, "%d-%m-%Y") as issue_date,c.fname as entry_by,pr.dealer_from 
			 
			 from requisition_is_master a,intersales_issue_master pr,user_activity_management c 
			 
			 where  a.entry_by=c.user_id and  pr.status="RECEIVED" and a.req_no=pr.req_no  '.$con.' order by a.req_no DESC';
                ...
                <table class="table1  table-striped table-bordered table-hover table-sm">
                    ...
                    while($row = mysqli_fetch_object($query)){
                        ...
                        <tr>
                            ...
                            <td><?=find1("select sub_ledger_name from general_sub_ledger where sub_ledger_id='".$row->dealer_from."'");?></td>

                            <td><?=$row->entry_by?></td>

                            <td><?=$row->checked_at?></td>

                            <td><input type="submit" name="submitit" id="submitit" value="Bill Create" class="btn1 btn1-submit-input" onclick="custom(<?=$row->pi_no?>);" /></td>
