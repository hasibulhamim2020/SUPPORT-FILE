...
$net_payable = $total_amount-$advance_amt;
    ...
    <form action="" method="post" name="codz" id="codz">
                ...
                <div class="col-sm-5 col-md-5 col-lg-5 col-xl-5">
                    ...
                    <div class="form-group row m-0">
                        ...
                        <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0">
                            <input type="text" name="vendor_id" id="vendor_id" value="<?=$_POST['vendor_id']?>" list="vendor" autocomplete="off" required />
							<datalist id="vendor">
        ...
        <div class="container-fluid bg-form-titel">
            ...
            ?>
                ...
                <table class="table1  table-striped table-bordered table-hover table-sm" style="zoom:85% !important">
                    <thead class="thead1">
					<tr class="bgc-info">
					 ...
					 <th colspan="4">Cash/Bank<input type="text" id="receive_sub_ledger" name="receive_sub_ledger" list="cash_bank" required  autocomplete="off"/>
					...
					$advance_to_vendor_dr = $config_ledger->supplier_advance_control;
					 ...
					 $adv_sql =" select sum(dr_amt-cr_amt) as amt,sub_ledger from journal where  ledger_id=".$advance_to_vendor_dr." and group_for = ".$_POST['group_for']." group by sub_ledger  ";		
...
<input type="checkbox" name="system_invoice_no<?=$row->system_invoice_no?>" class="form-control" id="system_invoice_no<?=$row->system_invoice_no?>" onclick="payment_cal(<?=$row->system_invoice_no?>)" /></td>
							<?php /*?><td>
							<a href="../../warehouse_mod/po_receiving/chalan_view_store.php?v_no=<?=rawurlencode(url_encode($row->grn_no))?>" target="_blank"><span class="style13" >
						 <?=$row->grn_no?>
						</span></a>
							</td><?php */?>
                      ...
                      <?php /*?>      <td><a href="../../purchase_mod/po/po_print_view_store.php?po_no=<?=rawurlencode(url_encode($row->po_no));?>" target="_blank"><span class="style13" >
						 <?=$row->po_no?>
						</span></a></td><?php */?>
