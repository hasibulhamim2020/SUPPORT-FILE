...
$jv_all=find_all_field('secondary_journal','','tr_from="vendor_invoice_receive" and tr_no='.$tr_no);
...
<?php }?>
<?
$sql2="SELECT a.ledger_id,a.ledger_name,b.dr_amt,b.cr_amt, a.ledger_group_id, b.narration FROM accounts_ledger a, secondary_journal b where b.jv_no='".$jv_all->jv_no."' and a.ledger_id=b.ledger_id order by b.dr_amt desc";
$data2=db_query($sql2);
while($info=mysqli_fetch_object($data2)){		  
	  ?>
      <tr>
