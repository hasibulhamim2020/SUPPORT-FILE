        ...
        <div class="container-fluid pt-5 p-0 ">
            ...
            <table class="table1  table-striped table-bordered table-hover table-sm">
                ...
                <tr>
					...
					<td align="center"><?=number_format($total_pcs,2)?></td>
...
<?php 
$credit_bal=find_a_field('journal','sum(dr_amt-cr_amt)','ledger_id="'.$dealer->account_code.'"');
?>

    <!--button design start-->

    <form action="unapproved_so_list.php" method="post" name="cz" id="cz" onSubmit="if(!confirm('Are You Sure Execute this?')){return false;}">
