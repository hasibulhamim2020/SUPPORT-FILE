                ...
                <div class="form-group row m-0">
                    ...
                    <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0">
                        <select name="checked" id="checked" class="form-control">
						  ...
						  <option <?=($_POST['checked']=='UNFINISHED')?'Selected':'';?>>UNFINISHED</option>
...
$received = $received + $data[1];
	 ...
	 <td align="center">
  <a target="_blank" href="general_voucher_print_view_for_status.php?t=<?=rawurlencode(url_encode($data[0]))?>&v=<?=rawurlencode(url_encode($data[1]))?>">
...
onclick="window.open('credit_note.php?t=<?=rawurlencode(url_encode($data[0]))?>&v=<?=rawurlencode(url_encode($data[1]))?>');"
