...

{
	...
	var URL = 'voucher_print_receipt.php?'+theUrl;
    ...
    <td valign="top"><div class="left_report">
		    ...
		    Voucher Type<span class="style2">*</span> : </td>
										...
										<option></option>
                                          ...
                                          <option value="contra"<?php if($vtype=='coutra') echo "selected"?>>Contra Posting</option>
