...
.box_report{
    ...
    <div class="form-container_large">
        ...
        <div class="container-fluid">
            ...
            <div id="reporting">
                <table id="grp"  class="tabledesign table1  table-striped table-bordered table-hover table-sm">
  ...
  where a.group_for = ".$_SESSION['user']['group']." and a.ledger_group_id=c.group_id ".$grp_con.$group_class_con."  ";
  ...
  where a.group_for = ".$_SESSION['user']['group']." and a.ledger_id=b.ledger_id and a.ledger_group_id=c.group_id and b.jv_date < '$fdate' ".$grp_con.$cc_con.$group_class_con."   group by a.ledger_id ";
  ...
  FROM accounts_ledger a, journal b,ledger_group c
  where a.group_for = ".$_SESSION['user']['group']." and a.ledger_id=b.ledger_id and a.ledger_group_id=c.group_id and b.jv_date BETWEEN '$fdate' AND '$tdate' ".$grp_con.$cc_con.$group_class_con." group by ledger_id ";
                        ...
                        $g="select c.group_name,c.group_id FROM ledger_group c where c.group_for =".$_SESSION['user']['group']." ".$grp_con.$group_class_con."   group by  c.group_id";
                        $gsql=db_query($g);
                        while($g=mysqli_fetch_row($gsql))
                        {
                            ...
                            $p="select a.ledger_name,a.ledger_id from accounts_ledger a where a.group_for = ".$_SESSION['user']['group']." and a.parent=0 and a.ledger_group_id='$g[1]' order by a.ledger_id";
