...
$dnarr=$detail.'Tr Mode: '.$tr_mode.':: Cheq# '.$c_no.':: Date= '.$cheq_date;
...
add_to_sec_journal($proj_id, $jv_no, $jv_date, $ledger_id, $dnarr,  '0', $amount, $tr_from, $tr_no,'','',$cc_code,'',$user_id,'',$r_from, $bank,$c_no,$cheq_date,$receive_ledger,$checked,$type,$employee,$remarks,$reference_id);
	...
	$up = 'update secondary_journal set tr_mode="'.$tr_mode.'", branch="'.$branch.'" , manual_voucher_no="'.$manual_voucher_no.'", exchange_rate="'.$exchange_rate.'", usd_amt="'.$usd_amt.'" where jv_no="'.$_SESSION['jv_no'].'"';
	db_query($up);
...
if($_SESSION['tr_no']>0){
	if($_SESSION['jv_no']>0){
		...
		$up = 'update secondary_journal set checked="NO", tr_mode="'.$tr_mode.'", branch="'.$j_data->branch.'", manual_voucher_no="'.$j_data->manual_voucher_no.'", exchange_rate="'.$j_data->exchange_rate.'", usd_amt="'.$j_data->usd_amt.'" where jv_no="'.$_SESSION['jv_no'].'"';
		db_query($up);
...
document.getElementById('of_branch_check').style.display='none';
document.getElementById('trMode_check').style.display='none';
document.getElementById('bank_check_new').style.display='none';
}else{
...
document.getElementById('of_branch_check').style.display='';
 document.getElementById('trMode_check').style.display='';
document.getElementById('bank_check_new').style.display='';
}
...
<?php if($cid == 'golden' || $cid == 'golden-demo' || $cid == 'dailyrice'){?>
<style>
	.display-mamun{
		display: none;
	}
				...
				<div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
					<div class="container n-form2">
							...
							<div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 pr-0">
								<div class="form-group row m-0 pb-1">
									...
									<div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
										...
										<input name="receipt_no" type="text" id="receipt_no" class="form-control" tabindex="1" size="15" value="<?=$tr_no?>" <? if($jv->tr_no>0) echo 'disabled'?> />
									...
									<div class="col-sm-7 col-md-7 col-lg-7 col-xl-7 p-0 pr-2 ">
										...
										<input name="jv_date" type="text" id="jv_date"
											 tabindex="2"  value="<?php if($jv->jv_date==""){
												   ...
												   echo $jv->jv_date;
											   } ?>" size="10" <?php /*?><? if($jv->tr_no>0) echo 'disabled'?><?php */?>  tabindex="1"required  class="form-control" />
						...
						<div class="row pb-1">
							...
							<div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 pr-0">
								<div class="form-group row m-0 pb-1">
									<label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text  font-size12">Receive Mode:</label>
									<div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
							...
							<div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 pl-0">
								<div class="form-group row m-0 pb-1">
									<label class="col-sm-5 col-md-5 col-lg-5 col-xl-5 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text font-size12">Received Through:</label>
									<div class="col-sm-7 col-md-7 col-lg-7 col-xl-7 p-0 pr-2 ">
	...
	<?php 
						...
						<div id="cash_check" class="form-group row m-0 pb-1">
							...
							<div class="col-sm-9 col-md-9 col-lg-9 col-xl-9 p-0 pr-2 ">
								...
								<? if($jv->tr_no>0){ ?>
								<input type="text" name="c_id_name" tabindex="5" id="cash_disable_id" readonly value="<?=find_a_field('accounts_ledger','ledger_name','ledger_id="'.$jv->relavent_cash_head.'"');?>" style="float:left" class="form-control" />
								<input type="hidden" name="c_id" value="<?=$jv->relavent_cash_head?>" />
								<? } else{?>
									<select name="c_id" id="cash_disable_id" style="float:left" tabindex="5" class="form-control">
						...
						<div id="bank_check" class="form-group row display-mamun m-0 pb-1">
							...
							<div class="col-sm-9 col-md-9 col-lg-9 col-xl-9 p-0 pr-2">
								...
								<? if($jv->tr_no>0){ ?>
									<input type="text" name="b_id_name" id="bank_disable_id" style="float:left" tabindex="6" value="<?=find_a_field('accounts_ledger','ledger_name','ledger_id="'.$jv->relavent_cash_head.'"');?>" readonly="readonly" class="form-control" />
									<input type="hidden" name="b_id" value="<?=$jv->relavent_cash_head?>" /><? }else{?>
									<select name="b_id" id="bank_disable_id" style="float:left" tabindex="6" <? if($jv->tr_no>0) echo 'readonly'?>  class="form-control"  onchange="bankData(this.value)">

										<option value="0"></option>

										<?

										foreign_relation('accounts_ledger','ledger_id','ledger_name',$b_id,'ledger_group_id="'.$bank_ledg_group_id.'"  order by ledger_id');
						...
						<!--This is for golden start-->
						<div id="bank_check_new" class="form-group row golden-display m-0 pb-1">
							...
							<div class="col-sm-9 col-md-9 col-lg-9 col-xl-9 p-0 pr-2">
								...
								<? if($jv->tr_no>0){ ?>
									<input type="text" name="b_id_name" id="bank_disable_id" style="float:left" tabindex="6" value="<?=find_a_field('accounts_ledger','ledger_name','ledger_id="'.$jv->relavent_cash_head.'"');?>" readonly="readonly" class="form-control" />
									<input type="hidden" name="b_id" value="<?=$jv->relavent_cash_head?>" /><? }else{?>
									<select name="b_id" id="bank_disable_id" style="float:left" tabindex="6" <? if($jv->tr_no>0) echo 'readonly'?>  class="form-control">
						...
						<!--This code for golden end-->
						<? } ?>
						
						<div id="trMode_check" class="form-group display-mamun row m-0 pb-1">
							<label class="col-sm-3 col-md-3 col-lg-3 col-xl-3 m-0 p-0 d-flex justify-content-end align-items-center pr-1 font-size12 bg-form-titel-text">Instrument Type:</label>
							<div class="col-sm-9 col-md-9 col-lg-9 col-xl-9 p-0 pr-2">

								<input name="tr_mode" type="text" id="tr_mode" value="<?php echo $jv->tr_mode?>" list="trModes" size="20" maxlength="25" tabindex="7" <? if($jv->tr_no>0) echo 'readonly'?> class="form-control"/>
								<datalist id="trModes">
									<option></option>
						...
						<div id="check_no_check" class="form-group row display-mamun m-0 pb-1">
							<label class="col-sm-3 col-md-3 col-lg-3 col-xl-3 m-0 p-0 d-flex justify-content-end align-items-center pr-1 font-size12 bg-form-titel-text">Instrument No:</label>
							<div class="col-sm-9 col-md-9 col-lg-9 col-xl-9 p-0 pr-2">
								<input name="c_no" type="text" id="c_no" value="<?php echo $jv->cheq_no?>" class="form-control" size="20" maxlength="25" tabindex="7" <? if($jv->tr_no>0) echo 'readonly'?> />
							</div>
						</div>

						<div  id="check_date_check" class="form-group row display-mamun m-0 pb-1">
							<label class="col-sm-3 col-md-3 col-lg-3 col-xl-3 m-0 p-0 d-flex justify-content-end align-items-center pr-1 font-size12 bg-form-titel-text">Instrument Date:</label>
							<div class="col-sm-9 col-md-9 col-lg-9 col-xl-9 p-0 pr-2">
								<input name="c_date" type="text" id="c_date" value="<?=$jv->cheq_date?>" class="form-control" size="12" maxlength="15" tabindex="8" <? if($jv->tr_no>0) echo 'disabled'?>  autocomplete="off"/>
							</div>
						</div>

						<div id="of_bank_check" class="form-group row display-mamun m-0 pb-1">
							<label class="col-sm-3 col-md-3 col-lg-3 col-xl-3 m-0 p-0 d-flex justify-content-end align-items-center pr-1 font-size12 bg-form-titel-text">Drawee:</label>
							<div class="col-sm-9 col-md-9 col-lg-9 col-xl-9 p-0 pr-2">
								<input name="bank" list="banks" type="text" id="bank" value="<?php echo $jv->bank?>" class="form-control"   tabindex="9" <? if($jv->tr_no>0) echo 'readonly'?> />
								<datalist id="banks">
						...
						<div id="of_branch_check" class="form-group row display-mamun m-0 pb-1">
							<label class="col-sm-3 col-md-3 col-lg-3 col-xl-3 m-0 p-0 d-flex justify-content-end align-items-center pr-1 font-size12 bg-form-titel-text">Drawee Branch:</label>
							<div class="col-sm-9 col-md-9 col-lg-9 col-xl-9 p-0 pr-2">

								<input name="branch" list="branches" type="text" id="branch" value="<?php echo $jv->branch?>"  tabindex="9" <? if($jv->tr_no>0) echo 'readonly'?> class="form-control"/>
								<datalist id="branches">
									<? foreign_relation('drawee_branch','concat(branch_name," - ",dist_name)','concat(branch_name," - ",dist_name)',$jv->branch,'1 order by branch_name asc');?>
								</datalist>	
						...
						<div class="form-group row m-0 pb-1">
							...
							<div class="col-sm-9 col-md-9 col-lg-9 col-xl-9 p-0 pr-2">
								<input name="remarks" type="text" id="remarks" value="<?php echo $jv->remarks?>" tabindex="10" class="form-control"   <? if($jv->tr_no>0) echo 'readonly'?> />
							</div>
						</div>
						
						
						<div class="form-group row display-mamun m-0 pb-1">
							<label class="col-sm-3 col-md-3 col-lg-3 col-xl-3 m-0 p-0 d-flex justify-content-end align-items-center pr-1 font-size12 bg-form-titel-text">Manual Voucher No:</label>
							<div class="col-sm-9 col-md-9 col-lg-9 col-xl-9 p-0 pr-2">
							...
							if(mysqli_num_rows($data2)>0){
								...
								{$dataa[2]=substr($dataa[2],0,20).'...';
									...
									<tr>
										...
										<? if($cid == 'mamun'){?>
										<td  style="padding:1px;" ><a href="general_voucher_print_view_for_draft_new.php?jv_no=<?php echo $dataa[4];?>" target="_blank"><img src="../images/print.png" width="16" height="16" border="0"></a></td>
										<? } else {?>
		...
		<div class="container-fluid pt-4 p-0 ">
			...
			<table class="table1  table-striped table-bordered table-hover table-sm">
				...
				<tr class="bgc-info">
					...
					<th>Cost Center</th>
					<th>Narration</th>
					<td class="display-mamun">Exchange Rate </td>
					<td class="display-mamun">USD Amt </td>
					<td>Amount</td>
					<td></td>
				</tr>
				</thead>
				...
				<tr>
					...
					<td>
							...
							<table border="1" align="center" cellpadding="2" cellspacing="2">
								<tr>
									<td>
										<input type="text" class="form-control" id="ledger_name" name="ledger_id" tabindex="12"  value="<?=$jv_data->ledger_name?>"/>
					...
					<td>
						<input name="detail" type="text" id="detail" tabindex="14"/>					</td>

					<td align="center" class="display-mamun"><input name="exchange_rate" type="text" id="exchange_rate" tabindex="14" value=""/></td>
					<td align="center" class="display-mamun"><input name="usd_amt" type="text" id="usd_amt" onkeyup="usdToBDT()" tabindex="14" value=""/></td>
					<td align="center">
						<input name="amount" type="text" id="amount" size="5" tabindex="15"/>					</td>


					<td>
						<input name="add_new" class="btn1 btn1-bg-submit" type="submit" id="add_new" value="Add New" tabindex="16"/>
						<input name="add" type="hidden" />					</td>
				</tr>
				</tbody>
			</table>
