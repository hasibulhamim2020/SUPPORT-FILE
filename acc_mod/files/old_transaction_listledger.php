  ...
  <tr>
    ...
    <td><div class="left_report">
		    ...
		    Period :                                       </td>
                                        ...
                                        <td colspan="2" align="left"><input name="fdate" type="text" id="fdate" size="12" maxlength="12" value="<?php echo $_REQUEST['fdate'];?>" /> 
...

{
...

	{
				...
				$total_sql = "select sum(a.dr_amt),sum(a.cr_amt) from journal a,accounts_ledger b where a.ledger_id=b.ledger_id and a.jv_date between '$fdate' AND '$tdate' and a.ledger_id like '$ledger_id' and b.group_for=".$_SESSION['user']['group']." AND a.cc_code=$cc_code ";
		...
		$c="select sum(a.dr_amt),sum(a.cr_amt) from journal a,accounts_ledger b where a.ledger_id=b.ledger_id and a.jv_date<'$fdate' and a.ledger_id like '$ledger_id' and b.group_for=".$_SESSION['user']['group']." AND a.cc_code=$cc_code";

		  $p="select a.jv_date,b.ledger_name,a.dr_amt,a.cr_amt,a.tr_from,a.narration,a.jv_no,a.tr_no,a.jv_no from journal a,accounts_ledger b where a.ledger_id=b.ledger_id and a.jv_date between '$fdate' AND '$tdate' and a.ledger_id like '$ledger_id' and 1 AND a.cc_code=$cc_code and b.group_for=".$_SESSION['user']['group']." order by a.jv_date,a.id";
...

	{
		...
		$total_sql = "select sum(a.dr_amt),sum(a.cr_amt) from journal a,accounts_ledger b where a.ledger_id=b.ledger_id and a.jv_date between '$fdate' AND '$tdate' and a.ledger_id like '$ledger_id' and b.group_for=".$_SESSION['user']['group']."";

		$total=mysqli_fetch_row(db_query($total_sql));

		

		$c="select sum(a.dr_amt)-sum(a.cr_amt) from journal a,accounts_ledger b where a.ledger_id=b.ledger_id and a.jv_date<'$fdate' and a.ledger_id like '$ledger_id' and b.group_for=".$_SESSION['user']['group']."";



		 $p="select a.jv_date,b.ledger_name,a.dr_amt,a.cr_amt,a.tr_from,a.narration,a.jv_no,a.tr_no,a.jv_no,a.cheq_no,a.cheq_date from journal a,accounts_ledger b where a.ledger_id=b.ledger_id and a.jv_date between '$fdate' AND '$tdate' and a.ledger_id like '$ledger_id' and b.group_for=".$_SESSION['user']['group']." order by a.jv_date,a.id";
