								  ...
								  <tr>
									...
									<table width="100%" border="0" cellspacing="2" cellpadding="0">
                                      ...
                                      <tr>
                                        ...
                                        <td width="22%" height="64" align="right">

		    Period :                                       </td>

                                        <td width="22%" align="left"><div align="right">
                                          <input name="fdate" type="text" id="fdate" size="12" class="form-control" value="<?php echo $_REQUEST['fdate'];?>" />                                     
                                        </div></td>

                                        <td width="6%" align="left"> &nbsp;&nbsp;&nbsp;&nbsp;
                                        <div align="center">-----</div></td>
                                        <td width="50%" align="left">  <div align="left">

                                          <input name="tdate" type="text" id="tdate" size="12" style="max-width:250px;" class="form-control" value="<?php echo $_REQUEST['tdate'];?>"/>
                                      ...
                                      <tr>
                                       ...
                                       <br /> <td height="56" align="center">&nbsp;</td>
                                       <td height="56" align="center">&nbsp;</td>
                                       <td height="56" align="center"><input class="btn1 btn1-bg-submit" name="show" type="submit" id="show" value="Show" /></td>
                                      </tr>
                                    </table>
...
<thead>
				 ...
				 <tr>
				   ...
				   <!--/Sales Calculation-->
				    ...
				    <!--Closing Stock Calculation-->
					 ...
					 <input type="hidden" name="closing" value=" <? $openingCTG = find_a_field('journal j, accounts_ledger a, ledger_group g','sum(j.dr_amt-j.cr_amt)','j.ledger_id=a.ledger_id and a.ledger_group_id=g.group_id and j.jv_date<'.$fdate); echo  number_format($openingCTG,2);?>" />
				 ...
				 <tr>
				   <td height="23">Balance Amount of Profit & Loss Appropiation A/C 
				   ...
				   <td><div align="center">a <? $Paioryears_Adjustment = ($closing_all_cr_dr+$during_year_all_cr_dr)-($closing_all_dr_cr+$all_opening_dr+$during_year_all_dr_cr); ?></div></td>
				   <td align="right">
					...
					<strong><?php /*?><?= number_format($Paioryears_Adjustment,2); ?><?php */?>
							<?php /*?><?=($balance_transfer>0)?number_format($balance_transfer,2):'('.number_format($balance_transfer*(-1),2).')';?><?php */?>
							
							<?=($Paioryears_Adjustment<0)?number_format($Paioryears_Adjustment*(-1),2):'('.number_format($Paioryears_Adjustment,2).')';?>
				 ...
				 <tr>
				   ...
				   <td><div align="center">b <? $gross_gross_profit = (($total_Stock_sale)-$gross_tot_exp); ?></div></td>
				 ...
				 <tr>
				   ...
				   <td><div align="center">c  <? $com_id = 1112; $ait_paid = sum_com($com_id,$fdate,$tdate); $total = $total - $amount; $total1 = $total1 + $amount;?></div></td>

				   <td align="right"><span class="style2">
				     
					 <?=($ait_paid<0)?number_format($ait_paid*(-1),2):'('.number_format($ait_paid,2).')';?>
				 ...
				 <tr>
				   ...
				   <td bgcolor="#CCCCFF"><div align="center"><? $balance_transfer = ($gross_gross_profit-($Paioryears_Adjustment+$ait_paid)); ?></div></td>
				   <td align="right" bgcolor="#CCCCFF"><strong><?=($balance_transfer>0)?number_format($balance_transfer,2):'('.number_format($balance_transfer*(-1),2).')';?></strong></td>
				   </tr>
