...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#CCCCCC">
  ...
  <tr>
    ...
    <?php /*?><td width="180" align="right"><a target="_blank" href="../../warehouse_mod/direct_purchase/chalan_view2.php?v_no=<?=rawurlencode(url_encode($ch->or_no));?>">DP-

        <?=$ch->or_no?>
    </a></td><?php */?>
	
	
	<td width="180" align="right"><a target="_blank" href="../../warehouse_mod/direct_purchase/chalan_view2.php?c=<?=rawurlencode(url_encode($c_id));?>&v=<?=rawurlencode(url_encode($ch->or_no));?>">DP-
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#339900">
  ...
  <tr>
    ...
    <?php /*?><td width="200" align="right"><a target="_blank" href="../../../warehouse_mod/pages/direct_purchase/chalan_view2.php?v_no=<?=$ch->or_no?>">DP-

        <?=$ch->or_no?>

    </a></td><?php */?>
	
	<td width="200" align="right"><a target="_blank" href="../../warehouse_mod/direct_purchase/chalan_view2.php?c=<?=rawurlencode(url_encode($c_id))?>&v=<?=rawurlencode(url_encode($ch->or_no))?>">DP-
