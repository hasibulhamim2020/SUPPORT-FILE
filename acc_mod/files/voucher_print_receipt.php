...
$_SESSION['user']['concern_name'] = 'ERP.COM.BD';
...
elseif($vtype=='journal'){$voucher_name='JOURNAL VOUCHER';$vtypes='journal';}

elseif($vtype=='contra'){$voucher_name='CONTRA VOUCHER';$vtype='contra';$vtypes='contra';}

else{$voucher_name=$vtype;$vtypes=$vtype;}
...

{
  ...
  $sql1="select jv_date,cc_code,entry_by, group_for from secondary_journal where jv_no=$vo_no and tr_from = '".$vtypes."' limit 1";
...
$concern = find_all_field('user_group','',"id=".$data1[3]);
...
if($_SESSION['user']['group']==3)
 ...
 $sql2="SELECT a.ledger_name,a.ledger_group_id,b.* FROM accounts_ledger a, secondary_journal b where b.jv_no='$vo_no' and a.ledger_id=b.ledger_id order by b.dr_amt desc,b.id";
          ...
          <tr>
            ...
            <td width="83%"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td align="center" class="title"><?=$concern->group_name?></td>
              </tr>
...
<a href="voucher_print_view_receipt.php?v_type=<?=$_REQUEST['v_type']?>&vo_no=<?=$_REQUEST['vo_no']?>">Client Copy</a></div>
      ...
      <tr>
        ...
        <td class="tabledesign_text">Voucher Date : <?php echo date('d-m-Y',strtotime($vo_date));?></td>
  ...
  <tr>
    ...
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000" class="tabledesign">
      ...
      <tr>
        ...
        <td width="25%" align="center">Control Head</td>

        <td width="30%" align="center">A/C Ledger Head</td>

        <td width="30%" align="center">Particulars</td>

        <td width="5%">Debit </td>
        <td width="4%">Credit</td>
      </tr>
  ...
  <tr>
    ...
    <td class="tabledesign_text"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
	    ...
	    <? if($vtype!='journal_info'){?><td><div align="center">Prepared by </div></td><? }?>
        ...
        <td><div align="center">DMD/MD/CHAIRMAN</div></td>
