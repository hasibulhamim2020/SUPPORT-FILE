...
// and tr_from='".$jv_all->tr_from."'
db_query("INSERT INTO secondary_journal_del 
          SELECT * FROM secondary_journal 
          WHERE jv_no ='".$jv_no."'");
		  
db_query("DELETE FROM `secondary_journal` WHERE jv_no ='".$jv_no."'");
header("Location: general_voucher_verify_1.php?new=2");
...
echo $_SESSION['proj_name'];
              ...
              $print_url = "https://saaserp.ezzy-erp.com/app/views/acc_mod/files/general_voucher_print_view_for_approval.php?c=" . rawurlencode($company_id) . "&v=" . rawurlencode($req_no_qr_data);
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#CCCCCC">
  ...
  <td><input name="reject" type="submit" id="reject" value="Reject" style="background-color:#FF0000;"/>
        <input type="hidden" name="rejected_jv" id="rejected_jv" value="<?=$jv_on?>" />
		</td>
