...
<form id="form2" name="form2" method="post" action="bill_payment.php">
		...
		<div class="n-form1 fo-short pt-3">
			...
			<div class="container">
				<div class="form-group row  m-0 mb-1 pl-3 pr-3">
					<label for="group_for" class="col-sm-3 col-md-3 col-lg-3 col-xl-3 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">Select Bill : </label>
					<div class="col-sm-9 col-md-9 col-lg-9 col-xl-9 p-0 pr-2">
						...
						<select name="vendor" id="vendor" required class="form-control">
							...
							<option value=""></option>
							<?
							$sql = 'select d.vendor_name,d.ledger_id from secondary_journal j, vendor d where j.tr_from="Bill" and j.ledger_id=d.ledger_id group by d.ledger_id';
							$qr = db_query($sql);
							while($data = mysqli_fetch_object($qr)){
								?>
								<option value="<?=$data->ledger_id?>"><?=$data->vendor_name.'#'.$data->ledger_id?></option>
							<? } ?>
			...
			<div class="n-form-btn-class">
				<input type="submit" name="submitit" id="submitit" value="View Bill" class="btn1 btn1-submit-input"/>
			</div>
        ...
        <tr>
			...
			<table width="60%" border="0" align="center" cellpadding="5" cellspacing="0" bgcolor="#FF9999">
              ...
              <tr>
                ...
                <td><div align="right"><strong>Select Bill  :</strong></div> </td>
