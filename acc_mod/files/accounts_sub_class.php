...
$mid = sprintf("%02d", $cy_id);
 ...
 $_POST['sub_class_id'] = $_POST['acc_class'].''.$mid;
                                  ...
                                  <td width="100%" colspan="2"><div class="box" style="width:400px;">
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                     ...
                                     <td><span class="style1" style="padding-top:5px;; color: #FF0000">*</span>Acc. Sub Class:</td>
                        				...
                        				<input name="sub_class_name" required type="text" id="sub_class_name" tabindex="1" class="form-control" value="<?=$sub_class_name?>"  style="width:220px;" >	
									  ...
									  <tr>
										...
										<select name="acc_class" required id="acc_class"  tabindex="2" class="form-control" style="width:220px;">
