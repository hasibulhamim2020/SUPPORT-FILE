...
VALUES ('$jv', '".strtotime($_REQUEST['opdate'])."', '".$ledger_id."', 'Reset Balance of ".$_REQUEST['opdate']."', '0', '$reset_amt', 'ResetOpening', '','','','".$_SESSION['user']['id']."','".$_SESSION['user']['group']."','".$entry_at."')";
else
$journal="INSERT INTO `journal` (
