...
if($_GET['tr_no']>0){
 ...
 $jv_val=find_a_field('journal','count(id)',"tr_no='".$_SESSION['tr_no']."' and tr_from='Payment'");
 $sj_val=find_a_field('secondary_journal','count(id)',"tr_no='".$_SESSION['tr_no']."' and tr_from='Payment' and cr_amt>0");
...
if($jv_val>0){
 $del_jv = "delete from journal where tr_from='Payment' and tr_no = '".$_SESSION['tr_no']."'";
 db_query($del_jv);
}

if($sj_val>0){
 $del_sj = "delete from secondary_journal where tr_from='Payment' and tr_no = '".$_SESSION['tr_no']."' and cr_amt>0";
 db_query($del_sj);
}
...
echo $jv->jv_date;
                        ...
                        <tr>
                          <td><div align="right"><span class="style3">*</span>Paid To:</div></td>
...
from  secondary_journal a where a.tr_from='Payment' and  SUBSTRING(a.tr_no,5,1)='0' and  a.cr_amt>0 group by a.tr_no order by a.tr_no desc limit 5";
...
<td width="11%" align="center" bgcolor="#45777B"><span class="style3">GL Code </span></td>

<td width="28%" align="center" bgcolor="#45777B"><span class="style3">GL Name </span></td>
<td width="15%" align="center" bgcolor="#45777B"><span class="style3">Reference</span></td>

<td width="15%" align="center" bgcolor="#45777B"><span class="style3">Cost Center</span></td>
<td width="16%" align="center" bgcolor="#45777B"><strong>Narration</strong></td>
<td width="10%" align="center" bgcolor="#45777B"><strong>Amount</strong></td>

<td width="5%" align="center" bgcolor="#45777B"><strong>Action</strong></td>
</tr>

<?

$sql2="select a.id, a.ledger_id, a.tr_no,l.ledger_name, a.dr_amt, a.narration,a.jv_date , a.jv_no, a.cc_code, a.reference_id

from  secondary_journal a, accounts_ledger l where a.ledger_id=l.ledger_id and a.jv_no='".$_SESSION['jv_no']."' and a.dr_amt>0 and tr_from='Payment'";
