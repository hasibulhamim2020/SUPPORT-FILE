...
<table width="100%" class="tabledesign" border="1" bordercolor="#000000" cellspacing="0" cellpadding="5">
       <tr style="font-size:13px;">
        ...
        <td align="center" style="background-color: #CCCCCC;"><strong>Pay</strong></td>
        <td align="center" style="background-color: #CCCCCC;"><strong>Damage</strong></td>
        ...
        <td align="center" style="background-color: #CCCCCC;"><strong> Qty</strong></td>
        <td align="center" style="background-color: #CCCCCC;">><strong>Payable Amt</strong></td>
