...

{
	...
	if($vo_type!='')		{$con .= "AND tr_from = '".$vo_type."'";  }
		if($vo_type=='')		{$con .= "AND tr_from in('Receipt','Payment','Journal','Contra')";  }
		...
		<form class="n-form1 fo-width1 pt-4" id="form1" name="form1" method="post" action="">
			...
			<div class="container-fluid">
				...
				<div class="form-group row m-0 mb-1 pl-3 pr-3">
					...
					<div class="col-sm-9 col-md-9 col-lg-9 col-xl-9 p-0">
						...
						<option value="">All</option>
							...
							<?php /*?><option value="Purchase"<?php if($vtype=='Purchase') echo "selected"?>>Purchase Voucher</option>

										  <option value="Salea"<?php if($vtype=='Salea') echo "selected"?>>Salea Voucher</option>

										  <option value="Collection"<?php if($vtype=='Collection') echo "selected"?>>Collection Voucher</option><?php */?>
				...
				<div class="form-group row m-0 mb-1 pl-3 pr-3">
					...
					<div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 p-0">
					  <input name="tdate" style="max-width:250px!important;" class="form-control" type="text" id="tdate" size="10" value="<?php  echo $_POST['tdate'];  ?>" autocomplete="off" />
					</div>
				</div>
				...
				<table class="table1  table-striped table-bordered table-hover table-sm" id="grp">
...

					{
						...
						<tr>
							...
							<td><a href="general_voucher_print_view_for_draft.php?jv_no=<?php echo  $vno[4]; ?>" target="_blank" ><input type="button" class="btn btn-success" value="View" /></a></td>
