    ...
    <td><div class="left_report">
		    ...
		    Period :                                       </td>
                                      ...
                                      <tr>
                                        ...
                                        <td align="left">
                                        <select name="ledger_id" id="ledger_id"><option selected value="%">All</option>
	  									<?php 
				                       $led=db_query("select ledger_id,ledger_name from accounts_ledger   where 1 and ledger_group_id='$cash_and_bank_balance' order by ledger_name");
	                                   while($ledg=mysqli_fetch_row($led)){
...
<?php
	if(isset($_REQUEST['show'])){
  $total=mysqli_fetch_row(db_query("select sum(dr_amt),sum(cr_amt) from journal where tr_from='Contra' and jv_date>'$fdate' and jv_date<'$tdate' and ledger_id like '$ledger_id' and 1"));
  $p="select a.jv_date,b.ledger_name,a.dr_amt,a.cr_amt,a.tr_no,a.narration from journal a,accounts_ledger b where tr_from='Contra' and a.ledger_id=b.ledger_id and a.jv_date>'$fdate' and a.jv_date<'$tdate' and a.ledger_id like '$ledger_id' and 1 order by a.tr_no";
