...
$title='General Ledger Reference';			// Page Name and Page Title
...
$cy_id  = find_a_field('accounts_ledger','max(ledger_sl)','sub_group_id='.$_POST['sub_group_id'])+1;
...
$_POST['ledger_id'] = $_POST['sub_group_id'].''.$_POST['ledger_sl'];
...
<tr>
  ...
  <th style="background-color:#45777B;"><span class="style3">GL Sub Group </span></th>
...
$con .='and a.warehouse_name like "%'.$_POST['warehouse_name'].'%" ';
 ...
 $td='select a.'.$unique.',  a.'.$shown.', a.acc_class, a.acc_sub_class, a.ledger_group_id, a.sub_group_id from '.$table.' a where 1  '.$con.' order by a.ledger_id  ';
...
<td><?=find_a_field('ledger_sub_group','sub_group_name','sub_group_id='.$rp[5]);?></td>
<td><?=$rp[1];?></td>
</tr>
...
document.getElementById('acc_class').value);">
									  ...
									  <tr>
                                        ...
                                        <td><span class="style1" style="padding-top:5px;; color: #FF0000">*</span>GL Sub Group:</td>

                                        <td>
										<span id="acc_sub_group">
										<select name="sub_group_id" required id="sub_group_id"  tabindex="2" style="width:220px;">
										<option></option>
                      						<? foreign_relation('ledger_sub_group','sub_group_id','CONCAT(sub_group_id, ": ", sub_group_name)',$sub_group_id,'sub_group_id="'.$sub_group_id.'"');?>
                    					</select></span></td>
                                      </tr>
