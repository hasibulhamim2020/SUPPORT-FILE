...
$sql1="select b.* from warehouse_damage_receive b where b.or_no = '".$or_no."'";
...
$sql1="select b.* from warehouse_damage_receive_detail b where b.or_no = '".$or_no."'";
		        ...
		        <tr>
		          ...
		          <td><table width="100%" border="1" cellspacing="0" cellpadding="3">
		            ...
		            <tr>
		              ...
		              <td><?php echo $dealer->dealer_name_e;?> - &nbsp;<?php echo $dealer->dealer_code;?>(<?=$dealer->team_name?>)</td>
...
?>
      ...
      <tr style="font-size:12px; height:40px;" <?=($i%2)?'bgcolor="#F7F7F7"':'';?>>
        ...
        <td align="right" valign="top">
		  ...
		  <input type="text" name="rate_<?=$id[$i]?>" id="rate_<?=$id[$i]?>" style="width:70px; text-align:right; color:#FF3300" value="<?=$rate[$i]?>" />            </td>

        <td align="right" valign="top"><?=$unit_qty[$i]?></td>

        <td align="right" valign="top"><strong><? if($damage_cause->payable=='Yes'){echo $amount[$i]; $t_amount = $t_amount + $amount[$i];} else echo '0.00';?>
		...
		onclick="getData2('damage_view_print_ajax.php', 'po<?=$id[$i]?>','<?=$id[$i]?>',document.getElementById('rate_<?=$id[$i]?>').value);" /></span></td>
        </tr>
...
<? }?>
  ...
  <tr style="font-size:14px;"><td colspan="6" align="center" valign="top"><div align="right"><strong>Total Amount: </strong></div></td>
        ...
        <td align="center" valign="top"><span class="style1"><?=number_format($tot_unit_qty,2)?></span></td>
