...
j.tr_from in('Payment','Receipt','Journal','Contra') and
				 ...
				 j.entry_by = u.user_id AND j.secondary_approval='Yes' and
...
$received = $received + $data[1];
      ...
      <!--<td align="center"><a target="_blank" href="general_voucher_print_view_for_approval_final.php?jv_no=<?=$data[1]?>"><img src="../images/print.png" width="20" height="20" /></a></td>-->
	  
	  
<td align="center">
  <a target="_blank" href="general_voucher_print_view_for_approval_final.php?c=<?=rawurlencode(url_encode($c_id))?>&v=<?=rawurlencode(url_encode($data[1]))?>">
...
<!--<input type="button" name="Button" value="YES"  onclick="window.open('general_voucher_print_view_for_approval_final.php?jv_no=<?=($data[1])?>');" class="btn btn-success btn-sm" />
-->

<input type="button" name="Button" value="YES"
  onclick="window.open('general_voucher_print_view_for_approval_final.php?c=<?=rawurlencode(url_encode($c_id))?>&v=<?=rawurlencode(url_encode($data[1]))?>');"
...
<input type="button" name="Button" value="NO"  onclick="window.open('general_voucher_print_view_for_approval_final.php?c=<?=rawurlencode(url_encode($c_id))?>&v=<?=rawurlencode(url_encode($data[1]))?>');" class="btn btn-danger btn-sm" />
...
<input type="button" name="Button" value="YES"  onclick="window.open('general_voucher_print_view_for_approval_final.php?jv_no=<?=$data[1] ?>');" class="btn1 btn1-bg-submit" />
...
<input type="button" name="Button" value="NO"  onclick="window.open('general_voucher_print_view_for_approval_final.php?jv_no=<?=$data[1] ?>');" class="btn1 btn1-bg-submit" />
