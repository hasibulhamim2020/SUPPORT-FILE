...
j.cr_amt>0 and
				  ...
				  j.ledger_id = l.ledger_id ".$group_s.$checked_con.$depot_con." group by j.jv_no";
					...
					while($data=mysqli_fetch_row($query)){
						...
						<tr>
							...
							<td><a target="_blank" href="ds_print_view.php?c=<?=rawurlencode(url_encode($c_id))?>&v=<?=rawurlencode(url_encode($data[10]))?>"><img src="../images/print.png" width="20" height="20" /></a></td>
  ...
  onclick="window.open('ds_print_view.php?c=<?=rawurlencode(url_encode($c_id))?>&v=<?=rawurlencode(url_encode($data[10]))?>');"
