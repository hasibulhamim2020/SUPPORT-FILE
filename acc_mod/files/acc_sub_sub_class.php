...
$page="acc_sub_sub_class.php";		// PHP File Name
...
$mid = sprintf("%02d", $cy_id);

 $_POST['sub_sub_class_id'] = $_POST['acc_sub_class'].''.$mid;
...
<tr>
  ...
  <th style="background-color:#45777B;"><span class="style3">Accounts Sub Sub Class </span></th>
  <th style="background-color:#45777B;"><span class="style3">Accounts Sub Class</span> </th>
</tr>
</thead>
...
$td = 'SELECT a.' . $unique . ', a.' . $shown . ', a.acc_sub_class 
       FROM ' . $table . ' a 
       WHERE 1 ' . $con . ' 
       ORDER BY a.id';
...
<td><?=$rp[1];?></td>
<td><?=find_a_field('acc_sub_class','sub_class_name','id='.$rp[2]);?></td>
</tr>
                                  ...
                                  <td width="100%" colspan="2"><div class="box" style="width:400px;">
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                     ...
                                     <td><span class="style1" style="padding-top:5px;; color: #FF0000">*</span>Acc. Sub Sub Class:</td>
                        				...
                        				<input name="sub_sub_class_name" required type="text" id="sub_sub_class_name" tabindex="1" class="form-control" value="<?=$sub_sub_class_name?>"  style="width:220px;" >	
									  ...
									  <tr>
                                        ...
                                        <td><span class="style1" style="padding-top:5px;; color: #FF0000">*</span>Accounts Sub Class:</td>

                                        <td>
										
										<select name="acc_sub_class" required id="acc_sub_class"  tabindex="2" class="form-control" style="width:220px;">
