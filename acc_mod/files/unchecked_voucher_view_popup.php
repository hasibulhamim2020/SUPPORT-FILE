...
else{$v_type=='coutra';$voucher_name='CONTRA VOUCHER';$vtype='contra';$tr_from='contra';}
...
sec_journal_journal($datab->jv_no,$datab->jv_no,$datab->tr_from);
...
//end
 ...
 $check = find_a_field('secondary_journal','checked','jv_no="'.$jv_no.'" and tr_from="'. $vtype.'"');
?>
  ...
  <table border="0" cellspacing="10" cellpadding="0" align="center" style="width:400px;">
    <tr>
	 <?
	   if($check=="NO"){
	 ?>
	 <td><input class="btn_p1" name="confirmm" type="submit" value="Confirm Voucher" onmouseover="this.style.cursor='pointer';" /></td>
      <td>&nbsp;</td>
