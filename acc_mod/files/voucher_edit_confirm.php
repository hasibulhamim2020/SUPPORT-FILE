...
$sql1="select jv_date,cc_code,user_id from journal where tr_no=$vo_no and tr_from = '".$vtypes."' limit 1";
          ...
          <tr>
            ...
            <td width="83%"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td align="center" class="title">AWN</td>
              </tr>
  ...
  <tr>
    ...
    <td class="tabledesign_text"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td colspan="2"><div align="center"><input type="submit" name="edit" id="edit" class="form-control" value="Push To Unfinished" style="height:35px; width:150px; background:red; color:#FFFFFF;" /></div></td>

        <td colspan="2"><div align="center"><input type="submit" name="confirm" id="confirm" class="form-control" value="Confirm Now" style="height:35px; width:150px; background:aquamarine;"/></div></td>
