...
elseif($_REQUEST['report']==210617002)
{
	
	
		$report="PARTY BALANCE REPORT";		
		if(isset($warehouse_id)){$con.=' and j.warehouse_id="'.$warehouse_id.'"';}
...
<!--		<img src="<?=SERVER_ROOT?>public/uploads/logo/tecno.png" style="width:220px;">-->
		...
		if($_REQUEST['ledger_id']) 		{$ledger_id_con=' and a.ledger_id="'.$_REQUEST['ledger_id'].'"';}
		 ...
		 $sql_sub="select a.ledger_id, a.ledger_name from accounts_ledger a, acc_reference b where a.ledger_id=b.ledger_id and  a.ledger_group_id in (10203) ".$ledger_group_con.$ledger_id_con." group by a.ledger_id";
			$data_sub=db_query($sql_sub);
		...
		<td><? 	if ($opening_amt[$row->id]>0) { echo  "DR"; } else { echo  "CR"; } ?></td>
		<td><? number_format($opening_balance= $opening_amt[$row->id],2);  $sub_total_opening_amt +=$opening_amt[$row->id]; 
		if ($opening_amt[$row->id]>0) { echo  number_format($opening_balance,2). ""; } else { echo number_format($opening_balance*(-1),2). ""; }  ?></td>
		<td><?=number_format($dr_amt[$row->id],2);  $sub_total_dr_amt +=$dr_amt[$row->id];?></td>
		<td><?=number_format($cr_amt[$row->id],2); $sub_total_cr_amt +=$cr_amt[$row->id]; ?></td>
...
elseif($_REQUEST['report']==210617007)
{
		$report="Job Completion Report";		
?>
		<style>
	...
	<table width="100%">
        <tr>
            <th colspan="6" id="heading" style=" border: none; ">UNIOCEAN Shipping Lines Ltd</th>
        </tr>
        <tr>
            <th colspan="6" style=" border: none; "><div id="sub_heading" align="center">Provisional Job Completion Sheet</div></th>
        </tr>
        <tr class="table_info">
            <td width="13%" class="table_info">JOB NO</td>
            <td width="18%"></td>
            <td width="17%" rowspan="2" class="table_info">D/POINT</td>
            <td width="16%" rowspan="2" class="table_info"></td>
            <td width="18%" class="table_info">ARRIVAL DATE</td>
            <td width="18%"></td>
        </tr>
        <tr class="table_info">
            <td class="table_info">REG NO</td>
            <td></td>
            <td class="table_info">SAILED DATE</td>
            <td></td>
        </tr>
        <tr class="table_info">
            <td class="table_info">VSL NAME</td>
            <td></td>
            <td class="table_info">CARGO</td>
            <td></td>
            <td class="table_info">TOTAL CARGO</td>
            <td></td>
        </tr>
        <tr class="table_info">
            <td class="table_info">DWT</td>
            <td></td>
            <td class="table_info">GRT</td>
            <td></td>
            <td class="table_info">NRT</td>
            <td></td>
        </tr>
		...
		<tr>
            <td colspan="6" style=" border: none; ">
				<table width="100%" border="1" style="margin-top:5px;">
				  <tr>
					<td width="3%"><div align="center">SL</div></td>
					<td width="60%"><div align="center">Particulars</div></td>
					<td width="10%"><div align="center">Amount BD </div></td>
					<td width="11%"><div align="center">R O E </div></td>
					<td width="16%"> <div align="center">REMARKS DOCS </div></td>
				  </tr>
				  <tr>
					<td><div align="center">A</div></td>
					<td><u>EXPENSES PAID BY CHEQUE/PAYORDER </u></td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
				  </tr>
				  <tr>
					...
					<td rowspan="4"><div align="center">As per ledger synchronized </div></td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
					<td>Bill rcvd </td>
				  </tr>
				  ...
				  <tr>
				    <td colspan="2"><div align="right" style="margin-right:10px;">SUB TOTAL EXPENSES </div></td>
				    <td>&nbsp;</td>
				    <td>&nbsp;</td>
				    <td>&nbsp;</td>
			      </tr>
		...
		<tr>
            <td colspan="6" style=" border: none; ">
				<table width="100%" border="1">
				  <tr>
					<td width="3%"><div align="center">B</div></td>
					<td width="60%"><u>EXPENSES: (HEAD OF MISC PAID BY CASH) </u></td>
					<td width="10%">&nbsp;</td>
					<td width="11%">&nbsp;</td>
					<td width="16%">&nbsp;</td>
				  </tr>
				  <tr>
					<td><div align="center">1</div></td>
					<td rowspan="7"><div align="center">As per ledger synchronized </div></td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
					<td>Bill rcvd </td>
				  </tr>
            ...
            <td colspan="6" style=" border: none; ">
				<table width="100%" border="1">
				  <tr>
					...
					<td width="60%"><u>OWNER'S EXPENSES PAYABLE BY CHEQUE/P.ORDER </u></td>
					<td width="10%">&nbsp;</td>
					<td width="11%">&nbsp;</td>
					<td width="16%">&nbsp;</td>
				  </tr>
            ...
            <td colspan="6" style=" border: none; ">
				<table width="100%" border="1">
				  <tr>
					...
					<td width="60%"><div align="right"><span style="margin-right:10px;">TOTAL EXPENSES (A+B+C+D)</span></div></td>
					<td width="10%">&nbsp;</td>
					<td width="11%">&nbsp;</td>
					<td width="16%">&nbsp;</td>
				  </tr>
		...
		<tr>
            <td colspan="6" style=" border: none; ">
				<table width="100%" border="1">
				  ...
				  <tr>
					<td><div align="center">1</div></td>
					<td rowspan="3"><div align="center">As per ledger synchronized </div></td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
					<td>Sup.attached </td>
				  </tr>
				  ...
				  <tr>
				    <td colspan="2"><div align="right" style="margin-right:10px;">TOTAL REVENUE </div></td>
				    <td>&nbsp;</td>
				    <td>&nbsp;</td>
				    <td>&nbsp;</td>
			      </tr>
            ...
            <td colspan="6" style=" border: none; ">
				<table width="100%" border="1" style="margin-bottom:80px;">
				  <tr>
					...
					<td width="60%"><div align="right">NET SURPLUS (F-E) </div></td>
					<td width="10%">&nbsp;</td>
					<td width="11%">&nbsp;</td>
					<td width="16%">&nbsp;</td>
				  </tr>
		...
		<tr>
            <td colspan="6" style=" border: none; ">
				<table width="100%" height="100px">
				  <tr>
					<td width="20%" style=" border: none; "><div align="center" style="text-decoration: overline;"><strong>  Prepared By  </strong></div></td>
					<td width="20%" style=" border: none; "><div align="center" style="text-decoration: overline;"><strong>Checked By</strong></div></td>
					<td width="20%" style=" border: none; "><div align="center" style="text-decoration: overline;"><strong>Auditor</strong></div></td>
					<td width="20%" style=" border: none; "><div align="center" style="text-decoration: overline;"><strong>Chairman</strong></div></td>
					<td width="20%" style=" border: none; "><div align="center" style="text-decoration: overline;"><strong>Managing Director</strong></div></td>
				  </tr>
				</table>			 
			</td>
        </tr>
...
elseif($_REQUEST['report']==210617008)
{
...
<table width="100%">
        ...
        <tr>
            <th colspan="4" id="heading"  style=" border: none; ">UNIOCEAN Shipping Lines Ltd</th>
        </tr>
        <tr>
            <th colspan="4"  style=" border: none; "><div align="center">Receipt & Payment Statement</div></th>
        </tr>
        <tr>
            <th colspan="4"  style=" border: none; "><div align="center">Date:</div></th>
        </tr>
		...
		<tr>
            <td colspan="4"  style=" border: none; ">
			  <table width="100%" border="1">
                  <tr>
                    <th width="40%" scope="col">Receipt</th>
                    <th width="10%" scope="col">Taka</th>
                    <th width="40%" scope="col">Payments</th>
                    <th width="10%" scope="col">Taka</th>
                  </tr>
                  <tr>
                    <td>Cash In Hand </td>
                    <td>&nbsp;</td>
                    <td><u>CASH EXPENDITURE </u></td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
                    <td><u>Cash at Bank </u></td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
                    <td>Midland Bank-SND</td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
                    <td>Bank Al-Falah.A/c-286 </td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
                    <td>NRBC Bank - 0011 </td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                  </tr>
		...
		<tr>
            <td colspan="4"  style=" border: none; ">
			  <table width="100%" style="margin-bottom:100px;">
			  	<tr>
                    <td>TK 860,544.00 Cheque issued to parties which is yet to presented for Payment from MDBL -  1819</td>
                </tr>
		      </table>			
			</td>
        </tr>
		...
		<tr>
            <td colspan="4"  style=" border: none; ">
				<table width="100%" height="100px">
				  <tr>
					<td width="25%"  style=" border: none; "><div align="center">
					  <p style="text-decoration: overline;"><strong>  Prepared By  </strong></p>
					  <p style="font-size: 11px; margin-top: -10px;"><strong>(Accounts Dept.) </strong></p></div>
					</td>
					<td width="25%"  style=" border: none; "><div align="center">
					  <p style="text-decoration: overline;"><strong>Checked/Verified By</strong></p>
					  <p style="font-size: 11px; margin-top: -10px;"><strong>Asst. Manager (A&amp;F) </strong></p></div>
					</td>
					<td width="25%"  style=" border: none; "><div align="center">
					  <p style="text-decoration: overline;"><strong>Checked/Verified By</strong></p>
					  <p style="font-size: 11px; margin-top: -10px;"><strong>(Auditor)</strong></p></div>
					</td>
					<td width="25%"  style=" border: none; "><div align="center" >
					  <p style="text-decoration: overline;"><strong>Approved By</strong></p>
					  <p style="font-size: 11px; margin-top: -10px;"><strong>(Chairman &amp; <strong>Managing Director</strong>)</strong></p></div>
					</td>
				  </tr>
				</table>			 
			</td>
...
elseif($_REQUEST['report']==210617009)
{
		$report="Receipt & Payment Statement";		
?>
