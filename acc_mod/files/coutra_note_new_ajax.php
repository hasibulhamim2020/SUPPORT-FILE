...
$sql2="select a.id,a.jv_date , a.jv_no, a.tr_no,l.ledger_name, a.dr_amt,a.cr_amt, a.narration,'Action'
from  secondary_journal a, accounts_ledger l where a.ledger_id=l.ledger_id and a.jv_no='".$_SESSION['jv_no']."' and a.tr_from='".$tr_from."' ";


$all_dealer[]=link_report_add_del_auto($sql2,'',6,7); 
$all_dealer[]=find_a_field('secondary_journal','sum(dr_amt-cr_amt)','tr_from = "'.$tr_from.'" and jv_no='.$_SESSION['jv_no']);
