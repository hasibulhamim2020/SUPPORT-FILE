...
$_POST['acc_sub_sub_class'] = find_a_field('acc_sub_sub_class','id','id='.$_POST['acc_sub_sub_class']); 
...
<tr>
  ...
  <th style="background-color:#45777B;"><span class="style3">Acc. Sub Class</span></th>
...
<? //}?>
    ...
    <td valign="top" width="40%"><div class="right">   <form action="" method="post" enctype="multipart/form-data" name="form1" id="form1" onsubmit="return check()">
                                  ...
                                  <td width="100%" colspan="2"><div class="box" style="width:400px;">
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                     ...
                                     <td><span class="style1" style="padding-top:5px;; color: #FF0000">*</span>GL  Group:</td>
                        				...
                        				<input name="group_name" required type="text" id="group_name" tabindex="1" value="<?=$group_name?>"  class="form-control" >										</td>
                                      </tr>
       ...
       document.getElementById('acc_class').value);" class="form-control">
										<option></option>
									  ...
									  <tr>
										...
										<select name="acc_sub_class" required id="acc_sub_class"  tabindex="2" style="width:220px;" class="form-control">
										<option></option>
									  ...
									  <tr>
                                        ...
                                        <td><select name="group_for" required id="group_for"  tabindex="7" class="form-control" >
                                          <? foreign_relation('user_group','id','group_name',$group_for,'1');?>
                                        </select></td>
                                      </tr>
