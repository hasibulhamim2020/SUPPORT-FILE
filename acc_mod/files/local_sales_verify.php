				...
				<div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
					<div class="container n-form2">
						...
						<div class="form-group row m-0 pb-1">
							<label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">LS Date :</label>
				  ...
				  j.ledger_id = l.ledger_id ".$group_s.$checked_con.$depot_con." group by j.jv_no";
					...
					while($data=mysqli_fetch_row($query)){
						...
						<tr>
							...
							<!--<td><a target="_blank" href="local_sales_print.php?jv_no=<?=$data[10]?>"><img src="../images/print.png" width="20" height="20" /></a></td>-->
							
							<td><a target="_blank" href="local_sales_print.php?c=<?=rawurlencode(url_encode($c_id))?>&v=<?=rawurlencode(url_encode($data[10]))?>"><img src="../images/print.png" width="20" height="20" /></a></td>
...
<input type="button" name="Button" value="YES"  onclick="window.open('local_sales_print.php?c=<?=rawurlencode(url_encode($c_id))?>&v=<?=rawurlencode(url_encode($data[10]))?>');" class="btn btn-success" />
										<?
	...
	<input type="button" name="Button" value="NO"  onclick="window.open('local_sales_print.php?c=<?=rawurlencode(url_encode($c_id))?>&v=<?=rawurlencode(url_encode($data[10]))?>');" class="btn btn-danger" />
