...
$title='GL Reference';			// Page Name and Page Title

do_datatable('table_head');

$page="accounts_gl_reference.php";		// PHP File Name

$table='acc_reference';		// Database Table Name Mainly related to this page

$unique='id';			// Primary Key of this Database table

$shown='reference_name';				// For a New or Edit Data a must have data field
...
<th style="background-color:#45777B;"><span class="style3">Reference Name </span></th>
<th style="background-color:#45777B;"><span class="style3">GL Name</span></th>
</tr>
</thead>
...
$con .='and a.warehouse_name like "%'.$_POST['warehouse_name'].'%" ';
 ...
 $td='select a.'.$unique.',  a.'.$shown.', a.ledger_id from '.$table.' a where 1  '.$con.' order by a.id  ';
                                ...
                                <tr>
                                  ...
                                  <td width="100%" colspan="2"><div class="box" style="width:400px;">
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                     ...
                                     <td><span class="style1" style="padding-top:5px;">*</span>GL Reference :</td>

                                        <td>
										<input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />
                       					<input name="id" type="hidden" id="id" tabindex="1" value="<?=$id?>" readonly>
                        				<input name="reference_name" required type="text" id="reference_name" tabindex="1" value="<?=$reference_name?>"  style="width:220px;" >	
									  ...
									  <tr>
                                        ...
                                        <td><span class="style1" style="padding-top:5px;; color: #FF0000">*</span>GL Name:</td>

                                        <td>
										
										<select name="ledger_id" required id="ledger_id"  tabindex="2" style="width:220px;">
										<option></option>
                      						<? foreign_relation('accounts_ledger','ledger_id','CONCAT(ledger_id, ": ", ledger_name)',$ledger_id,'1');?>
                    					</select></td>
                                      </tr>
