...
echo $_SESSION['proj_name'];
              ...
              $print_url = "https://saaserp.ezzy-erp.com/app/views/acc_mod/files/general_voucher_print_view_for_status.php?c=" . rawurlencode($company_id) . "&v=" . rawurlencode($req_no_qr_data);
