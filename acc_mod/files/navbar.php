...
?>
  ...
  <!-- CSS Files -->
  <link href="../../../dashboard_assets/css/new.css?v=2.1.2" rel="stylesheet" />
...
<div class="content">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-warning card-header-icon">
                  ...
                  <p class="card-category">Total Receive Today</p>
                  <h3 class="card-title"><?=find_a_field('journal','sum(dr_amt)','tr_from="Receive" and jv_date="'.$today.'"');?>
                    <small></small>
                  </h3>
                </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-success card-header-icon">
                  ...
                  <p class="card-category">Total Payment Today</p>
                  <h3 class="card-title"><?=find_a_field('journal','sum(dr_amt)','tr_from="Payment" and jv_date="'.$today.'"');?></h3>
                </div>
                <div class="card-footer">
                  <div class="stats">
                    <i class="material-icons">date_range</i> Last 24 Hours
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-danger card-header-icon">
                  ...
                  <p class="card-category">Total Adjustment Today</p>
                  <h3 class="card-title"><?=find_a_field('journal','sum(dr_amt)','tr_from="Journal_info" and jv_date="'.$today.'"');?></h3>
                </div>
                <div class="card-footer">
                  <div class="stats">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-info card-header-icon">
                  ...
                  <p class="card-category">Total Contra Today</p>
                  <h3 class="card-title"><?=find_a_field('journal','sum(dr_amt)','tr_from="Contra" and jv_date="'.$today.'"');?></h3>
                </div>
                <div class="card-footer">
                  <div class="stats">
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="card card-chart">
                ...
                <div class="card-body">
                  <h4 class="card-title">Receive Last Month</h4>
                  <p class="card-category">
                    <span class="text-success"><i class="fa fa-long-arrow-up"></i> 20% </span> increase.</p>
                </div>
                <div class="card-footer">
                  <div class="stats">
            ...
            <div class="col-md-4">
              <div class="card card-chart">
                ...
                <div class="card-body">
                  <h4 class="card-title">Payment Last Month</h4>
                 <p class="card-category">
            ...
            <div class="col-md-4">
              <div class="card card-chart">
                ...
                <div class="card-body">
                  <h4 class="card-title">Revenue Last Month</h4>
                  <p class="card-category">
  ...
  <script src="../../../dashboard_assets/js/material-dashboard.js?v=2.1.2" type="text/javascript"></script>
  <!-- Material Dashboard DEMO methods, don't include it in your project! -->
  <script src="../../../dashboard_assets/demo/demo.js"></script>
...
include ("../../template/main_layout_navbar.php");
