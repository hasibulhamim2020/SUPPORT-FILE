...
FROM
  ...
  issue_invoice ii
WHERE
  ii.s_inv_id = j.jv_no AND 
  ii.customer = c.customer_id AND 
  ii.item = it.item_id';
...
<body>
  <div align="right"><p align="center" class="caption"><?php echo $_SESSION['proj_name']."<br \>";?></p>
    <p align="center" class="style1">Issue Voucher List </p>
  <br />	  
      <table class="tabledesign" width="75%" border="1" style="border-collapse:collapse; border-color:#C1DAD7" id="grp" align="center" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <th width="8%" align="center">Voucher No</th>
          <th width="12%" align="center">Voucher Date</th>
          <th width="26%" align="center">Name</th>
          <th width="31%" align="center">Item Name</th>
          <th width="11%" align="center">Qty</th>
        ...
        <tr>
          ...
          <td align="center"><?php echo date("Y-m-d",$vno[2]) ?></td>
          <td align="left"><?php echo $vno[3] ?></td>
          <td align="left"><?php echo $vno[4] ?></td>
          <td align="center"><?php echo $vno[5] ?></td>
          <td align="center"><a href="#" onclick="window.opener.document.form1.item.value=<?php echo $vno[6] ?>; window.opener.document.form1.refno.value=<?php echo $vno[0] ?>; window.opener.document.form1.item.select(); closewin();">Select</a></td>
        </tr> 
