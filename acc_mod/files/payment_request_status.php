...
$unique = 'vo_no';
$status = 'UNCHECKED';
$target_url = 'payment_request_print_view.php';
...
$con.= 'and s.jv_date between "'.$_POST['fdate'].'" and "'.$_POST['tdate'].'"';
  ...
  $res='select  	s.jv_no, s.tr_no as Request_id, DATE_FORMAT(s.jv_date, "%d-%m-%Y") as date,  a.ledger_name as bank_name, sum(cr_amt) as Amount, s.checked,   u.fname as entry_by,  s.entry_at from secondary_journal s, accounts_ledger a, user_activity_management u where 
