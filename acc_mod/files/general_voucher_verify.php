			...
			<td><table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" bgcolor="#FF9999">
              ...
              <tr>
                ...
                <td width="43%" rowspan="4"><label>
                  ...
                  <input type="submit" name="submitit" id="submitit" value="Voucher View" style="width:200px; font-weight:bold; font-size:12px; height:30px; color:#090"/>
...
$received = $received + $data[1];
      ...
      <td align="center"><a target="_blank" href="general_voucher_print_view.php?jv_no=<?=$data[1] ?>"><img src="../images/print.png" width="20" height="20" /></a></td>
...
<input type="button" name="Button" value="YES"  onclick="window.open('general_voucher_print_view.php?jv_no=<?=$data[1] ?>');" style=" font-weight:bold;width:40px; height:27px;background-color:#66CC66;"/>
...
<input type="button" name="Button" value="NO"  onclick="window.open('general_voucher_print_view.php?jv_no=<?=$data[1] ?>');" style="font-weight:bold;width:40px; height:27px;background-color:#FF0000;"/>
