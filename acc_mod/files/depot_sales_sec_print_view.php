...

{
	...
	sec_journal_journal($jv_no,$jv,'DepotSales');
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#CCCCCC">
  ...
  <tr>
    ...
    <td width="180" align="right"><a target="_blank" href="../../warehouse_mod/pages/depot_transfer/print_view_acc.php?v_no=<?=$ch->pi_no?>">CH-
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#339900">
  ...
  <tr>
    ...
    <td width="200" align="right"><a target="_blank" href="../../warehouse_mod/pages/depot_transfer/print_view_acc.php?v_no=<?=$ch->pi_no?>">CH-
...
<a target="_blank" href="../../warehouse_mod/pages/pr/chalan_view2.php?v_no=<?=$ch->pr_no?>"></a></div><? }?>
  ...
  <tr>
    ...
    <td><? if($jv->cc_code>0){?>CC CODE: <? echo find_a_field('cost_center','center_name',"id='$jv->cc_code'")?><? }?></td>
