...

{
	...
	sec_journal_journal($jv_no,$jv,'localSales');
...
$ch = find_all_field('warehouse_other_issue_detail','oi_no','oi_no='.$jv->tr_no);
...
echo $_SESSION['proj_name'];
			...
			<td width="17%" align="right" class="qr-code">
              ...
              $print_url = "https://saaserp.ezzy-erp.com/app/views/acc_mod/files/local_sales_print.php?c=" . rawurlencode($company_id) . "&v=" . rawurlencode($req_no_qr_data);
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#CCCCCC">
  ...
  <tr>
   ...
   <?php /*?> <td width="180" align="right"><a target="_blank" href="../../warehouse_mod/other_sales/local_sales_print_view.php?v_no=<?=$ch->oi_no?>">LS-

        <?=$ch->oi_no?>

    </a></td><?php */?>
	
	 <td width="180" align="right"><a target="_blank" href="../../warehouse_mod/other_sales/local_sales_print_view.php?c=<?=rawurlencode(url_encode($c_id))?>&v=<?=rawurlencode(url_encode($ch->oi_no))?>">LS-
...
<a target="_blank" href="../../warehouse_mod/other_sales/local_sales_print_view.php?v_no=<?=$ch->oi_no?>"></a></div><? }else{?>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#339900">
  ...
  <tr>
   ...
   <?php /*?> <td width="200" align="right"><a target="_blank" href="../../warehouse_mod/other_sales/local_sales_print_view.php?v_no=<?=$ch->oi_no?>">LS-

        <?=$ch->oi_no?>

    </a></td><?php */?>
	
	<td width="200" align="right"><a target="_blank" href="../../warehouse_mod/other_sales/local_sales_print_view.php?c=<?=rawurlencode(url_encode($c_id))?>&v=<?=rawurlencode(url_encode($ch->oi_no))?>">LS-
...
<a target="_blank" href="../../warehouse_mod/pages/pr/chalan_view2.php?v_no=<?=$ch->oi_no?>"></a></div><? }?>
...
$sql2="SELECT a.ledger_id,a.ledger_name,cr_amt,dr_amt,b.narration,b.sub_ledger FROM accounts_ledger a, secondary_journal b where b.jv_no='$jv_no' and a.ledger_id=b.ledger_id";
