        ...
        <tr>
          <td width="50%" valign="top"><table width='100%' border="1" cellpadding="2" cellspacing="2" bordercolor="#333333" bgcolor="#FFFFFF" style="border-collapse:collapse">
              <tr align="center">
                ...
                <td align="left" bgcolor="#E0E0E0"><span class="style5"><?=$v?></span></td>
                <td align="left" bgcolor="#E0E0E0"><span class="style5">Folio</span></td>
                <td align="left" bgcolor="#E0E0E0"><span class="style5"><?=$vv?></span></td>
                <td align="left" bgcolor="#E0E0E0" class="style5">Folio</td>
                <td align="left" bgcolor="#E0E0E0"><span class="style5">Narrations</span></td>
                <td align="right" bgcolor="#E0E0E0"><span class="style5">Amount</span></td>
              </tr>
			  <?php 
$pi=0;
$t_amt=0;
