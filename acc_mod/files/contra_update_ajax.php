...
if($ledger_id>0){
 ...
 $jv_val=find_a_field('journal','count(id)',"tr_no='".$tr_no."' and tr_from='Contra'");
  $sj_val=find_a_field('secondary_journal','count(id)',"tr_no='".$tr_no."' and tr_from='Contra' ");
...
if($sj_val>0){
 $del_sj = "delete from secondary_journal where tr_from='Contra' and tr_no = '".$tr_no."'";
 db_query($del_sj);
}
