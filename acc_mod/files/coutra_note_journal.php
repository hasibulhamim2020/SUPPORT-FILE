...
<input name="remarks" type="text" id="remarks" value="<?php echo $jv->remarks?>" class="input1"   <? if($jv->tr_no>0) echo 'readonly'?> />
                    ...
                    <tr>
                      ...
                      <th style="background-color:#45777B;"><span class="style3">Vou No </span></th>
                      ...
                      <th style="background-color:#45777B;"><span class="style3">Amount</span></th>
                     ...
                     <th style="background-color:#45777B;"><span class="style3">Date</span></th>
					 
					 <th style="background-color:#45777B;"><span class="style3">Status</span></th>



<th style="background-color:#45777B;">&nbsp;</th>
                      </tr>
...
from  secondary_journal a where a.tr_from='Journal'  and SUBSTRING(a.tr_no,5,1)='0' and  a.dr_amt>0 and a.checked in ('NO','YES') group by a.tr_no order by a.tr_no desc limit 6";
...
{$dataa[2]=substr($dataa[2],0,20).'...';
                    ...
                    <tr>
					 ...
					 <td><?=$dataa[5]?></td>
                      ...
                      <td  style="padding:1px;" ><a href="general_voucher_print_view_from_journal.php?jv_no=<?php echo $dataa[4];?>" target="_blank"><img src="../images/print.png" width="16" height="16" border="0"></a></td>
                    </tr>
        ...
        <tr>
		  ...
		  <table width="100%" border="1" align="center"  style="border-collapse:collapse; border:1px solid #C1DAD7;" cellpadding="2" cellspacing="2">
            ...
            <tr>
              ...
              <td width="5%" align="center" style="background-color:#45777B;"><span class="style3">Type</span></td>



              <td width="8%" align="center" style="background-color:#45777B;"><span class="style3">GL Code </span></td>
              <td width="31%" align="center" style="background-color:#45777B;"><span class="style3">GL Name </span></td>
              ...
              <td width="10%" align="center" style="background-color:#45777B;"><span class="style3">Reference</span></td>
              <td width="12%" align="center" style="background-color:#45777B;"><span class="style3">Cost Center</span></td>
              ...
              <td width="10%" align="center" style="background-color:#45777B;"><span class="style3">Narration</span></td>
              ...
              <td width="7%" align="center" style="background-color:#45777B;"><span class="style3">Debit</span></td>
			  
			  <td width="7%" align="center" style="background-color:#45777B;"><span class="style3">Credit</span></td>
              ...
              <td width="6%" style="background-color:#45777B;" rowspan="2" align="center">
...
<td width="10%" align="center" style="background-color:#45777B;"><span class="style3">GL Code </span></td>

<td width="25%" align="center" style="background-color:#45777B;"><span class="style3">GL Name </span></td>
<td width="13%" align="center" style="background-color:#45777B;"><span class="style3">Reference</span></td>

<td width="13%" align="center" style="background-color:#45777B;"><span class="style3">Cost Center</span></td>
<td width="11%" align="center" style="background-color:#45777B;"><strong>Narration</strong></td>
<td width="10%" align="center" style="background-color:#45777B;"><span class="style3">Debit</span></td>

<td width="12%" align="center" style="background-color:#45777B;"><span class="style3">Credit</span></td>
<td width="6%" align="center" style="background-color:#45777B;"><strong>Action</strong></td>
</tr>
