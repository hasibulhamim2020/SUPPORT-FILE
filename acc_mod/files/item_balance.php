		    ...
		    Period :                                       </td>
                                      ...
                                      <tr>
                                        ...
                                        <select name="item_name" id="item_name"><option selected value="%">All</option>
	  									<?php $items = db_query("select * from item_group");
...
//  $query="SELECT a.* FROM item_info as a, item_group as b WHERE a.group_id=b.group_id and a.group_id like "'.$_REQUEST['item_name'].'"';

$p='SELECT a.item_name, a.rcvqty, a.saleqty, a.cost_price, a.sale_price FROM item_info as a, item_group as b WHERE a.group_id=b.group_id and a.group_id like "'.$_REQUEST['item_name'].'"';
