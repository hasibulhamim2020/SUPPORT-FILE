...
if(isset($_POST['approve'])){
 $usql = "update secondary_journal set ca_checked = '".$_SESSION['user']['id']."', ca_checked_at = '".date('Y-m-d H:i:s')."' where jv_no = '".$all->jv_no."'";
db_query($usql);
	}
?>
...
<? if($all->ca_checked<1) {?>
<td><input type="submit" name="approve" id="approve" value="Approve" onclick="location.reload();">
</td>
<? }?>
