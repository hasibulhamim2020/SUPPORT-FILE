...
if($_POST['check']=='CHECK')
{
	...
	$ssql='update warehouse_damage_receive set status="CONFIRMED" where or_no="'.$j->tr_no.'"';
	db_query($ssql);
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#339900">
  <tr>
    <td width="1"><input name="button" type="button" onclick="hide();window.print();" value="Print" /></td>
    <td width="200" align="right"><a target="_blank" href="../../damage_mod/pages/damage_report/damage_view_print.php?v_no=<?=$jv->tr_no?>">DR-
        <?=$jv->tr_no?>
    </a></td>
