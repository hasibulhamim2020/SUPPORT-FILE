...
foreign_relation('general_sub_ledger','sub_ledger_id','sub_ledger_name',$sub_ledger_id,"1 and group_for='".$_SESSION['user']['group']."'  order by sub_ledger_id");
						...
						<div class="form-group row  m-0 mb-1 pl-3 pr-3">
							...
							<div class="col-sm-9 col-md-9 col-lg-9 col-xl-9 p-0 pr-2">
								...
								<select name="group_for" id="group_for" class="form-control" >
									<option value="<?php echo $_REQUEST['group_for'];?>"></option>
	  ...
	  $sub_ledger_name_get[$srow->sub_ledger_id]=$srow->sub_ledger_name;
							...
							$total_sql = "select sum(a.dr_amt),sum(a.cr_amt) from journal a,accounts_ledger b".$d_table." where a.ledger_id=b.ledger_id and a.group_for='".$_POST['group_for']."' and a.jv_date between '$fdate' AND '$tdate' and a.ledger_id like '$sledger_id' ".$cc_con.$d_where.$v_type;
							...
							$c="select sum(a.dr_amt)-sum(a.cr_amt) from journal a,accounts_ledger b".$d_table." 
							where a.ledger_id=b.ledger_id and a.group_for='".$_POST['group_for']."' and a.jv_date<'$fdate' 
							and a.ledger_id like '$sledger_id'  ".$cc_con.$d_where.$v_type.$sub_ledger_con;
		 ...
		 from journal a,accounts_ledger b".$d_table." where a.ledger_id=b.ledger_id and a.group_for='".$_POST['group_for']."' and a.jv_date between '$fdate' AND '$tdate' ".$sub_ledger_con.$cc_con.$v_type." and a.ledger_id like '$sledger_id' ".$d_where;
