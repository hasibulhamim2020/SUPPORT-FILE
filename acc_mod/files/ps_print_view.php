...

{
	...
	sec_journal_journal($jv_no,$jv,'PosSales');
...
$pos_all = find_all_field('sale_pos_master','*','pos_id='.$jv->tr_no);
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#CCCCCC">
  ...
  <tr>
    ...
    <td width="180" align="right"><a target="_blank" href="../../../warehouse_mod/pages/pos/pos_print_view.php?v_no=<?=$ch->or_no?>">POS-
...
<a target="_blank" href="../../../warehouse_mod/pages/pos/pos_print_view.php?v_no=<?=$ch->or_no?>"></a></div><? }else{?>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#339900">
  ...
  <tr>
    ...
    <td width="200" align="right"><a target="_blank" href="../../../warehouse_mod/pages/pos/pos_print_view.php?v_no=<?=$pos_all->pos_id?>">POS-
