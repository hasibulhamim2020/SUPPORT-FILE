...
<tr>
  ...
  <th style="background-color:#45777B;"><span class="style3">Accounts Class</span> </th>
</tr>
</thead>
...
echo $td='select a.'.$unique.',  a.'.$shown.', a.acc_class from '.$table.' a where 1  '.$con.' order by a.id  ';
