...

{
	...
	$sql="SELECT DISTINCT 
				...
				WHERE
				 ...
				 if($_POST['user_name']!=''){$sql.=" and journal.user_id=".$_POST['user_name'];}

				$sql.=" group by  journal.jv_no order by id asc";
								  ...
								  <tr>
								    ...
								    <td valign="top"><div class="box"><form id="form1" name="form1" method="post" action=""><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                      ...
                                      <tr>
                                        ...
                                        <td width="40%" align="right">Sales Date<span class="style2">*</span> : </td>
...

		{
			...
			$v_type = $_REQUEST['v_type'];$i++; if($i%2==0)$cls=' class="alt"'; else $cls='';?>
							   ...
							   <tr<?=$cls?>>
								...
								<td><a target="_blank" href="sales_sec_print_view.php?jv_no=<?=$vno[0] ?>"><img src="../images/print_hover.png" width="20" height="20" /></a></td>
