            ...
            <div class="row m-0 p-0 fo-width">
                <div class="col-sm-5">
                    ...
                    <div class="form-check">
                        <input name="report" type="radio" class="radio1" id="210617008" value="210617008"  checked="checked" />
                        <label class="form-check-label p-0" for="210617008">
                            Received & Payment Statement 
                        </label>
                    </div>
                    <div class="form-check">
                        <input name="report" type="radio" class="radio1" id="210617007" value="210617007"  />
                        <label class="form-check-label p-0" for="210617007">
...
document.getElementById('ledger_group').value);" class="form-control" >
					...
					<div class="form-group row m-0 mb-1 pl-3 pr-3">
                        <label for="group_for" class="col-sm-4 m-0 p-0 d-flex align-items-center">Job Name :</label>
                        <div class="col-sm-8 p-0">
                                                <span id="acc_gl_ledger">
                            <select name="ledger_id" id="ledger_id"  class="form-control" >
                                ...
                                <? foreign_relation('cost_center','id','concat(id," - ",center_name)',$id,'1');?>
