...

{
	...
	sec_journal_journal($jv_no,$jv,'DirectSales');
...
echo $_SESSION['proj_name'];
			...
			<td width="17%" align="right" class="qr-code">
              ...
              $print_url = "https://saaserp.ezzy-erp.com/app/views/acc_mod/files/ds_print_view.php?c=" . rawurlencode($company_id) . "&v=" . rawurlencode($req_no_qr_data);
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#CCCCCC">
  ...
  <tr>
    ...
    <?php /*?><td width="180" align="right"><a target="_blank" href="../../sales_mod/direct_sales/ds_print_view.php?v_no=<?=$ch->or_no?>">DS-<?=$ch->or_no?></a></td><?php */?>
	
	
	  <td width="180" align="right"><a target="_blank" href="../../sales_mod/direct_sales/ds_print_view.php?c=<?=rawurlencode(url_encode($c_id))?>&v=<?=rawurlencode(url_encode($ch->or_no))?>">DS-<?=$ch->or_no?></a></td>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#339900">
  ...
  <tr>
    ...
    <?php /*?><td width="200" align="right"><a target="_blank" href="../../sales_mod/direct_sales/ds_print_view.php?v_no=<?=$ch->or_no?>">DS-<?=$ch->or_no?></a></td><?php */?>
	
	<td width="200" align="right"><a target="_blank" href="../../sales_mod/direct_sales/ds_print_view.php?c=<?=rawurlencode(url_encode($c_id))?>&v=<?=rawurlencode(url_encode($ch->or_no))?>">DS-<?=$ch->or_no?></a></td>
