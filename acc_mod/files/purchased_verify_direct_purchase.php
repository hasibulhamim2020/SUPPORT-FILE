...
$title='Direct Purchase Verification';
$now=time();
				...
				<div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
					<div class="container n-form2">
						...
						<div class="form-group row m-0 pb-1">
							<label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">DP Date :</label>
						...
						<div class="form-group row m-0 pb-1">
							<label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">DP Date To :</label>
							<div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
    ...
    <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2">
        <span class="oe_form_group_cell">
            <select name="depot_id" id="depot_id" class="form-control">
                <?php foreign_relation('warehouse','warehouse_id','warehouse_name',$_POST['depot_id'],'use_type="SD" order by warehouse_id'); ?>  
            </select>
        </span>
    </div>
</div>
			...
			<div class="container-fluid p-0 ">
				...
				<div class="n-form-btn-class">
					<input type="submit" name="submitit" id="submitit" value="View DP" class="btn1 btn1-submit-input"/>
				</div>
		...
		<div class="container-fluid pt-5 p-0 ">
			...
			<table class="table1  table-striped table-bordered table-hover table-sm">
				...
				FROM
				  ...
				  warehouse_other_receive_detail r,
...
j.cr_amt>0 and
				  ...
				  j.ledger_id = l.ledger_id ".$group_s.$checked_con.$depot_con." group by j.jv_no";
					...
					while($data=mysqli_fetch_row($query)){
						...
						<!--	<td><a target="_blank" href="direct_purchase_print_view.php?jv_no=<?=rawurlencode(url_encode($data[10]))?>"><img src="../images/print.png" width="20" height="20" /></a></td>-->
							
							<td><a target="_blank" href="direct_purchase_print_view.php?c=<?=rawurlencode(url_encode($c_id))?>&v=<?=rawurlencode(url_encode($data[10]))?>"><img src="../images/print.png" width="20" height="20" /></a></td>
			...
			if(($data[9]=='YES')){
				...
				<!--<input type="button" name="Button" value="YES"  onclick="window.open('direct_purchase_print_view.php?jv_no=<?=rawurlencode(url_encode($data[10]));?>');" class="btn1 btn1-bg-submit"/>-->
				
				<input type="button" name="Button" value="YES"
  onclick="window.open('direct_purchase_print_view.php?c=<?=rawurlencode(url_encode($c_id))?>&v=<?=rawurlencode(url_encode($data[10]))?>');"
  class="btn1 btn1-bg-submit"/>
			...
			<!--	<input type="button" name="Button" value="NO"  onclick="window.open('direct_purchase_print_view.php?jv_no=<?=rawurlencode(url_encode($data[10]));?>');" class="btn1 btn1-bg-cancel"/>-->
				
				<input type="button" name="Button" value="NO"  onclick="window.open('direct_purchase_print_view.php?c=<?=rawurlencode(url_encode($c_id));?>&v=<?=rawurlencode(url_encode($data[10]));?>');" class="btn1 btn1-bg-cancel"/>
        ...
        <tr>
			...
			<td><table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" bgcolor="#FF9999">
              ...
              <tr>
                ...
                <td width="20%"><div align="right"><strong>LP Date :</strong></div></td>
                ...
                <td width="20%" rowspan="4"><label>
                  ...
                  <input type="submit" name="submitit" id="submitit" value="View LP" class="btn1 btn1-submit-input"/>
...
$received = $received + $data[1];
      ...
      <td align="center"><a target="_blank" href="local_purchase_print_view.php?jv_no=<?=$data[10] ?>"><img src="../images/print.png" width="20" height="20" /></a></td>
...
<input type="button" name="Button" value="YES"  onclick="window.open('local_purchase_print_view.php?jv_no=<?=$data[10] ?>');" class="btn1 btn1-bg-submit"/>
...
<input type="button" name="Button" value="NO"  onclick="window.open('local_purchase_print_view.php?jv_no=<?=$data[10] ?>');" class="btn1 btn1-bg-cancel"/>
