...

{
...

	{
		...
		$g="select DISTINCT c.group_name,SUM(dr_amt),SUM(cr_amt),c.group_id FROM accounts_ledger a, journal b,ledger_group c where a.ledger_id=b.ledger_id and a.ledger_group_id=c.group_id and b.jv_date BETWEEN '$fdate' AND '$tdate' and c.group_for=".$_SESSION['user']['group']." AND b.cc_code=$cc_code group by c.group_name";
...

	{
		...
		$g="select DISTINCT c.group_name,SUM(dr_amt),SUM(cr_amt),c.group_id FROM accounts_ledger a, journal b,ledger_group c where a.ledger_id=b.ledger_id and a.ledger_group_id=c.group_id and b.jv_date BETWEEN '$fdate' AND '$tdate' and c.group_for=".$_SESSION['user']['group']." group by c.group_name";
...
?>
  ...
  <tr>
    ...
    <th colspan="5" align="left"><?php echo $g[0];?></th>
...
$cr=$p[2];
  ...
  <tr>
    ...
    <th colspan="2" align="right">Balance : <?php echo number_format(($total_dr-$total_cr),2);?></th>
