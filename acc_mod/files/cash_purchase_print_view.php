...

{
	...
	sec_journal_journal($jv_no,$jv,'Cash_Purchase');
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="background-color:#CCCCCC;">
  ...
  <tr>
    ...
    <td width="180" align="right"><a target="_blank" href="../../../warehouse_mod/pages/cash_purchase_golden/chalan_view2.php?v_no=<?=$ch->or_no?>">CP-
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="background-color:#339900;">
  ...
  <tr>
    ...
    <td width="200" align="right"><a target="_blank" href="../../../warehouse_mod/pages/cash_purchase_golden/chalan_view2.php?v_no=<?=$ch->or_no?>">CP-
...
<a target="_blank" href="../../warehouse_mod/pages/cash_purchase_golden/chalan_view2.php?v_no=<?=$ch->or_no?>"></a></div><? }?>
