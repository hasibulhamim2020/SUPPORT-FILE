...
$title='Cash Purchase Verification';
$now=time();
		...
		<div class="container-fluid bg-form-titel">
				...
				<div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
					<div class="container n-form2">
						...
						<div class="form-group row m-0 pb-1">
							<label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">CP Date :</label>
							<div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
								<input name="do_date_fr" class="form-control" type="text" id="do_date_fr" value="<?=$_POST['do_date_fr']?>" autocomplete="off" required />
							</div>
						</div>
						<div class="form-group row m-0 pb-1">
							<label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">CP Date To :</label>
							<div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
								<input name="do_date_to" type="text" id="do_date_to" value="<?=$_POST['do_date_to']?>" class="form-control" autocomplete="off" required />
							</div>
						</div>
						<div class="form-group row m-0 pb-1">
			...
			<div class="container-fluid p-0 ">
				...
				<div class="n-form-btn-class">
					<input type="submit" name="submitit" id="submitit" value="View CP" class="btn1 btn1-submit-input"/>
				</div>
...
j.cr_amt>0 and
			...
			if(($data[9]=='YES')){
				...
				<input type="button" name="Button" value="YES"  onclick="window.open('cash_purchase_print_view.php?jv_no=<?=$data[10] ?>');" class="btn1 btn1-bg-submit"/>
				...
				<input type="button" name="Button" value="NO"  onclick="window.open('cash_purchase_print_view.php?jv_no=<?=$data[10] ?>');" class="btn1 btn1-bg-cancel"/>
