		    ...
		    Period :                                       </td>
						  ...
						  <option value="">Select Type</option>
							  ...
							  <tr>
								...
								<th width="24%" align="center">Acc Head </th>
								<th width="7%" align="center">Source</th>
								<th width="12%" height="20" align="center">Dr Amt </th>
								<th width="12%" align="center">Cr Amt </th>
								</tr>
<?php
if(isset($_REQUEST['show']))
{
  ...
  <tr>
	...
	if($data[4]=='Receipt'||$data[4]=='Payment'||$data[4]=='Journal_info'||$data[4]=='Contra')
	{
		...
		elseif($data[4]=='Sales')
	{
		$link="sales_sec_print_view.php?jv_no=".$data[8];
		echo "<a href='$link' target='_blank'>".$data[7]."</a>";
	}
