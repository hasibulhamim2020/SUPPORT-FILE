...
$received = $received + $data[1];
      ...
      <!--<td align="center"><a target="_blank" href="general_voucher_print_view_for_approval.php?jv_no=<?=$data[1]?>"><img src="../images/print.png" width="20" height="20" /></a></td>-->
	       ...
	       <td align="center"><a target="_blank" href="general_voucher_print_view_for_approval.php?c=<?=rawurlencode(url_encode($c_id))?>&v=<?=rawurlencode(url_encode($data[1]))?>"><img src="../images/print.png" width="20" height="20" /></a></td>
      ...
      <td align="center"><span id="divi_<?=$data[1]?>">
			...
			onclick="window.open('general_voucher_print_view_for_approval.php?c=<?=rawurlencode(url_encode($c_id))?>&v=<?=rawurlencode(url_encode($data[1]))?>');"
class="btn1 btn1-bg-submit" />
			...
			<input type="button" name="Button" value="NO"  onclick="window.open('general_voucher_print_view_for_approval.php?c=<?=rawurlencode(url_encode($c_id))?>&v=<?=rawurlencode(url_encode($data[1]))?>');" class="btn1 btn1-bg-cancel" />
