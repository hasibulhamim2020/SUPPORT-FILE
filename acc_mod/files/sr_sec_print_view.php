...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#CCCCCC">
  <tr>
	...
	<? if($chalan_no>0){?>
	<?php /*?><a target="_blank" href="../../../views/warehouse_mod/sales_return_invoice/sales_return_print_view.php?v_no=<?=rawurlencode(url_encode($ch->sr_no))?>">SR-<?=$ch->sr_no?></a><?php */?>
	
	<a target="_blank" href="../../../views/warehouse_mod/sales_return_invoice/sales_return_print_view.php?c=<?=rawurlencode(url_encode($c_id))?>&v=<?=rawurlencode(url_encode($ch->sr_no))?>">SR-<?=$ch->sr_no?></a>
	
		<? } else{?>
		<?php /*?>	<a target="_blank" href="../../../views/warehouse_mod/sales_return/sales_invoice_print_view.php?v_no=<?=rawurlencode(url_encode($ch->sr_no))?>">SR-<?=$ch->sr_no?></a><?php */?>
			
			<a target="_blank" href="../../../views/warehouse_mod/sales_return/sales_invoice_print_view.php?c=<?=rawurlencode(url_encode($c_id))?>&v=<?=rawurlencode(url_encode($ch->sr_no))?>">SR-<?=$ch->sr_no?></a>
		<? }?>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#339900">
  <tr>
	...
	<? if($chalan_no>0){?>
	<?php /*?><a target="_blank" href="../../../views/warehouse_mod/sales_return_invoice/sales_return_print_view.php?v_no=<?=$ch->sr_no?>">SR-<?=$ch->sr_no?></a><?php */?>
	
	<a target="_blank" href="../../../views/warehouse_mod/sales_return_invoice/sales_return_print_view.php?c=<?=rawurlencode(url_encode($c_id))?>&v=<?=rawurlencode(url_encode($ch->sr_no))?>">SR-<?=$ch->sr_no?></a>
		<? } else{?>
			<?php /*?><a target="_blank" href="../../../views/warehouse_mod/sales_return/sales_invoice_print_view.php?v_no=<?=$ch->sr_no?>">SR-<?=$ch->sr_no?></a><?php */?>
