...
//{
//$vo_no = find_a_field('journal','tr_no','jv_no='.$_REQUEST['vo_no']);
...
$viewx = 'dr_amt';
 ...
 $sql2="select a.ledger_name,b.* FROM accounts_ledger a, journal b where b.jv_no='".$vo_no."' and a.ledger_id=b.ledger_id ".$con." order by b.id desc";
//echo $sql2="SELECT a.ledger_name,b.* FROM accounts_ledger a, $vtype b where b.$no='$vo_no' and a.ledger_id=b.ledger_id ".$con." order by b.$no desc";
?>
