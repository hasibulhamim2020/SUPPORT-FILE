...

{
	...
	var URL = 'unchecked_voucher_view_popup.php?'+theUrl;
    ...
    <td valign="top"><div class="left_report">
		    ...
		    Voucher Type<span class="style2">*</span> : </td>
										...
										<option></option>
										  ...
										  <option value="Sales"<?php if($vtype=='Salea') echo "selected"?>>Sales Voucher</option>
	  ...
	  ?>
...

		{
			...
			$v_type = $_REQUEST['v_type'];$i++; if($i%2==0)$cls=' class="alt"'; else $cls='';?>
							  ...
							  <tr<?=$cls?> onclick="DoNav('<?php echo 'v_type='.$vno[6].'&vdate='.$vno[3].'&v_no='.$vno[4].'&view=Show' ?>');">
