...
<style>
	#btnExport:hover {
		background-color: #e9fbcd !important;
	}
</style>		
<table class="mt-5" border="0" cellspacing="0" cellpadding="0" align="left">
<tr>
<td>
<!--    <button id="btnExport" type="button" onclick="fnExcelReport();" style="width: 55px;cursor: pointer;border: 0px !important;background-color: white;"><img src="../../../../public/assets/images/xls_hover.png" width="40" height="40"></button>-->
...
<td>
<form class="m-0 pl-1 pr-1" action="ShowForPrint.php" method="post" name="form_print" target="_blank" id="form_print" onsubmit='$("#datatodisplay1").val( $("<div>").append( $("#grp").eq(0).clone() ).html() )'>
