...
$vdate=$vtype."_date";
 ...
 $vo_no = find_a_field('journal','tr_no','jv_no='.$_REQUEST['vo_no'].' and tr_from = "'.ucwords($vtype).'"');
...

{
 ...
 $sql1="select jv_date,cc_code,entry_by from journal where tr_no=$vo_no and tr_from = '".$vtype."' limit 1";
...
$sql2="SELECT a.ledger_name,a.ledger_group_id,b.* FROM accounts_ledger a, journal b where b.tr_no='$vo_no' and b.tr_from = '".$vtype."' and a.ledger_id=b.ledger_id order by b.id";

else

$sql2="SELECT a.ledger_name,a.ledger_group_id,b.* FROM accounts_ledger a, journal b where b.tr_no='$vo_no' and b.tr_from = '".$vtype."' and a.ledger_id=b.ledger_id order by b.dr_amt desc,b.id";
...
echo $_SESSION['user']['concern_name'];
