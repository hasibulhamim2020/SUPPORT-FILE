...
<input type="button" name="Button" value="OK" style="width:40px; height:20px; background-color:#66CC66;"/>
<?
			  }
			  else
			  {
...
<input type="button" name="Button" value="NO"  onclick="update_value(<?=$data[0]?>)" style="width:40px; height:20px;background-color:#FF3366;"/><? }}else echo 'Set ACC CODE';?>
          </span></td>
      </tr>
	  <? }}?>
	        <tr class="alt">
