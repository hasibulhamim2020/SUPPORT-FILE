...
<th style="background-color:#45777B;"><span class="style3">Cost Center </span></th>
...
$con .='and a.warehouse_name like "%'.$_POST['warehouse_name'].'%" ';
 ...
 $td='select a.'.$unique.',  a.'.$shown.', u.group_name, c.category_name from '.$table.' a, cost_category c, user_group u	where  a.category_id=c.id and  a.group_for=u.id    '.$con.' order by a.id  ';
                                  ...
                                  <td width="100%" colspan="2"><div class="box" style="width:400px;">
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                     ...
                                     <td>Cost Center:</td>
                        				...
                        				<input name="center_name" required type="text" id="center_name" tabindex="1" value="<?=$center_name?>"  class="form-control" >	
									  ...
									  <tr>
										...
										<select name="category_id" required id="category_id"  tabindex="7" class="form-control">
