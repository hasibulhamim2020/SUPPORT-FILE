...
if(isset($_POST['convert'])){
 ...
 $so_ms = "INSERT INTO `sale_do_master` (`do_no`, `do_date`,`quo_no` ,`group_for`,`dealer_code`,`delivery_address`,`remarks`, `status`, `depot_id`,`vat_type` ,`vat_box`,`vat`, `ait_box` ,`ait`,`vat_ait_box`,`vat_ait`,`discount`, `cash_discount`,`ref_no`,`po_no`,`entry_at`, `entry_by`) 
 
 
 
 VALUES('".$so_no."', '".$ms_data->do_date."', '".$ms_data->do_no."','".$ms_data->group_for."','".$ms_data->dealer_code."','".$ms_data->delivery_address."', '".$ms_data->remarks."', 'MANUAL','".$ms_data->depot_id."', '".$ms_data->vat_type."','".$ms_data->vat_box."','".$ms_data->vat."','".$ms_data->ait_box."','".$ms_data->ait."' ,'".$ms_data->vat_ait_box."','".$ms_data->vat_ait."','".$ms_data->discount."','".$ms_data->cash_discount."','".$ms_data->ref_no."','".$_POST['po_no']."',
'".$entry_at."', '".$entry_by."' )";
        ...
        <div class="container-fluid bg-form-titel">
            <div class="row">
				...
				<div class="col-sm-5 col-md-5 col-lg-5 col-xl-5">
                    <div class="form-group row m-0">
          <label class="col-sm-5 col-md-5 col-lg-5 col-xl-5 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text"> Active Customer:</label>
                        <div class="col-sm-7 col-md-7 col-lg-7 col-xl-7 p-0">
                ...
                <table class="table1  table-striped table-bordered table-hover table-sm">
                    ...
                    <tbody class="tbody1">
					  ...
					  <tr <?=($data->RCV_AMT>0)?'style="background-color:#FFCCFF"':'';?>>
                            ...
                            <td style="text-align:left"><?= find_a_field('dealer_info','dealer_name_e','dealer_code="'.$data->dealer_code.'"');?></td>
                            ...
                            <td>
								<form action="" method="post" name="codz" id="codz" onSubmit="if(!confirm('Are You Sure Execute this?')){return false;}">
									...
									<input name="convert" type="submit"  id="convert" value="Convert to SO" class="btn1 btn1-submit-input" />
								</form>
							</td>
