...
if ($_REQUEST['old_do_no'] > 0)
    $$unique_master = $_SESSION[$unique_master] = $_REQUEST['old_do_no'];
...
if (prevent_multi_submit()) {
    ...
    if (isset($_POST['new'])) {
        ...
        $manual_num = find_a_field('tr_from_no_setup', 'no_format', 'tr_from="' . $tr_from . '" and group_for="' . $_POST['group_for'] . '" and status="Active"');
        $vars = ['CC' => $_POST['group_for'], 'WW' => $_POST['depot_id']];
        $_POST['manual_do_no'] = next_code_dynamic($manual_num, $table_master, 'manual_do_no', $vars, $_POST['do_date']);
        ...
        if (!isset($_SESSION[$unique_master])) {
            ...
            $$unique_master = $_SESSION[$unique_master] = $crud->insert();
            db_query("INSERT INTO sale_do_master_del select * from sale_do_master where do_no=" . $$unique_master . "");

            $tr_type = "Initiate";
            $tr_no = $$unique_master;
            $type = 1;
            $msg = 'Sales Order No Created. (SO No :-' . $_SESSION[$unique_master] . ')';
        } else {
            unset($_POST['job_no']);
            unset($_POST['job_id']);
            unset($_POST['year']);
...
//}
        ...
        $tr_no = $$unique_master;
        $tr_id = $xid;
        db_query("INSERT INTO sale_do_details_del select * from sale_do_details where id=" . $tr_id . "");
...
if ($del > 0) {
    ...
    if ($del > 0) {
        $tr_type = "Item delete";
        $tr_no = find_a_field('sale_do_details', 'do_no', 'id="' . $del . '"');
        $tr_id = $del;
        $condition = $unique_detail . "=" . $del;
        db_query("INSERT INTO sale_do_details_del select * from sale_do_details where id=" . $del . "");
...
if ($$unique_master > 0)
    $btn_name = 'Update SO Information';
else
    $btn_name = 'Initiate SO Information';
...
<div class="form-container_large">
            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
                    <div class="container n-form2">
                        <div class="form-group row m-0 pb-1">
                            <label
                                class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">Order
                                No</label>
                            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">

                                <input name="do_no" type="text" id="do_no" value="<? if ($$unique_master > 0)
                                    echo $$unique_master; ?>" readonly />
                        ...
                        <div class="form-group row m-0 pb-1">
                            ...
                            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2">
                                <input name="do_date" type="text" id="do_date"
                                    value="<?= ($do_date != '') ? $do_date : date('Y-m-d') ?>" required />
                            </div>
                        </div>
                        <? } ?>
                        ...
                        <div class="form-group row m-0 pb-1">
                            ...
                            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2">
                                ...
                                <input name="do_date2" type="text" id="do_date2" value="<?= $do_date; ?>" readonly=""
                                    required />
                        ...
                        <div class="form-group row m-0 pb-1">
                            <label
                                class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">Company</label>
                            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2">
                        ...
                        <div class="form-group row m-0 pb-1">
                            <label
                                class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">Delivery
                                Address</label>
                            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2">
                                <input name="delivery_address" type="text" id="delivery_address"
                        ...
                        <div class="form-group row m-0 pb-1">
                            <label
                                class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">Contact
                                Person</label>
                            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2">
                        ...
                        <div class="form-group row m-0 pb-1 <?= ($credit_limit > 0) ? '' : 'd-none' ?> "
                            id="credit_box">
                            <label
                                class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">Credit
                                Limit</label>
                            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2">
                                <input name="credit_limit" type="text" id="credit_limit" value="<?= $credit_limit; ?>"
                                    readonly="readonly" />

                            </div>
                        </div>

                        <div class="form-group row m-0 pb-1 <?= ($received_amt > 0) ? '' : 'd-none' ?> "
                            id="adv_box_amt">
                            <label
                                class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">Advance
                                Amount</label>
                            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2">
                                <input name="received_amt" type="text" id="received_amt"
                                    value="<?= $received_amt; ?>" />

                            </div>
                        </div>

                        <div class="form-group row m-0 pb-1 <?= ($receive_acc_head > 0) ? '' : 'd-none' ?> "
                            id="adv_box_ledger">
                            <label
                                class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">Bank/Cash
                                Ledger</label>
                            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2">
                ...
                <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
                    <div class="container n-form2">
                        ...
                        <div class="form-group row m-0 pb-1">
                            <label
                                class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">Job
                                No</label>
                            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
                                <input name="job_no_duplicate" type="text" id="job_no_duplicate" value="<?= $job_no ?>"
                                    readonly="" tabindex="105" />
                            </div>
                        </div>
                        <? } ?>
                        ...
                        <div class="form-group row m-0 pb-1">
                            ...
                            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
                                <?php if ($dealer_code) { ?>
                                <input type="text" name="dealer_code_combo" id="dealer_code_combo"
                                    value="<?= find_a_field('dealer_info', 'concat(dealer_name_e,"#",dealer_code)', 'dealer_code="' . $dealer_code . '"') ?>"
                                    readonly />
                                <? } else { ?>
                                <input type="text" list="dealer"
                                    value="<?= find_a_field('dealer_info', 'concat(dealer_name_e,"#",dealer_code)', 'dealer_code="' . $dealer_code . '"') ?>"
                                    name="dealer_code_combo" id="dealer_code_combo"
                                    onchange="get_dealer_info(this.value)" required autocomplete="off" />
                                <datalist id="dealer">
                                    <option></option>
                        ...
                        <div class="form-group row m-0 pb-1">
                            <label
                                class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">Balance</label>
                            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2">
                                <? if ($dealer_code) {
                                ...
                                <input name="c_balance" type="text" id="c_balance"
                                    value="<?= $c_balance - $pending_amt - $p_chalan; ?>" readonly="readonly" />
                        ...
                        <div class="form-group row m-0 pb-1">
                            <label
                                class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">Attachment</label>
                            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2">
                                ...
                                <a href="../../../controllers/uploader/upload_view.php?proj_id=<?= $_SESSION['proj_id'] ?>&&folder=sales&&name=<?= $file_upload; ?>"
                                    target="_blank">
                                    View Attachment</a>
                                <?php } ?>
                            </div>
   ...
   <?php } ?> <?php */ ?>
            ...
            <div class="n-form-btn-class">
                ...
                <input name="new" type="submit" class="btn1 btn1-bg-submit" value="Initiate Sales Order"
                    tabindex="12" />
                    ...
                    <tr>
                        ...
                        <td id="so_data_found" colspan="4">
                            ...
                            <table width="100%" border="1" align="left" cellpadding="0" cellspacing="2">
                                <tr>
                                    <td width="40%"><input name="item_name" type="text" readonly="" autocomplete="off"
                                            value="" id="item_name" /> </td>
                                    <td width="20%"><input name="pcs_stock" type="text" readonly="" autocomplete="off"
                                            value="" id="pcs_stock" /></td>
                                    <td width="20%"><input name="ctn_price" type="text" id="ctn_price" readonly=""
                        ...
                        <td><input name="ctn_unit" type="text" id="ctn_unit" required="required" value=""
                                onchange="count()" /></td>
                        <td>
                            <input name="pkt_unit" type="text" id="pkt_unit" required="required" value=""
                                onchange="count()" />
                        </td>
                        <td>
                            <input name="dist_unit" type="text" class="input3" id="dist_unit" value=""
                                onchange="count()" />
                        </td>

                        <td>
                            <input name="total_unit" type="text" id="total_unit" readonly />
                        </td>
                ...
                <tbody class="tbody1">
                    ...
                    <tr>
                        ...
                        <td><? if ($ch_exist == 0) {
                            ...
                            <input name="dist_unit_new_<?= $data->id; ?>" type="text" class="input3"
                                id="dist_unit_new_<?= $data->id; ?>" value="" />
                            <? } ?>
                        </td>
                        ...
                        <? } else { ?>
                        <td><input type="button" class="btn1 btn1-bg-update" value="UPDATE"
                                onclick="data_update(<?= $data->id ?>,<?= $data->do_no ?>)" /></td>
                        <? } ?>
                    </tr>
    ...
    <!--button design start-->
    <form action="select_dealer_do.php" method="post" name="cz" id="cz"
        ...
        <div class="container-fluid p-0 ">
            ...
            <div class="n-form-btn-class">
                ...
                <input name="confirm" type="submit" class="btn1 btn1-bg-submit" value="CONFIRM SO." />
                <? } else {
                    echo "Check credit limit activition or Balance ...";
                } ?>
            </div>
                ...
                success: function (response) {
                    ...
                    if (res) {
                        ...
                        if (res['bank_reconsila'] == 'YES') {
                            $('#adv_box_amt').removeClass('d-none');
                            $('#adv_box_ledger').removeClass('d-none');
                        } else {
                            $('#received_amt').val('');
                            $('#adv_box_amt').addClass('d-none');
                            $('#adv_box_ledger').removeClass('d-none');
                        ...
                        $('#credit_limit').val('');
                        $('#c_balance').val('');
                        $('#adv_box_ledger').addClass('d-none');
                        $('#adv_box_amt').removeClass('d-none');
                        $('#c_balance').val('');
                    }
                },
