    ...
    <td><div id="pr">
      ...
      <table width="100%" class="tabledesign" border="1" bordercolor="#000000" cellspacing="0" cellpadding="5"  style="font-size:12px">
        ...
        <tr>
          ...
          <td width="18%" rowspan="2" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Item Name </strong></td>
          <td width="10%" rowspan="2" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Style No </strong></td>
          <td width="10%" rowspan="2" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>PO No </strong></td>
          <td width="10%" rowspan="2" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Destination</strong></td>
          <td width="10%" rowspan="2" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Referance</strong></td>
          <td width="10%" rowspan="2" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>SKU No</strong></td>
          <td width="10%" rowspan="2" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Pack Type </strong></td>
          <td width="10%" rowspan="2" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Color</strong></td>
          <td width="10%" rowspan="2" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Size</strong></td>
          <td width="10%" rowspan="2" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Printing Info</strong></td>
          <td width="18%" rowspan="2" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Additional Info</strong></td>
          <td width="18%" rowspan="2" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Additional</strong><strong> Charge </strong></td>
          <td width="18%" rowspan="2" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Unit</strong></td>
          <td width="18%" colspan="6" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Measurement</strong></td>
          <td width="13%" rowspan="2" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Sqm</strong></td>
          <td width="13%" rowspan="2" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Paper Combination</strong></td>
          <td width="13%" rowspan="2" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Sqm Rate </strong></td>
          <td width="13%" rowspan="2" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Pcs Price</strong></td>
          <td width="13%" rowspan="2" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong> Negotiate Price</strong></td>
          <td width="9%" rowspan="2" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Quantity</strong></td>
          <td width="9%" rowspan="2" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Value</strong></td>
          <td width="9%" rowspan="2" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Delivery Place </strong></td>
          <td width="9%" rowspan="2" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Delivery Date </strong></td>
          </tr>
        <tr>
          <td align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>L</strong></td>
          <td align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>W</strong></td>
          <td align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>H</strong></td>
          <td align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Ply</strong></td>
          <td align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>WL</strong></td>
          <td align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>WW</strong></td>
        </tr>
        
        <?  $sqlc = 'select c.*, i.item_id, i.item_name from sale_do_details c, item_info i,  item_sub_group s, item_group g where i.item_id=c.item_id and i.sub_group_id=s.sub_group_id and s.group_id=g.group_id  and c.do_no='.$do_no.' group by c.id order by c.id asc';
        ...
        <tr style="font-size:12px;">
          ...
          <td align="left" valign="top"><?=$datac->additional_charge;?></td>
          <td align="left" valign="top"><?=$datac->measurement_unit;?></td>
          <td align="left" valign="top"><?=$datac->L_cm;?></td>
          <td align="left" valign="top"><?=$datac->W_cm;?></td>
          <td align="left" valign="top"><?=$datac->H_cm;?></td>
          <td align="left" valign="top"><?=$datac->ply;?></td>
          <td align="left" valign="top"><?=$datac->WL;?></td>
          <td align="left" valign="top"><?=$datac->WW;?></td>
          <td align="left" valign="top"><?=$datac->sqm;?></td>
          <td align="left" valign="top"><?=$datac->paper_combination;?></td>
          <td align="left" valign="top"><?=$datac->sqm_rate;?></td>
          <td align="left" valign="top"><?=$datac->final_price;?></td>
          <td align="left" valign="top"><?=$datac->unit_price;?></td>
          ...
          <td align="center" valign="top"><?=find_a_field('delivery_place_info','delivery_place','id='.$datac->delivery_place);?></td>
          <td align="center" valign="top"><?php echo date('d-m-Y',strtotime($datac->delivery_date));?></td>
          </tr>
		...
		?>
        <tr style="font-size:12px;">
        <td colspan="25" align="right" valign="middle"><strong> Total:</strong></td>
