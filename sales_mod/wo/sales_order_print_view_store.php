...
//$do_no 		= url_decode(str_replace(' ', '+', $_REQUEST['v_no']));
...
<div class="body">
	<div class="header">
		...
		<td width="17%" align="right" class="qr-code">
              ...
              $print_url = "https://saaserp.ezzy-erp.com/app/views/sales_mod/wo/sales_order_print_view_store.php?c=" . rawurlencode($company_id) . "&v=" . rawurlencode($req_no_qr_data);
...
<td  align="center"><?=$data->total_unit?></td>
</tr>
