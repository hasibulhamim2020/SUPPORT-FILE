...
3. In vendor information, if the 'Acc Verification'  is yes, then it will send to Accounts department first to verify. Then you can find it in 'Sales Module - Unapproved SO List'.
...
-->
	...
	<div class="form-container_large">
					...
					<div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
						<div class="container n-form2">
							...
							<div class="form-group row m-0 pb-1">
								...
								<div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2">
									<?php /*?><select  id="depot_id" name="depot_id" class="form-control">
										<? foreign_relation('warehouse','warehouse_id','warehouse_name',$depot_id,'warehouse_id="'.$_SESSION['user']['depot'].'"');?>
									</select><?php */?>
									
									
									<?php	if($dealer_code){ ?>
											<input type="text" name="depot_id" id="depot_id" value="<?=find_a_field('warehouse','concat(warehouse_name,"#",warehouse_id)','warehouse_id="'.$depot_id.'"')?>" readonly />
									<?	}else{ ?>
		...
		<? if($$unique_master>0){?>
			...
			<div class="container-fluid pt-5 p-0 ">
			<?
			  $res='select a.id,b.item_name,a.item_id,a.unit_name, a.unit_price,a.pkt_unit,a.dist_unit, a.total_unit, a.total_amt as Net_sale, a.discount, a.vat_amt, a.total_amt_with_vat,a.do_no,a.gift_id from
