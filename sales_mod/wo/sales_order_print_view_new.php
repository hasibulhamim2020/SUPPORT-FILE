...
<div class="main-content">
	...
	<div id="pr">
        <div align="left">
			 ...
			 <span> 
				 <button style="background: #33ACFF ; border-style:dotted ;border: groove; border-radius:10px"">
				 <a style="color: #000000" href="../wo/sales_order_print_view_new_pdf.php?v_no=<?=$do_no?>" target="_blank">PDF.copy</button>
			 </span> 
