...
and "'.date('Y-m-d').'"';}
          ...
          $res ='select a.do_no,a.entry_by,a.do_date,a.dealer_code,d.dealer_name_e,u.fname,a.depot_id,a.entry_by,w.warehouse_id,w.warehouse_name,wd.user_id

  from sale_do_master a,dealer_info d,user_activity_management u, warehouse w, warehouse_define wd

  where a.dealer_code=d.dealer_code and a.entry_by=u.user_id and a.depot_id=w.warehouse_id and wd.status="Active" and w.warehouse_id=wd.warehouse_id and a.entry_by=wd.user_id and  a.status="MANUAL" '.$con.' order by a.do_no desc';
