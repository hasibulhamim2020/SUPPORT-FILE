...
$data=explode('##',$str);
 ...
 $item_all= find_all_field('item_info','','finish_goods_code="'.$item_id.'"');
 $item_id = $item_all->item_id;
...
<tr bgcolor="#CCCCCC">
	 ...
	 <td width="8%"><input name="unit_name" type="text" class="input3"  value="<?=$item_all->unit_name;?>" id="unit_name" style="width:50%; height:30px;" /></td>
	<td width="13%"><input name="do_price" type="text" class="input3"  value="<?=$item_all->d_price;?>" id="do_price" style="width:90%; height:30px;" /></td>
	 <td width="13%"><input name="unit_price" type="text" class="input3" id="unit_price" style="width:90%; height:30px;" required="required"  value="<?=$item_sales_price?>" onkeyup="count()" /></td>
</tr>
