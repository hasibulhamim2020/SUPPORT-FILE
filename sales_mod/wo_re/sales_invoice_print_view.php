 ...
 <tr> <td><hr /></td></tr>
  ...
  <tr><td>&nbsp;</td></tr>
  	...
  	<tr height="30">
  	  ...
  	  <td width="50%"  style="text-align:center; "><span style="color:#FFF; font-size:18px; background:#CCCCCC; padding:8px 20px; color:#000000; font-weight:bold; border: 2px solid #000000; border-radius: 5px; ">
			  ...
			  <tr>
		          ...
		          <td><table width="100%" border="1" cellspacing="0" cellpadding="5" style=" ">
		            ...
		            <tr>
		              ...
		              <td ><span style="font-size:14px; " class="style8">Sales Type: <?php echo find_a_field('sales_type','sales_type','id='.$master->sales_type);?> &nbsp;</span></td>
		              </tr>
...
<th width="7%" bgcolor="#CCCCCC"><span role="presentation" dir="ltr">Net Amt  </span></th>
<th width="7%" bgcolor="#CCCCCC">VAT (<?=$master->vat?>%) </th>
<th width="7%" bgcolor="#CCCCCC">Amt With Vat </th>
</tr>
...
<td><?=$data->total_amt_with_vat; $tot_total_amt_with_vat +=$data->total_amt_with_vat;?></td>
        </tr>
...
<td><strong>
  <?=number_format($tot_total_amt_with_vat,2);?>
</strong></td>
        </tr>
      </table>      </td>
  </tr>
		  ...
		  <tr>
		    ...
		    <td valign="top">
		      ...
		      <table width="100%" border="0" cellspacing="0" cellpadding="3"  style="font-size:13px">
		          ...
		          <td><table width="100%" height="65" border="1" cellpadding="3" cellspacing="0">

		            <tr>

		              <td valign="top"><span style="font-size:14px; font-weight:500; letter-spacing:.3px;" class="style8">
					  In Word: SAR
            <?

//$taxable_amount =  $tot_total_amt-$master->cash_discount;
//$tot_vat_amt = ($taxable_amount*$master->vat)/100;
$amount_including_vat = $tot_total_amt_with_vat-$master->cash_discount;
			...
			<td width="40%">
			    ...
			    <table width="100%" border="0" cellspacing="0" cellpadding="3"  style="font-size:13px">
			      ...
			      <tr>
			        ...
			        <td><table width="100%" border="1" cellspacing="0" cellpadding="6">
			          
			          <tr>
			            
			            <td width="68%"><strong>Sub Total </strong></td>
			        ...
			        <td><table width="100%" border="1" cellspacing="0" cellpadding="6">
			          ...
			          <tr>
			            ...
			            <td width="68%"><strong>VAT</strong><strong> (<?=$master->vat?>%) </strong>&nbsp;</td>
			        ...
			        <td><table width="100%" border="1" cellspacing="0" cellpadding="6">
			          ...
			          <tr>
			            ...
			            <td width="68%"><strong>Cash Discount</strong></td>
			        ...
			        <td><table width="100%" border="1" cellspacing="0" cellpadding="6">
			          ...
			          <tr>
			            ...
			            <td width="68%"><strong>Total Amount SAR 
			              
			              </strong>&nbsp;</td>
						  
						   <td width="32%"><strong>
			              <?=number_format($amount_including_vat = $tot_total_amt_with_vat-$master->cash_discount,2);?>
			              </strong>&nbsp;</td>
	                    </tr>
