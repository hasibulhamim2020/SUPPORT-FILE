...
$title='Distribution Co-Ordinator Approval';
do_calander('#fdate');
do_calander('#tdate');
...
$target_url = '../cdo/di_do_check.php';
...
where m.status in ('PROCESSING') and m.received_amt>=0 and received_status='received' and m.sa_approval='APPROVED' and m.dealer_code=d.dealer_code ".$con."
