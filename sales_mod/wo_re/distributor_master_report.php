...
?>
<table width="100%" cellspacing="0" cellpadding="2" border="0">
<thead><tr><td style="border:0px;" colspan="15"><?=$str?></td></tr><tr>
<th>S/L-1</th>
<th>Chalan No</th>
<th>Do No</th>
<th>Do Date</th>
...
<td><?=$s?></td>
<td><a href="../../../warehouse_mod/pages/wo/delivery_challan_print_view.php?v_no=<?=$data->chalan_no?>" target="_blank"><?=$data->chalan_no?></a></td>
<td><?=$data->do_no?></td>
<td><?=$data->do_date?></td>
...
?><tr class="footer"><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td>
  <td>&nbsp;</td>
  <td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td>
<td>&nbsp;</td>
<td><?=number_format(($tp_t),2)?></td>
<td><?=number_format(((-1)*$dp_t),2)?></td>
<td><?=number_format(($sp_dp_t),2)?></td>
<td><?=number_format($tas,2);?></td>
...
elseif($_REQUEST['report']==20003) { // dealer wise item chalan report
...
<table width="100%" cellspacing="0" cellpadding="2" border="0">
<thead><tr>
<td style="border:0px;" colspan="19">
<div class="header">
<h2><strong><?=find_a_field('user_group','group_name','id='.$_SESSION['user']['group']);?></strong></h2>
<h2><?=$report?></h2>
<h2>Period <?=$fr_date?> To <?=$to_date?></h2></div><div class="left"></div><div class="right"></div><div class="date">Reporting Time: <?=date("h:i A d-m-Y")?></div></td></tr>
<tr>
    <th>SL</th>
    <th>Chalan No </th>
    <th>Chalan Date </th>
...
i.item_name,i.unit_name as unit,i.item_brand as brand,i.pack_size,
c.pkt_unit as ctn,c.dist_unit as pcs,c.total_unit as total_pcs,c.unit_price as rate,total_amt,
d.region_code as region,d.zone_code as zone,d.area_code

from dealer_info d, sale_do_chalan c, item_info i 
where d.dealer_code=c.dealer_code and c.item_id=i.item_id 
'.$con.$date_con.$warehouse_con.$item_con.$item_brand_con.$dealer_type_con.$dealer_code_con.$region_con.$zone_con.' 
and i.finish_goods_code!=2000 and i.finish_goods_code!=2001
...
<table width="100%" cellspacing="0" cellpadding="2" border="0"><thead><tr><td style="border:0px;" colspan="14"><div class="header"><h1>Jamuna Industrial Agro Group</h1><h2>Closing Report</h2>
