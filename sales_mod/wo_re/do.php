						...
						<div class="container n-form2">
							...
							<!--<div class="form-group row m-0 pb-1">
								...
								<div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2">
									  ...
									  <a href="../../../assets/support/upload_view.php?name=<?=$do_file?>&folder=do_distributor" target="_blank">View File</a>
...
<? foreign_relation('dealer_info d,dealer_type t','d.dealer_code','concat(d.dealer_name_e,". #",t.dealer_type)',$dealer_code_combo,'d.dealer_type=t.id');?>
							...
							<div class="form-group row m-0 pb-1">
								...
								<div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2">
									...
									<!--<input  name="payment_by" type="text" id="payment_by" value="<?=$payment_by;?>"  required />-->
											...
											<?php /*?><option></option>
											<option <?=($payment_by=='CHEQUE')?'selected':''?>>CHEQUE</option><?php */?>
							...
							<div class="form-group row m-0 pb-1">
								...
								<div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2">
									...
									<option></option>
									<? foreign_relation('accounts_ledger a,ledger_group g','a.ledger_id','a.ledger_name',$receive_acc_head,'a.ledger_group_id=g.group_id order by ledger_name');?>
									</select>
								</div>
							</div>
			...
			<table class="table1  table-striped table-bordered table-hover table-sm">
					...
					<tr>
						<td id="sub">
							...
							<input name="item_id" list="item" type="text" value="" id="item_id" onblur="getData2('sales_invoice_ajax.php', 'so_data_found', this.value, document.getElementById('do_no').value);" autocomplete="off"/>
							<datalist id="item">
							 <option></option>
		...
		<? if($$unique_master>0){?>
			...
			<div class="container-fluid pt-5 p-0 ">
			<?
			   $res='select a.id,b.item_name,a.item_id,b.finish_goods_code,a.unit_name, a.unit_price, a.pkt_unit,a.total_unit, a.total_amt as Net_sale, a.discount, a.vat_amt, a.total_amt_with_vat from
