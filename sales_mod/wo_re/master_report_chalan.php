...
$query =db_query($sql);
?>
<table width="100%" cellspacing="0" cellpadding="2" border="0"><thead><tr><td style="border:0px;" colspan="10"><div class="header"><h1>Jamuna Industrial Agro Group</h1><h2><?=$report?></h2>
...
$query =db_query($sql);
?>
<table width="100%" cellspacing="0" cellpadding="2" border="0"><thead><tr><td style="border:0px;" colspan="13"><div class="header"><h1>Jamuna Industrial Agro Group</h1><h2><?=$report?></h2>
...
$sql2='select 
		...
		where d.dealer_code=m.dealer_code and m.id=a.order_no  and   
	a.unit_price = 0 and m.item_id=i.item_id '.$con.$date_con.$warehouse_con.$item_con.$item_brand_con.$dtype_con.$super_con.$region_con.$zone_con.' 
	group by  m.gift_on_item order by i.finish_goods_code';
	$query2 = db_query($sql2);
	while($data2 = mysqli_fetch_object($query2))
	{
...
?>
<tr><td><?=++$s?></td><td><?=$data->fg?></td><td><?=$data->item_name?></td><td><?=$data->unit?></td><td><?=$data->brand?></td><td><?=$data->pack_size?></td><td><?=$data->pkt?></td><td><?=$data->pcs?></td><td><?=$data->qty?></td>
...
?>
<tr class="footer"><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td style="text-align:right"><?=number_format($actual_total,2)?></td><td><span style="text-align:right"><?=number_format($dis_total,2)?></span></td>
...
{
?>
<table width="100%" cellspacing="0" cellpadding="2" border="0"><thead><tr><td style="border:0px;" colspan="8"><?=$str?><div class="left"></div><div class="right"></div><div class="date">Reporting Time: <?=date("h:i A d-m-Y")?></div></td></tr>
