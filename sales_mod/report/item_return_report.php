...
$datas=find_all_field('sale_return_details','s','do_no='.$do_no);
$vendor = find_all_field('dealer_info','s','dealer_code='.$datas->dealer_code);
$sql1="select b.* from sale_return_master b where b.do_no = '".$do_no."'";
$data1=db_query($sql1);
...
$rec_frm=$info->dealer_name_e;
$vendor_name=$info->dealer_name_e;
$vendor_id=$info->dealer_code;
$or_subject=$info->remarks;
$do_date=$info->do_date;
}

$sql1="select b.* from sale_return_details b where b.do_no = '".$do_no."'";
$data1=db_query($sql1);
...
$amount[] = $info->unit_price*$info->total_unit;
		  ...
		  <tr>
		      ...
		      <table width="100%" border="0" cellspacing="0" cellpadding="3"  style="font-size:13px">
		        <tr>
		          ...
		          <td><table width="100%" border="1" cellspacing="0" cellpadding="3">
		            <tr>
		              <td><?php echo $vendor->dealer_name_e;?> - &nbsp;<?php echo $vendor->dealer_code;?></td>
		              </tr>
		            </table></td>
		          </tr>
		        ...
		        <tr>
		          ...
		          <td><table width="100%" border="1" cellspacing="0" cellpadding="3">
                      <tr>
                        <td><?=$vendor->address_e.'<br>Mobile: '.$vendor->contact_no?>&nbsp;</td>
                      </tr>
                  </table></td>
		          </tr>
			...
			<td width="30%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="3"  style="font-size:13px">
			  ...
			  <tr>
			    ...
			    <td><table width="100%" border="1" cellspacing="0" cellpadding="3">
                    <tr>
                      <td><?=date("d M, Y",strtotime($do_date))?>
                        &nbsp;</td>
                    </tr>
                </table></td>
			    </tr>
