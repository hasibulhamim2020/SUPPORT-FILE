        ...
        <div class="row m-0 p-0">
            <div class="col-sm-5">
             ...
             <!-- <div class="form-check">
                    ...
                    <label class="form-check-label p-0" for="report1-btn">Sales Order Report</label>
                    </div>-->
				
				
			<div class="col-sm-5">
                <div align="left">Collection Report </div>
              
				<div class="form-check">
                    <input name="report" type="radio" class="radio1" id="report1-btn" value="191199" />
                    <label class="form-check-label p-0" for="report1-btn">Customer Statement Report</label>
				</div>
