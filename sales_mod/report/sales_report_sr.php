...
<div class="d-flex justify-content-center">
    <form class="n-form1 pt-4" action="master_report_sr.php" method="post" name="form1" target="_blank" id="form1">
        <div class="row m-0 p-0">
            ...
            <div class="col-sm-7">
				<div class="form-group row m-0 mb-1 pl-3 pr-3">
					...
					<input type="text" list="item" name="item_id" id="item_id" />
					<datalist id="item">
					<option></option>
