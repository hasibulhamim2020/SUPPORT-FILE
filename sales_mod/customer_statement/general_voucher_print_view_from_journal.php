	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	  <tr>
	    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="1%">
			<img src="<?=SERVER_ROOT?>public/uploads/logo/<?=$_SESSION['user']['group']?>.png" style="width:90px;" />		</td>
            <td width="83%"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td align="center" class="title">

				<? echo find_a_field('user_group','group_name',"id=".$_SESSION['user']['group']);?>                </td>
              </tr>
              <tr>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#00CC00">
  <tr>
	...
	<? if($jv->tr_from=='Sales'){?>
	<a target="_blank" class="jvbutton" href="../wo/sales_invoice_print_view.php?v_no=<?=$jv->tr_no;?>">Invoice View # <?=$jv->tr_no;?> </a>	
	<? }?>
	
	<? if($jv->tr_from=='Sales Return'){?>
	<a target="_blank" class="jvbutton" href="../sales_return/sales_invoice_print_view.php?v_no=<?=$jv->tr_id;?>">SR View # <?=$jv->tr_no;?> </a>	
	<? }?>
	
	<? if($jv->tr_from=='Goods Return'){?>
	<a target="_blank" class="jvbutton" href="../sales_return/sales_invoice_print_view.php?v_no=<?=$jv->tr_id;?>">SR View # <?=$jv->tr_no;?> </a>	
	<? }?>
	
	<? if($jv->tr_from=='Damage Return'){?>
	<a target="_blank" class="jvbutton" href="../sales_return/sales_invoice_print_view.php?v_no=<?=$jv->tr_id;?>">SR View # <?=$jv->tr_no;?> </a>	
	<? }?>
	
	<? if($jv->tr_from=='Purchase'){?>
	<a target="_blank" class="jvbutton" href="../../../purchase_mod/pages/posp/po_print_view.php?po_no=<?=$jv->tr_id;?>">PO View # <?=$jv->tr_no;?> </a>	
	<? }?>
