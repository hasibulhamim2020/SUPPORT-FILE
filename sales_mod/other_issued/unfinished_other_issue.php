...
<th width="10%" class="text-center">OI No</th>
<th width="23%" class="text-center">OI Date</th>
...
<td class="text-center"><a href="new_return.php?old_pr_no=<?=$data->pr_no?>"><button class="btn btn-success btn-sm">Complete OI</button></a></td>
</tr>
<?php } ?>
</tbody></table>
</div></td>
