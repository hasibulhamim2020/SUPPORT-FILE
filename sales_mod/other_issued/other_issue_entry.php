...
<label style="width:220px;">Other Issue No: </label>
...
<label style="width:220px;">Other Issue Date: </label>
...
<input name="delete"  type="submit" class="btn1" value="DELETE OTHER ISSUE" style="width:60%; font-weight:bold; background:#0073AA; font-size:12px;color:#F00; height:30px" />
...
<input name="confirm" type="submit" class="btn1" value="CONFIRM OTHER ISSUE" style="width:60%; background:#0073AA; font-weight:bold; font-size:12px; height:30px; color: #FFFFFF; float:right" />
</td>
</tr>
