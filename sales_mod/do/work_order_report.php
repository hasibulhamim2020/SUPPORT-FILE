                        ...
                        <tr>
                          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                              ...
                              <tr>
                                ...
                                <td><div align="left">Delivery Order  Report</div></td>
                              </tr>
                              <tr>
                                <td><input name="report" type="radio" class="radio" value="1991" /></td>
                                <td><div align="left">Delivery Order Brief Report with Chalan Amount </div></td>
                              </tr>
                              <tr>
                                <td><input name="report" type="radio" class="radio" value="191" /></td>
                                <td><div align="left">Delivery Order  Report (At A Glance) </div></td>
                              </tr>
...
<!--
  ...
  <tr>
           ...
           <tr>-->
                              ...
                              <td><div align="left">Staff Wise Sales Details Report </div></td>
              ...
              <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                  ...
                  <tr>
                    ...
                    <td><span class="oe_form_group_cell">
                      <select name="product_group" id="product_group" style="margin-left:4px">
                      <option></option>
                  ...
                  <tr>
                    <td>Product Brand : </td>
                    <td><select name="item_brand" id="item_brand" style="margin-left:4px">
                                          <option></option>
                                        </select></td>
                  </tr>
                  ...
                  <tr>
				   ...
				   <tr>
                    ...
                    <td><select name="marketing_person" style="margin-left:4px">
					 <option></option>
				  ...
				  <tr>
                    ...
                    <td>Client Name :</td>
                    <td>
                    <input  name="dealer_code" type="text" id="dealer_code" class="form-control"/>                    </td>
                  </tr>

				  <tr>
				    <td>Client Type :</td>
				    <td><span class="oe_form_group_cell" >
				      <select name="dealer_type" id="dealer_type" style="margin-left:4px">
					  <option></option>
