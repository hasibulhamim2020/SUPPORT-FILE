        ...
        <div class="row m-0 p-0">
            <div class="col-sm-5">
                ...
                <div class="form-check">
                    <input name="report" type="radio" class="radio1" id="report1-btn" value="1121" checked="checked" tabindex="1">
                    <label class="form-check-label p-0" for="report1-btn">
                      Promotional Offer Report(1121)
                    </label>
                </div>
                ...
                <!--<div class="form-group row m-0 mb-1 pl-3 pr-3">
                    ...
                    <div class="col-sm-8 p-0">
                            ...
                            <select name="warehouse_id" id="warehouse_id">
							  <? foreign_relation('warehouse','warehouse_id','warehouse_name','','1 and group_for="'.$_SESSION['user']['group'].'"');?>
                   			 </select>
