...
while($data3=mysqli_fetch_object($query)){$s++;
...
elseif($_REQUEST['report']==1121) 
{
?>
<h4 align="center" style="line-height:5px;"><?=find_a_field('user_group','group_name','id='.$_SESSION['user']['group']);?></h4>
<h6 align="center" style="line-height:5px;"><?=find_a_field('user_group','address','id='.$_SESSION['user']['group']);?></h6>
<h5 align="center" style="line-height:5px;">Promotional Offer Report</h5>
<table width="90%" border="1" cellpadding="0" cellspacing="0" style="margin:0px auto">
  <tr>
	<th>ID</th>
	<th>Offer Name</th>
	<th>Customer Type</th>
   ...
   <? 
               ...
               <tr>
					<td><?=$data->id?></td>
					<td style="text-align:center"><?=$data->offer_name?></td>
					<td style="text-align:center"><?=$data->customer_type?></td>
					
					<td style="text-align:center"><?=$data->item_name?></td>
					<td style="text-align:center"><?=$data->item_qty?></td>
					
					<td style="text-align:center"><?=$data->gift_name?></td>
					<td style="text-align:center"><?=$data->gift_qty?></td>
					<td style="text-align:center; width:100px;"><?=$data->start_date?></td>
					<td style="text-align:center; width:100px;"><?=$data->end_date?></td>
