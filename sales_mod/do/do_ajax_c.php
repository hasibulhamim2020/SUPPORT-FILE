...
<td><input name="in_stock" pattern="[1-9]" type="text" class="input3" id="in_stock"  style="width:55px;" value="<?=$in_stock?>" readonly="readonly" onfocus="focuson('pkt_unit')"/>
...
<input name="unit_price" type="hidden" class="input3" id="unit_price"  style="width:55px;" value="<?=$item_all->c_price?>"/>

<input name="unit_price2" type="text" class="input3" id="unit_price2"  style="width:55px;" value="<?=($item_all->c_price*$item_all->pack_size)?>" onkeydown="count()"/>

<input name="pkt_size" type="hidden" class="input3" id="pkt_size"  style="width:55px;"  value="<?=$item_all->pack_size?>" readonly="readonly"/>

<input  name="c_price" type="hidden" id="c_price" value="<?=$item_all->c_price?>" readonly="readonly"/></td>
