...
$title='Product Item Unit';			// Page Name and Page Title
$page="item_unit.php";		// PHP File Name

$table='lc_item_unit';		// Database Table Name Mainly related to this page
$unique='id';			// Primary Key of this Database table
$shown='unit';				// For a New or Edit Data a must have data field
                              ...
                              <td>                                   
							    <table width="100%" border="0" cellspacing="0" cellpadding="0">
								  <tr>
									<td>
									<fieldset>
                                        <legend>Product Item Unit</legend>
									...
									<div>
                                          ...
                                          <input name="unit" type="text" id="unit" value="<?=$unit?>" />
									</div>
