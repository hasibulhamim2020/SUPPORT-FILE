...
$table='lc_product_category';		// Database Table Name Mainly related to this page
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								  ...
								  <tr>
									...
									<div class="tabledesign">
                                        <? 	$res='select '.$unique.','.$unique.','.$shown.',category_detail as detail from '.$table;
								  ...
								  <tr>
									...
									<div>
										...
										<div>
                                          ...
                                          <input name="category_detail" type="text" id="category_detail" value="<?=$category_detail?>" />
                                        </div>
                                        										<div>
                                          <label>Status:</label>
