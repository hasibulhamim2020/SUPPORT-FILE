		...
		<form action="" method="post" name="cloud" id="cloud">
			...
			?>
					...
					<tr>
						...
						<td><?=$row->qty?></td>
						<td><a href="?del=<?=$row->id?>"><button type="button" class="btn2 btn1-bg-cancel"><i class="fa-solid fa-trash"></i></button></a></td>
		...
		<form action="" method="post" name="cz" id="cz" onSubmit="if(!confirm('Are You Sure Execute this?')){return false;}">
			<div class="container-fluid p-0 ">
				...
				<div class="n-form-btn-class">
					   ...
					   <input name="cancel"  type="submit" class="btn1 btn1-bg-cancel" value="DELETE"  />
						<input type="button" class="btn1 btn1-bg-help" value="CLOSE"  onclick="window.location.href='select_unapproved_mr.php'" /></td>
