...
$title='New Sales Requisition Create';
...
<?php /*?><input  name="<?=$field?>" type="date" id="<?=$field?>" value="<?=$$field?>" /><?php */?>
						...
						<div class="container n-form2">
							...
							<div class="form-group row m-0 pb-1">
								...
								<div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2">
									...
									<input name="warehouse_id" id="warehouse_id" value="1" type="hidden" />
		...
		<form action="?<?=$unique?>=<?=$$unique?>" method="post" name="cloud" id="cloud">
				...
				<table class="table1  table-striped table-bordered table-hover table-sm">
					...
					<tr>
						...
						<td>
							...
							<input  name="item_id" type="text" id="item_id" value="<?=$item_id?>" required="required" onblur="getData2('mr_ajax.php', 'mr', this.value, document.getElementById('warehouse_id').value);"/>
						...
						<table style="width:100%;" border="1">
							...
							<tr>
								...
								<td width="33%"><input name="qoh" type="text"  id="qoh" class="form-control" onfocus="focuson('qty')" /></td>
			...
			<div class="container-fluid pt-5 p-0 ">
				...
				$res='select a.id,b.item_name as item_name,a.qoh as stock_qty,a.last_p_qty as last_pur_qty,a.last_p_date as last_pur_date,a.qty,"x" from requisition_order_vision a,item_info b where b.item_id=a.item_id and a.req_no='.$req_no;
				...
				<table class="table1  table-striped table-bordered table-hover table-sm">
					...
					<tbody class="tbody1">
						...
						$res='select a.id,b.item_name as item_name,a.qoh as stock_qty,a.last_p_qty as last_pur_qty,a.last_p_date as last_pur_date,a.qty,a.unit_name,a.remarks,"x" from requisition_order_vision a,item_info b where b.item_id=a.item_id and a.req_no='.$req_no;
