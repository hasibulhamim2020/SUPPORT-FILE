...
window.print();
             ...
             <div class="company-title">
              <div class="d-flex justify-content-around">
                ...
                <div class="company-header">
                  ...
                  <h5 class="bg-dark text-light text-capitalize text-center p-1">Quality product at affordable cost</h5>
  ...
  <p class="text-center">Cell :<?php echo find_a_field('project_info','proj_phone','1')?>.Web:<?php echo find_a_field('project_info','proj_email','1')?>  </p>
            ...
            <div class="text-center">
              <button class="btn btn-default outline border rounded-pill border border-dark"><h4>Gate Pass</h4></button>
            </div>
...
?>
                  ...
                  <tr>
                    <td colspan="1"><?=$i+1?></td>
                    <td colspan="7"><? echo $items->item_name.'-'.$items->finish_goods_code; if($unit_price[$i]<1) echo ' <b>[Gift Item]</b>'; ?>
