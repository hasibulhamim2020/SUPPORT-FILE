...
<a target="_blank" href="master_invoice_cus_new1.php?master_invoice_no=<?=$data->master_invoice_no?>&& do_no=<?=$data->do_no?>" style="color:#FFFFFF;"><button class="btn btn-success btn-sm">Invoice</button></a>
