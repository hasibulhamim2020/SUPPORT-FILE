...
getData2('edit_request_ajax.php', 'ppp',id,info);
...
<!--Start Edit Notes From Here-->
<div class="box">
	<a class="button" href="#<?=$data->id?>">Edit Note</a>
</div>

<div id="<?=$data->id?>" class="overlay">
	<div class="popup">
		<a class="close" href="#">&times;</a>
		<div class="content">
			<input type="text" value="<?=$$unique_master?>" name="e_do_no" class="form-control" >
			<input type="text" value="<?=$job_no?>" name="e_job_no" class="form-control"  >	
			<input type="text" value="<?=$data->id?>" name="e_request_no" class="form-control"  >
			<input type="date" name="e_request_date" class="form-control"  >	
			<textarea   name="e_request_note" class="form-control"  ></textarea>			
		</div>
	</div>
</div>
	
	<!--End Edit Notes From Here-->
	
<span id="ppp"><? if ($data->edit_request==0) {?><input name="<?='edit#'.$data->id?>" type="button" id="Edit" value="Request" style="width:100px; height:30px; color:#000; font-weight:700" onclick="update_edit(<?=$data->id?>);start(this);"  /> <? }?>

<? if ($data->edit_request==1) {?>

<input name="" type="button" id="Edit" value="Pending" style="width:100px; height:30px; color:#000; font-weight:700"   /> 
...
<input name="" type="button" id="Edit" value="Accepted" style="width:100px; height:30px; color:#000; font-weight:700"   /> 
