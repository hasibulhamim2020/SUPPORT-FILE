...
<div class="form-container_large">
    <form action="" method="post" name="codz" id="codz">
        ...
        <div class="container-fluid pt-5 p-0 ">
          ...
          $tr_type="Search";
          }else{$con=' and a.do_date between "'.date('Y-m-o1').'" 
				and "'.date('Y-m-d').'"';}
				...
				?>
						<tr>
                            ...
                            <td class="text-center"><a href="do.php?old_do_no=<?=$data->do_no?>"><input type="button" value="Complete DO" class="btn1 btn1-bg-submit" /></a></td>
    ...
    <table width="80%" border="0" align="center">
      ...
      <tr>
        ...
        <td width="1" bgcolor="#FF9966"><strong>
          <input type="text" name="fdate" id="fdate" style="width:200px;" value="<?=($_POST['fdate']!='')?$_POST['fdate']:date('Y-m-01');?>" class="form-control"/>
        </strong></td>
        <td align="center" bgcolor="#FF9966"><strong> -to- </strong></td>
        <td width="1" bgcolor="#FF9966"><strong>
          <input type="text" name="tdate" id="tdate" style="width:200px;" value="<?=($_POST['tdate']!='')?$_POST['tdate']:date('Y-m-d');?>"  class="form-control"/>
        </strong></td>
...
<td class="text-center"><a href="do.php?old_do_no=<?=$data->do_no?>"><button class="btn1 btn1-bg-submit">Complete DO</button></a></td>
</tr>
<?php } ?>
</tbody></table>
</div></td>
