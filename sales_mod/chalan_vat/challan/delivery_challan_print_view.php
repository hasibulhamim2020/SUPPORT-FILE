		    ...
		    <td width="100%" valign="top">
		      ...
		      <table width="100%" border="0" cellspacing="0" cellpadding="3"  style="font-size:12px">
		        ...
		        <tr>
		          ...
		          <td>:	&nbsp;
                    <?= find_a_field('dealer_info','contact_person_name','dealer_code="'.$master->dealer_code.'"');?></td>
	              <td>Challan Date </td>
  ...
  <tr>
	...
	<table width="100%" cellspacing="0" cellpadding="0"  >
		...
		<tr style="font-size:12px">
			...
			<td  align="center" width="20%"><strong>Store Officer</strong></td>
			
			<td  align="center" width="20%"><strong>Billing Officer Approved</strong></td>
		    <td  align="center" width="20%"><strong>Accounts Manager</strong></td>
