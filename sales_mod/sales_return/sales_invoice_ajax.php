...
<tr bgcolor="#CCCCCC">
	 ...
	 <td width="25%"><input name="pcs_stock" type="text" class="input3"  value="<?=(int)$stock_in_pcs;?>" id="pcs_stock" style="width:90%; height:30px;" /></td>
	 <td width="25%"><input name="crt_price" type="text" class="input3" id="crt_price"  style="width:90%; height:30px;"  required="required"  value="<?=$price_data->crt_price;?>" readonly=""   /></td>
	 <td width="25%"><input name="unit_price" type="text" class="input3" id="unit_price"  style="width:90%; height:30px;" required="required"  value="<?=$price_data->unit_price;?>" readonly=""   /></td>
</tr>
</table>
