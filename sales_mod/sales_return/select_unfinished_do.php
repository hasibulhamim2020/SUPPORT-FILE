...
<th width="23%" class="text-center">SR Date</th>
...
and "'.date('Y-m-d').'"';}
  ...
  from sale_return_master a,dealer_info d,user_activity_management u
...
<td class="text-center"><a href="do.php?old_do_no=<?=$data->do_no?>"><button class="btn btn-success btn-sm">Complete SR</button></a></td>
</tr>
<?php } ?>
</tbody></table>
</div></td>
