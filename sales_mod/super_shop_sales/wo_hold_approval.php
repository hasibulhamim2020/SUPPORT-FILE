...
if(isset($_POST['confirm'])){
 ...
 $sql = 'update sale_do_master set status="HOLD", hold_app_by="'.$entry_by.'", hold_app_at="'.$entry_at.'" where do_no = '.$do_no;
	db_query($sql);
...
<input name="confirm" type="submit" class="btn1" value="WO HOLD APPROVE" style="width:270px; font-weight:bold; float:right; font-size:12px; height:30px; color:#090" /></td>
