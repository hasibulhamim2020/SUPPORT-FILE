...
<input name="group_for" type="hidden" id="group_for" required readonly=""  value="<?=$_SESSION['user']['group']?>" tabindex="105" />
                            ...
                            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2">
                                <? if ($dealer_code<1) {?>
									...
									<option></option>
										  ...
										  <? foreign_relation('dealer_info','dealer_code','dealer_name_e',$dealer_code_combo,'1 and dealer_type="3"');?>
											 </select>
		...
		<input name="new" type="submit" class="btn1 btn1-bg-submit" value="Update Sales Order"  tabindex="12" />
