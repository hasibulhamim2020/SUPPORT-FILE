    ...
    <tr>
      <td valign="top"><div class="left">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td><div class="tabledesign" style="height:787px;width:638px;">
                  ...
                  <tr>
                    <td style="font-size:16px; padding:5px; color:#FFFFFF" bgcolor="#45777B"><div align="center">
                      ...
                      <div>
                        ...
                        <input name="AREA_NAME" type="text" id="AREA_NAME" tabindex="2" value="<?=$AREA_NAME?>" class="form-control">
                      </div>
					  <div>
            ...
            <tr>
              <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td><div class="button">
                        <? if(isset($_GET[$unique])){?>
                        <input name="update" type="submit" id="update" value="Update" class="btn btn-warning" />
                        <? }?>
                      </div></td>
                    <td><div class="button">
