...
$title='Hotel Service Point';	// Page Name and Page Title
$page="service_point_s.php";	// PHP File Name

$table='hms_service_point';		// Database Table Name Mainly related to this page
$unique='id';					// Primary Key of this Database table
$shown='point_name';			// For a New or Edit Data a must have data field
								  ...
								  <tr>
									...
									<fieldset>
                                        ...
                                        <input name="service_group_id" id="service_group_id" value="<?=$_SESSION['user']['id'];?>" type="hidden">
                                          <input name="point_name" type="text" id="point_name" value="<?=$point_name?>" />
