...
<table width="80%" border="0" align="center">
  ...
  <tr>
    <td align="right" bgcolor="#FF9966"><strong>Corporate Vendor: </strong></td>
    <td bgcolor="#FF9966"><strong>
      <input name="dealer" type="text" id="dealer" value="<?=$_POST['dealer']?>" class="form-control" />
    </strong></td>
    <td bgcolor="#FF9966">Item Brand </td>
    <td bgcolor="#FF9966"><select name="brand_name" id="brand_name" class="form-control">
<option></option>
...
<div class="tabledesign2" style="width:100%"><table width="70%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td bgcolor="#6699CC"><strong>Vendor Name: </strong></td>
