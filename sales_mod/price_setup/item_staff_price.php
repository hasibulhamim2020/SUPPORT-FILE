...
do_calander('#odate');
//auto_complete_from_db('dealer_info','dealer_name_e','dealer_code','dealer_code="7005" ','dealer');
...
var strURL="item_price_staff_ajax.php?item_id="+item_id+"&dealer_code="+dealer_code+"&discount="+discount+"&set_price="+set_price+"&flag="+flag;
...
<table width="80%" border="0" align="center">
  ...
  <tr>
    <td align="right" bgcolor="#FF9966"><strong> Dealer: </strong></td>
    <td bgcolor="#FF9966"><strong>
      <input name="dealer" type="text" id="dealer" value="7005" />
    </strong></td>
...
order by finish_goods_code';
  ...
  <tr bgcolor="<?=($i%2)?'#E8F3FF':'#fff';?>">
    ...
    <td><?=$data->d_price?></td>
    <td>
	<input name="mrp_<?=$data->item_id?>" id="mrp_<?=$data->item_id?>" type="hidden" value="<?=$data->d_price?>" />
