...
$input_page="dealer_type_input.php"; $add_button_bar = 'Mhafuz';
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td><div class="tabledesign" style="height:787px;">
                  <? 	$res='select '.$unique.','.$unique.' as CODE,'.$shown.' as CUSTOMER_TYPE  from '.$table;
                  ...
                  <tr>
                    <td colspan="2"><fieldset>
                      ...
                      <div>
                        ...
                        <input name="dealer_type" type="text" id="dealer_type" tabindex="2" value="<?=$dealer_type?>">
                      </div>
                      <!--<div>
                        <label>RSM</label>
