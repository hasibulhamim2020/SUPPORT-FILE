...
$con.=' and a.mobile_no = "'.$_POST['mobile_no'].'"';
         ...
         $sql="select a.dealer_code as code,a.account_code as ledger_code,a.dealer_name_e as dealer_name , a.mobile_no ,  b.BRANCH_NAME as Division_Name, z.ZONE_NAME as Zone_Name, ar.AREA_NAME as Territory, (select PBI_NAME from personnel_basic_info where PBI_ID=a.DSM_ID) as DSM_Name,
		  (select PBI_NAME from personnel_basic_info where PBI_ID=a.ZSM_ID) as ZSM_Name,
		  (select PBI_NAME from personnel_basic_info where PBI_ID=a.TSM_ID) as TSM_Name from dealer_info a, zon z, branch b, area ar  
		 where  a.zone_code=z.ZONE_CODE and a.region_code=b.BRANCH_ID and a.area_code=ar.AREA_CODE".$con." order by b.BRANCH_NAME ";
		break;
...
$con.=' and a.mobile_no = "'.$_POST['mobile_no'].'"';
         ...
         $sql="select a.dealer_code as code,a.account_code as ledger_code,a.dealer_name_e as dealer_name ,(select ledger_name from accounts_ledger where ledger_id=a.account_code) as ledger_name,a.propritor_name_e as propritor_name ,a.mobile_no , z.ZONE_NAME, a.canceled as active from dealer_info a, zon z
		 where  a.dealer_type='Regular' and a.zone_code=z.ZONE_CODE  ".$con." order by a.dealer_code asc";
		break;
