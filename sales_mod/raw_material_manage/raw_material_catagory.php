...
$title='Raw Material Catagory';			// Page Name and Page Title
$page="raw_material_catagory.php";		// PHP File Name

$table='proc_raw_material_catagory';		// Database Table Name Mainly related to this page
