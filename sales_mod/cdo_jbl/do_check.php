...
<!--        top form start hear-->
 ...
 <th>Pcs Qty</th>
                ...
                <tbody class="tbody1">
					...
					$res='select a.id,b.finish_goods_code as code,b.item_name,a.unit_price,a.pkt_unit as crt_qty,a.total_unit as pcs,a.dist_unit,a.total_amt,"X" from sale_do_details a,item_info b where b.item_id=a.item_id and a.do_no='.$$unique_master.' order by a.id';
