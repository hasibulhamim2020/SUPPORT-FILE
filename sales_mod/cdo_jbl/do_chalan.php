...
?>
        <tr>
          ...
          <td align="center" bgcolor="#FFFF99"><a href="chalan_view.php?v_no=<?=$aaa->chalan_no?>"><img src="../../images/print.png" width="15" height="15" /></a></td>
        </tr>
<?
}
?>
    ...
    <tr>
      <td colspan="5"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td align="right" bgcolor="#9999FF"><strong>Chalan Date:</strong></td>
