...
<div class="form-container_large">
  <form action="" method="post" name="codz" id="codz">
    <table  style="width:80%; margin:0 auto; border:0; text-align:center;">
      ...
      <tr>
        <td  style="text-align:right; background-color:#00bfff"><strong>Date Interval :</strong></td>
        <td style="width:30%; background-color:#00bfff;"><strong>
          <input type="text" name="fdate" id="fdate" class="from-control"   value="<?=($_POST['fdate']!='')?$_POST['fdate']:date('Y-m-01')?>" autocomplete="off"/>
        </strong></td>
        <td  style="text-align:center; background-color:#00bfff"><strong> -to- </strong></td>
        <td style="width:30%; background-color:#00bfff;"><strong>
