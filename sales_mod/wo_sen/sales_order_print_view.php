                  ...
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
						...
						<table width="100%" border="0" cellspacing="0" align="center" cellpadding="0" style="font-size:15px; margin:0; padding:0;">
									...
									<tr>
									<td>
						  	          <div align="left"><img src="<?=SERVER_ROOT?>public/uploads/logo/<?=$_SESSION['proj_id']?>.png"   style=" width:50%; height: 100px;"  />
                        ...
                        <td width="25%"> 
							<table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-size:15px; margin:0; padding:0;">
									...
									<tr>
									  <td style="padding-bottom:3px;"><h2 style="margin: 0px;"><?=$group_data->group_name?></h2></td>
							  </tr>
							  ...
							  <tr>
								  <td style=" font-size:14px; line-height:24px;"><?=$group_data->vat_reg?></td>
							  </tr>
						  </table>
						</td>
					  </tr>
 ...
 <tr>
  ...
  <tr><td>&nbsp;</td></tr>
  	...
  	<tr height="30">
  	  ...
  	  <td width="50%"  style="text-align:center; "><span style="color:#FFF; font-size:18px; background:#c7ffed; padding:8px 30px; color:#000000; font-weight:bold; border: 2px solid #000000; border-radius: 5px; ">
	  SALES ORDER</span> </td>
