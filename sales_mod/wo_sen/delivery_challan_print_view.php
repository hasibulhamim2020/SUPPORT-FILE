...
<th width="3%" bgcolor="#CCCCCC">Barcode</th>
...
<th width="9%" bgcolor="#CCCCCC">Bag</th>
</tr>
...
<td><strong>
  <?=number_format($total_bag_unit,0);?>
</strong></td>
        </tr>
      </table>      </td>
  </tr>
  ...
  <tr>
	...
	<table width="100%" cellspacing="0" cellpadding="0"  >
		...
		<tr style="font-size:12px">
		    ...
		    <td  align="center" width="25%"><strong>Receiver</strong></td>
		    </tr>
		<tr style="font-size:12px">
		  <td align="center">&nbsp;</td>
		  <td  align="center">&nbsp;</td>
...
$total_quantity2 = $total_quantity + $data->total_unit;
$total_bag_size2 = $total_bag_size + $data->bag_size;

$total_bag_unit2 = $total_bag_unit2 + $data->bag_unit;
