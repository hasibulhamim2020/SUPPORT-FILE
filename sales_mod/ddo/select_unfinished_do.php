...
<table width="70%" border="0" align="center">
  ...
  <tr>
	...
	<?
	$query ="select a.do_no,a.dealer_code,d.product_group,d.dealer_name_e from sale_do_master a,dealer_info d where d.dealer_code=a.dealer_code and d.dealer_type='Distributor' and a.status='MANUAL' and do_date='".date('Y-m-d')."' and a.entry_by=".$_SESSION['user']['id'];
	?>
