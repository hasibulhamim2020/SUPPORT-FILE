...
<input name="unit_price" type="hidden" class="input3" id="unit_price"  style="width:55px;" value="<?=$item_all->d_price?>"/>

<input name="unit_price2" type="text" class="input3" id="unit_price2"  style="width:55px;" value="<?=($item_all->d_price*$item_all->pack_size)?>" onkeydown="count()"

/>

<input name="pkt_size" type="hidden" class="input3" id="pkt_size"  style="width:55px;"  value="<?=$item_all->pack_size?>" readonly="readonly"/>

<input  name="t_price" type="hidden" id="t_price" value="<?=$item_all->t_price?>" readonly="readonly"/></td>
