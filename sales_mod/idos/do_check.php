...
$sss = "select * from sale_gift_offer where item_id='".$_POST['item_id']."' and start_date<='".$do_date."' and end_date>='".$do_date."' and group_for like '%".$_POST['group_for']."%' limit 1";
else
$sss = "select * from sale_gift_offer where item_id='".$_POST['item_id']."' and start_date<='".$do_date."' and end_date>='".$do_date."' and (group_for like '%A%' or group_for like '%B%' or group_for like '%C%' or group_for like '%D%') limit 1";
  ...
  <tr>
    ...
    <div>
      <label style="width:75px;">Dealer : </label>
        ...
        </select><input style="width:10px;"  name="group_for" type="text" id="group_for" value="<?=$dealer->product_group;?>" readonly="readonly"/>
    </div>
      <div>
    ...
    <td>
			<fieldset style="width:220px;">
			  <div>
			    ...
			    <input style="width:105px;"  name="do_date" type="text" id="do_date" value="<?=$do_date;?>" readonly="readonly"/>
		      </div>
			<div>
...
<td bgcolor="#CCCCCC">
  ...
  <td bgcolor="#CCCCCC"><table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td><input name="dist_unit" type="text" class="input3" id="dist_unit" style="width:55px;" onkeydown="count()" readonly="readonly"/></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><div align="center" class="style1">ACCOUNT CODE IS NOT AVAILABLE </div></td>
  </tr>
</table>
<?
}
