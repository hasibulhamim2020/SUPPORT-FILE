...
<form action="master_report.php" method="post" name="form1" target="_blank" id="form1">
        ...
        <div class="row m-0 p-0">
            ...
            <div class="col-sm-5">
                ...
                <div align="left">Price Setup </div>

                <div class="form-check">

                    <input name="report" type="radio" class="radio1" id="report1-btn" value="8888" checked="checked">

                    <label class="form-check-label p-0" for="report1-btn">

                      Product Price Information Setup
                ...
                <div class="form-group row m-0 mb-1 pl-3 pr-3">
                    ...
                    <div class="col-sm-8 p-0">
                        ...
                        <span class="oe_form_group_cell">
							...
							<input list="item" name="item_name" type="text" id="item_name" />
						   <datalist id="item">
...
document.getElementById('group_id').value);">
				...
				<div class="form-group row m-0 mb-1 pl-3 pr-3">
                    ...
                    <div class="col-sm-8 p-0">
						...
						<input list="item_sub" type="text" name="item_sub_group" id="item_sub_group" tabindex="4"  />
                       <datalist id="item_sub">
