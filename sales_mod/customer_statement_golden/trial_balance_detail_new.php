...
/*}*/
    ...
    <div class="form-container_large">
        ...
        <form id="form1" name="form1" method="post" action="">
                        ...
                        <div class="form-group row m-0">
                            ...
                            <div class="col-sm-9 col-md-9 col-lg-9 col-xl-9 p-0">
                                <select name="group_id" id="group_id" required>
                                    <option></option>
                                    <? foreign_relation('ledger_group','group_id','group_name',$_REQUEST['group_id'],"group_id=122001");?>
                                </select>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container-fluid pt-5 p-0 " id="grp">

                <table class="table1  table-striped table-bordered table-hover table-sm" cellpadding="0" cellspacing="0">
                    <thead class="thead1">
                    <tr class="bgc-info">
                        <th>Code</th>
                        <th>Ledger Group</th>
