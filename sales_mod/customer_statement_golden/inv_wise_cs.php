...
/*}*/
    ...
    <div class="form-container_large">
        ...
        <form id="form1" name="form1" method="post" action="master_report.php" target="_blank">
                ...
                <div class="row">
                    <div class="col-sm-3 col-md-3 col-lg-3 col-xl-3 pt-1 pb-1">
                        <div class="form-group row m-0">
                            ...
                            <div class="col-sm-9 col-md-9 col-lg-9 col-xl-9 p-0">
                                ...
                                <input name="fdate" type="text" id="fdate" value="<?=$_REQUEST['fdate'];?>" autocomplete="off"/>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-3 col-md-3 col-lg-3 col-xl-3  pt-1 pb-1">
                        <div class="form-group row m-0">
                            ...
                            <div class="col-sm-9 col-md-9 col-lg-9 col-xl-9 p-0">
                                <input name="tdate" type="text" id="tdate" size="12" value="<?php echo $_REQUEST['tdate'];?>" autocomplete="off"/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 pt-1 pb-1">
                        <div class="form-group row m-0">
                            ...
                            <div class="col-sm-9 col-md-9 col-lg-9 col-xl-9 p-0">
                                <select name="dealer_acc_code" id="dealer_acc_code" required>
                                    <option></option>
                                    <? foreign_relation('accounts_ledger','ledger_id','ledger_name',$_REQUEST['dealer_acc_code'],"ledger_group_id=122001");?>
                                </select>
                            </div>
                        </div>
                    </div>
