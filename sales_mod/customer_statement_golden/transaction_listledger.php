				...
				<div class="row">
					<div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 pt-1 pb-1">
						<div class="form-group row m-0">
							<label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">Period</label>
									...
									<table width="100%" border="0" cellspacing="2" cellpadding="2">
                                      ...
                                      <tr>
                                        ...
                                        <td width="28%" align="left">
											<!--<input type="text" class="form-control" style="max-width:250px;" name="ledger_id" id="ledger_id" value="<?php echo $_REQUEST['ledger_id'];?>" size="50" />-->
...
?>
						  ...
						  <option value="">Select Type</option>
                                      ...
                                      <tr>
                                        ...
                                        <td colspan="2" align="left">
											<select name="cc_code" id="cc_code" style="width:250px;" >
										<option value="<?php echo $_REQUEST['cc_code'];?>"></option>
											<? foreign_relation('cost_center cc, cost_category c','cc.id','cc.center_name',$_POST['cc_code'],"cc.category_id=c.id and c.group_for='".$_SESSION['user']['group']."' ORDER BY id ASC");?>
										</select>
                                      ...
                                      <tr>
                                        <td colspan="3" align="center" style="padding:13px;">
											<input class="btn" name="show" type="submit" id="show" value="Show" />
										</td>
                                      </tr>
                                    </table>
								    </form>
							  ...
							  <tr>
								...
								<th width="22%" align="center">Particulars</th>
...
<!--    <th align="right"><?php $blance = $blance+($data[2]-$data[3]); if($blance>0) echo '(Dr) '.number_format($blance,2); elseif($blance<0) echo '(Cr) '.number_format(((-1)*$blance),2);else echo "0.00"; ?></th>-->
    </tr>
