...
$target_url = 'delivery_challan.php';
                ...
                <div class="col-sm-5 col-md-5 col-lg-5 col-xl-5">
                    ...
                    <div class="form-group row m-0">
                        ...
                        <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0">
                            ...
                            <input class="form-control" name="date" id="date" value="<?=$_POST['date']?>" autocomplete="off"/>
                    ...
                    <div class="form-group row m-0">
                        ...
                        <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0">
                            ...
                            <select name="req_no" id="req_no" >
								...
								<? foreign_relation('requisition_master_vision','req_no','req_no',$_POST['req_no'],'status  in ("CHECKED")');?>
...
$con .= ' and req_no='.$_POST['req_no'].'';

if($_POST['date']!='') 

$con .= ' and req_date="'.$_POST['date'].'"';





  $res=" select * from requisition_master_vision where status='CHECKED' ".$con;
		...
		?>
					...
					?>
                        ...
                        <tr>
							...
							<input type="button" value="Complete Challan" onClick="custom(<?=$row->req_no;?>);" class="btn1 btn1-bg-submit" / >
