...
$master= find_all_field('sale_other_master','','do_no='.$do_no);


$ch_data= find_all_field('sale_other_details','','chalan_no='.$chalan_no);
...
$ssql = 'select a.* from warehouse a, sale_other_master b where a.warehouse_id=b.depot_id and b.do_no='.$do_no;
...
$to_ctn = find_a_field('sale_other_details','sum(pkt_unit)','chalan_no='.$chalan_no);

$to_pcs = find_a_field('sale_other_details','sum(dist_unit)','chalan_no='.$chalan_no); 



$ordered_total_ctn = find_a_field('sale_other_details','sum(pkt_unit)','dist_unit = 0 and do_no='.$do_no);

$ordered_total_pcs = find_a_field('sale_other_details','sum(dist_unit)','do_no='.$do_no); 
 ...
 <tr> <td><hr /></td></tr>
  ...
  <tr><td>&nbsp;</td></tr>
  	...
  	<tr height="30">
  	  ...
  	  <td width="50%"  style="text-align:center; "><span style="color:#FFF; font-size:18px; background:#CCCCCC; padding:8px 40px; color:#000000; font-weight:bold; border: 2px solid #000000; border-radius: 5px; text-transform:uppercase; ">
	  <?php echo find_a_field('issue_type','issue_type','id='.$master->sales_type);?> </span> </td>
			  ...
			  <tr>
				  ...
				  <td><table width="100%" border="1" cellspacing="0" cellpadding="5" style=" ">
		            ...
		            <tr>
		              ...
		              <td ><span style="font-size:14px; font-weight:bold;" class="style8"> Invoice No: <?php echo $master->do_no?> &nbsp;</span></td>
		              </tr>
		          ...
		          <td><table width="100%" border="1" cellspacing="0" cellpadding="5" style=" ">
		            ...
		            <tr>
		              ...
		              <td ><span style="font-size:14px; font-weight:bold; float: left;" class="style8"> Invoice Date:
		          ...
		          <td><table width="100%" border="1" cellspacing="0" cellpadding="5" style=" ">
		            ...
		            <tr>
		              ...
		              <td ><span style="font-size:14px;" class="style8"> Type: <?php echo find_a_field('issue_type','issue_type','id='.$master->sales_type);?> </span>&nbsp;</span></td>
		              </tr>
...
//, (a.init_pkt_unit*a.unit_price) as Total,(a.init_pkt_unit-a.inStock_ctn) as Shortage
  ...
  $res='select  s.sub_group_name,  b.item_name, a.*
   from sale_other_details a, item_info b, item_sub_group s 
...
<td><?=$data->pkt_size?></td>
<td><?=$data->pkt_unit; $tot_pkt_unit +=$data->pkt_unit;?></td>
<td><?=$data->dist_unit; $tot_dist_unit +=$data->dist_unit;?></td>
</tr>
...
<td><strong><?=$tot_pkt_unit?></strong></td>
<td><strong><?=$tot_dist_unit?></strong></td>
</tr>
      </table>      </td>
  </tr>
...
$amount_including_vat = $taxable_amount+$tot_vat_amt;
			        ...
			        <td><table width="100%" border="1" cellspacing="0" cellpadding="3">
			          ...
			          <tr>
			            ...
			            <td width="68%"><strong>Total Amount Including VAT 
						   ...
						   <td width="32%"><strong>
			              <?=(int)$amount_including_vat = $taxable_amount+$tot_vat_amt;?>
			              </strong>&nbsp;</td>
	                    </tr>
	...
	<table width="100%" cellspacing="0" cellpadding="0"   >
		...
		<tr>
		  ...
		  <?php $uid=find_a_field('sale_other_master','entry_by','do_no="'.$do_no.'"');
