    ...
    <td><div id="pr">
      ...
      <table width="100%" class="tabledesign" border="1" bordercolor="#000000" cellspacing="0" cellpadding="5"  style="font-size:10px">
        ...
        <tr>
          ...
          <td width="21%" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Item Name </strong></td>
          ...
          <? }?>
		    <? if ($size_count>0) {?>
          <? }?>
          <td width="26%" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Measurement</strong></td>
          <td width="8%" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Ply</strong></td>
          <td width="15%" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>UOM</strong></td>
          <td width="13%" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Delivery Qty </strong></td>
          <td width="13%" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Bundle Qty </strong></td>
        </tr>
        
        <?    $sqlc = 'select c.order_no, c.item_name as ch_item_name, c.delivery_date, c.delivery_place,c.printing_info,c.additional_info, c.measurement_unit, sum(c.total_unit) as total_unit, sum(c.bundle_1+c.bundle_2+c.bundle_3) as tot_bundle,
		 ...
		 from sale_do_chalan c, item_info i,  item_sub_group s, item_group g where i.item_id=c.item_id and i.sub_group_id=s.sub_group_id and s.group_id=g.group_id  and c.chalan_no='.$chalan_no.'  group by c.item_id, c.L_cm, c.W_cm, c.H_cm, c.measurement_unit, c.ply  order by c.id asc';
        ...
        <tr style="font-size:10px;">
          ...
          <td align="center" valign="top"><?=number_format($datac->tot_bundle,2); $grand_tot_bundle1 +=$datac->tot_bundle; ?></td>
        </tr>
        ...
        <td align="center" valign="middle"><strong>
          <?=number_format($grand_tot_bundle1,2) ;?>
        </strong></td>
        </tr>
      </table>
    ...
    <td>
      ...
      <table width="100%" class="tabledesign" border="1" bordercolor="#000000" cellspacing="0" cellpadding="5"  style="font-size:10px">
        ...
        <tr style="font-size:10px;">
          ...
          <td align="center" valign="top"><?=number_format($datac->tot_bundle,2); $grand_tot_bundle2 +=$datac->tot_bundle; ?></td>
        </tr>
        ...
        <td align="center" valign="middle"><strong>
          <?=number_format($grand_tot_bundle2,2) ;?>
        </strong></td>
        </tr>
      </table>
