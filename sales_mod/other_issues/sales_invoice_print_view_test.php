...
<th width="3%" bgcolor="#CCCCCC">SL</th>


<th width="5%" bgcolor="#CCCCCC">PKG #</th>
<th width="5%" bgcolor="#CCCCCC">Item</th>
<th width="5%" bgcolor="#CCCCCC">Colour</th>
<th width="5%" bgcolor="#CCCCCC">GSM</th>
<th width="11%" bgcolor="#CCCCCC">Size</th>
<th width="9%" bgcolor="#CCCCCC">Print Name </th>
<th width="9%" bgcolor="#CCCCCC">Quantity</th>
<th width="9%" bgcolor="#CCCCCC">KG</th>
<th width="6%" bgcolor="#CCCCCC">U-Price</th>
<th width="7%" bgcolor="#CCCCCC">Amount</th>
</tr>
...
//, (a.init_pkt_unit*a.unit_price) as Total,(a.init_pkt_unit-a.inStock_ctn) as Shortage
 ...
 echo $res='select  s.sub_group_name,  b.item_name, a.*
  ...
  <tr>
	...
	<table width="100%" cellspacing="0" cellpadding="0"  >
		...
		<tr style="font-size:12px">
		    ...
		    <td  align="center" width="25%"><strong>General Manager</strong></td>
...
while($dataa=mysqli_fetch_object($queryy)){
...
<td><?=find_a_field('colour','colour','id="'.$dataa->colour_b.'"');?></td>
<td><?=$dataa->gsm?></td>
<td><? if($dataa->s_w>0) {?><?=$dataa->s_w?><? }?><? if($dataa->s_h>0) {?>X<?=$dataa->s_h?><? }?><? if($dataa->s_g>0) {?>X<?=$dataa->s_g?><? }?></td>

<td><?=find_a_field('dealer_print_name','print_name','id="'.$dataa->print_name.'"');?></td>
<td><?=$dataa->total_unit?></td>
<td><?=$dataa->bag_size?></td>
<td><?=$dataa->unit_price?></td>
<td><?=$dataa->total_amt?></td>
</tr>
        
        <?
		
$total_quantity2 = $total_quantity2 + $dataa->total_unit;
$total_bag_size2 = $total_bag_size2 + $dataa->bag_size;

$total_amount2 = $total_amount + $dataa->total_amt;
...
<td><strong>
  <?=number_format($total_bag_size2,3);?>
</strong></td>
<td>&nbsp;</td>
<td><strong><?=number_format($total_amount,2);?></strong></td> <?php /*?><?=number_format($total_amount2,2);?><?php */?>
</tr>
        <tr style="font-size:16px; font-weight:500; letter-spacing:.3px;">
          <td colspan="10">In Word:
            <?
