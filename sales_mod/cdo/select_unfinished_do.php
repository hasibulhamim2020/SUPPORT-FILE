...
<div class="form-container_large">
  <form action="" method="post" name="codz" id="codz">
    <table  style="width:80%; margin:0 auto; border:0; text-align:center;">
      ...
      <!--</tr>-->
      <tr>
        <td  style="background-color:#00bfff; text-align:right; padding: 20px 0px;"><strong>Date Interval :</strong></td>
        <td  style="background-color:#00bfff;"><strong>
          <input type="text" name="fdate" id="fdate" class="from-control"   value="<?=($_POST['fdate']!='')?$_POST['fdate']:date('Y-m-01')?>" autocomplete="off"/>
        </strong></td>
        <td  style="background-color:#00bfff; text-align:center;"><strong> -to- </strong></td>
        <td style="background-color:#00bfff;"><strong>
          <input type="text" name="tdate" id="tdate" class="from-control" value="<?=($_POST['tdate']!='')?$_POST['tdate']:date('Y-m-d')?>" autocomplete="off"/>
        </strong></td>
        <td rowspan="2" style="background-color:#00bfff;" ><strong>
          <input type="submit" name="submitit" id="submitit" value="VIEW DETAIL"  style="width:120px;  font-weight:bold; font-size:15px; height:30px;  color:#808080"/>
        </strong></td>
      </tr>
