                  ...
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-size:15px; margin:0; padding:0;">
									...
									<tr>
									  <td style="padding-bottom:3px; text-align:center;"><span style="font-size:18px; color:#000000; margin:0; padding: 0 0 0 0; text-transform:uppercase;  font-weight:700; font-family: 'TradeGothicLTStd-Extended';"><?=$group_data->group_name?></span></td>
							  </tr>
									...
									<tr>
										<td style="text-align:center;"><strong>Phone:</strong> <?=$group_data->mobile;?>,  <strong>Email: </strong><?=$group_data->email;?></td>
									</tr>
 ...
 <tr> <td><hr /></td></tr>
  ...
  <tr><td>&nbsp;</td></tr>
  	...
  	<tr height="30">
  	  ...
  	  <td width="50%"  style="text-align:center; "><span style="color:#FFF; font-size:18px; padding:8px 30px; color:#000000; font-weight:bold; border: 2px solid #000000; border-radius: 5px; ">
	  SALES ORDER</span> </td>
...
<tr>
 ...
 <?=number_format($invoice_amt= ($tot_amt_after_discount+$vat_amt),2); ?>
        ...
        <tr>
          <td colspan="7"><span class="style8" style="font-size:14px; font-weight:500; letter-spacing:.3px;"><strong>In Word:</strong>
             <?
