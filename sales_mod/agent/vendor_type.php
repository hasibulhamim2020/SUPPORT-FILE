  ...
  <tr>
    ...
    <td valign="top"><form action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
      ...
      <table style="width:100%; border:0; border-collapse:collapse; padding:0;">
                            <tr>
                              <td>                                   
							    <table style="width:90%; border:0; border-collapse:collapse; padding:0; margin-top:60px;">
								  <tr>
									<td>
									<fieldset>
                                        <legend style="font-size:16px;"><?=$title?> Details</legend>
										...
										<div>
                                          <label>Type ID:</label>
                                          <input name="id" type="text" id="id" value="<?=$id?>" readonly="readonly">
                                        </div>
									<div>
                                          <label>Type Name:</label>
                                          <input name="vendor_type" type="text" id="vendor_type" value="<?=$vendor_type?>" />
									</div>
									</fieldset>									</td>
								  </tr>
                           </table>
