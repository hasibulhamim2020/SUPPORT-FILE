...
while (($excelData = fgetcsv($file, 0, ",")) !== FALSE){
    
    $numColumns = count($excelData);
...
$sql = "INSERT INTO sale_target_so (target_year,target_month,target_period, dealer_code,so_code,
   item_id,target_qty,
   price,target_amt,entry_by, entry_at 
)VALUES(
        ...
        <div class="oe_form_sheet oe_form_sheet_width">
          <div  class="oe_view_manager_view_list"><div  class="oe_list oe_view">
            <table width="80%" border="1" align="center">
              ...
              <tr>
                <td>&nbsp;</td>
                <td><input name="delete_all" type="submit" id="delete_all" value="Delete Old Data"/></td>
                <td><p><input name="upload" type="submit" id="upload" value="Upload File" /></p>
                  <p>&nbsp; </p></td>
                <td colspan="3">&nbsp;</td>
              </tr>
              <tr>
