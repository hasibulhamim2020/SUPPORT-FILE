...
$target_url = '../wh_transfer/print_view.php';
...
<? foreign_relation('warehouse','warehouse_id','warehouse_name',$_POST['depot'],'1 and use_type="WH" order by warehouse_id');?>
...
$res='select  	a.pi_no as transfer_id,a.pi_no as transfer_id, a.pi_date as date, ug.group_name as Company, b.warehouse_name, a.status, u.fname as entry_by,a.entry_at from user_activity_management u, warehouse_transfer_master a,warehouse b, user_group ug where a.group_for=ug.id and  a.warehouse_from='.$_SESSION['user']['depot'].' and a.entry_by=u.user_id and a.warehouse_to=b.warehouse_id and b.use_type!="PL" '.$con.' order by a.pi_no desc';
