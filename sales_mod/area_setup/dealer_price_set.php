...
<table  style="width:80%; margin:0 auto; border:0; text-align:center;">
  ...
  <tr>
    <td  style="text-align:right; background-color:#FF9966;"><strong>Corporate Dealer: </strong></td>
    ...
    <td style=" background-color:#FF9966;"><select name="brand_name" id="brand_name">
<option></option>
...
<div class="tabledesign2" style="width:100%"><table width="70%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td style=" background-color:#6699CC;"><strong>Dealer Name: </strong></td>
...
<table id="grp"  style="width:100%; border:0 border-collapse:collapse; text-align:center; padding:0;">
  <tr>
