...
$title='Hotel Floor Information';
$page="hotel_floor.php";

$table='hms_hotel_floor';
$unique='id';
$shown='floor_name';
								  ...
								  <tr>
									...
									<fieldset>
										...
										<div>
                                          ...
                                          <input name="floor_name" type="text" id="floor_name" value="<?=$floor_name?>">
                                        </div>
									<div>
										...
										<div>
                                          ...
                                          <input name="floor_no" type="text" id="floor_no" value="<?=$floor_no?>" />
                                        </div>
										<div>
