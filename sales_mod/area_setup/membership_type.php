...
$title='Hotel Membership Type';
$page="membership_type.php";

$table='hms_member_type';
$unique='id';
$shown='member_type';
								  ...
								  <tr>
									...
									<fieldset>
										...
										<div>
                                          ...
                                          <input name="member_type" type="text" id="member_type" value="<?=$member_type?>">
                                        </div>
									<div>
									...
									<div>
                                          ...
                                          <input name="commission" type="text" id="commission" value="<?=$commission?>" />
									</div>
									</fieldset>									</td>
								  </tr>
