...
$title='Hotel Services Item';			// Page Name and Page Title
$page="service_setup_s.php";		// PHP File Name
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <td>                                   
								...
								<? 
			  $sql="SELECT id,service_group FROM hms_service_group WHERE id=".$_SESSION['user']['id'];
