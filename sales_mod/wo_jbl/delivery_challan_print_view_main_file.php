 ...
 <tr> <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td><div id="pr">
      ...
      <table width="100%" class="tabledesign" border="1" bordercolor="#000000" cellspacing="0" cellpadding="5"  style="font-size:10px">
        ...
        <?    $sqlc = 'select c.order_no, c.delivery_date, c.delivery_place,c.printing_info,c.additional_info, c.measurement_unit, sum(c.total_unit) as total_unit,
  ...
  <tr>
  	<td colspan="2">
        ...
        <?  $sqlc = 'select s.sub_group_name, c.delivery_date, c.delivery_place,c.printing_info,c.additional_info, c.measurement_unit, sum(c.total_unit) as total_unit, c.unit_price, i.unit_name, c.total_amt, i.item_id, i.item_name, c.ply, c.style_no, c.po_no,  c.paper_combination, c.L_cm, c.W_cm, c.H_cm,
        ...
        <tr style="font-size:12px;">
          ...
          <td align="center" valign="top"><?= $datac->item_name?></td>
          <td align="center" valign="top"><?=number_format($datac->tot_bundle,2);  $tot_bundle_sum +=$datac->tot_bundle;?></td>
        ...
        <td align="center" valign="middle"><strong><?=number_format($tot_bundle_sum,2);?></strong></td>
