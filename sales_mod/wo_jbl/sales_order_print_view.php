...
<td  align="right"><?=$data->pkt_unit?></td>
...
<td  align="right"><?=$data->total_amt; $tot_total_amt +=$data->total_amt;?></td>
        ...
        <?  } ?>
        <tr>
			<td colspan="11"  align="right" style="text-align:right;"><strong>  Sub Total</strong></td>
			<td  align="right" style="text-align:right;"><strong> <?=number_format($tot_total_amt,2);?></strong></td>
		</tr>

<tr >
          <td colspan="11"  align="right" style="text-align:right;"><strong> Discount (<?=$master->discount;?>%)</strong></td>
 ...
 <? $tot_amt_after_discount = $tot_total_amt-$discount_amt; ?>
        ...
        <tr >
          <td colspan="11"  align="right" style="text-align:right;"><strong> VAT (<?=$master->vat?>%)</strong></td>
          <td  align="right" style="text-align:right;">
		  	<strong>
        ...
        <tr >
          <td colspan="11"  align="right" style="text-align:right;"><strong> Invoice Amount </strong></td>
          <td  align="right" style="text-align:right;">
		  <strong>
