...
('".$do_no."',  '".$_POST['do_date']."', '".$_POST['dealer_code']."',  '".$_POST['via_customer']."',  '".$item_gunny."', 
 '".$_POST['depot_id']."', '".$gunny_price."', '".$_REQUEST['bag_unit']."', '".$_REQUEST['bag_unit']."', '".$_REQUEST['bag_unit']."',
  '".$_REQUEST['total_amt']."','".$_REQUEST['gsm']."','".$_REQUEST['sale_unit']."','".$_REQUEST['roll_pcs']."','".$_REQUEST['mtr']."','".$_REQUEST['yard']."', '".$_SESSION['user']['id']."', '".$now."', '".$_POST['remarks']."')";
...
<? foreign_relation('dealer_info d,dealer_type t','d.dealer_code','concat(d.dealer_name_e,". #",t.dealer_type)',$dealer_code_combo,'d.dealer_type=t.id and d.status="ACTIVE" and d.group_for="'.$_SESSION['user']['group'].'"');?>
		...
		<? if($$unique_master>0){?>
			...
			<div class="container-fluid pt-5 p-0 ">
			<?
			  $res='select a.id,b.item_name,a.item_id,a.unit_name,a.sale_unit,a.roll_pcs,a.mtr,a.yard,a.gsm, a.unit_price, a.total_unit, a.total_amt as Net_sale, a.discount, a.vat_amt, a.total_amt_with_vat from
