...
var pcs_qty = ((document.getElementById('dist_unit').value)*1);

var total_unit = (pkt_unit*pkt_size);
var total_unit = +total_unit+pcs_qty;
//var vat = ((document.getElementById('vat').value)*1);



var total_unit =document.getElementById('total_unit').value=total_unit; 
...
<? foreign_relation('dealer_info d,dealer_type t','d.dealer_code','concat(d.dealer_name_e,". #",t.dealer_type)',$dealer_code_combo,'d.dealer_type=t.id and d.status="ACTIVE"');?>
	...
	<td>
							<input  name="pkt_unit" type="text" class="input3" id="pkt_unit" value="" onkeyup="count()"   />
 						</td>
							<td>
							<input  name="dist_unit" type="text" class="input3" id="dist_unit" value="" onkeyup="count()"   />
 						</td>
						<td>
							<input  name="total_unit" type="text" class="input3" id="total_unit" value="" readonly=""  onkeyup="count()" />
 						</td>
		...
		<? if($$unique_master>0){?>
			...
			<div class="container-fluid pt-5 p-0 ">
			<?
			  $res='select a.id,b.item_name,a.item_id,a.unit_name, a.unit_price, a.total_unit, a.total_amt as Net_sale, a.discount, a.vat_amt, a.total_amt_with_vat,a.pkt_unit,a.dist_unit from
