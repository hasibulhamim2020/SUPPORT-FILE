...
{
var edit_request = (document.getElementById('edit_request#'+id).value);


var info = edit_request+"<@>"+edit_request;
getData2('edit_request_ajax.php', 'ppp'+id,id,info);
...
<input name="remarks" type="text" id="remarks" style="width:250px;" value="<?=$remarks?>" tabindex="105" />
...
<option></option>
      ...
      <? foreign_relation('fsc_claim_type','id','fsc_claim',$fsc_claim,'1');?>
		 </select>
...
<label style="width:140px;">FSC Logo: </label>
	...
	<select id="fsc_logo" name="fsc_logo"  style="width:220px;" required >
        <option selected="selected"><?=$fsc_logo?></option>
...
<tr>
  <td colspan="15" align="center" bgcolor="#0073AA"><span class="style2">Technical Information</span></td>
  </tr>
<tr>

<td colspan="3" align="center" bgcolor="#0073AA"><span class="style2">Product Name </span></td>
...
<input type="hidden" id="job_no" name="job_no" value="<?=$job_no?>"  />
  ...
  <input   name="style_no" type="text" class="input3" id="style_no" style="width:60px; height:30px;" value="<?=$_POST['style_no'];?>" autocomplete="off"  required="required"  tabindex="0"/>
  </span>  </td>
  <td width="4%" align="center" ><span class="style2">
  
 
  
  <input   name="po_no" type="text" class="input3" id="po_no" style="width:50px; height:30px;" value="<?=$_POST['po_no'];?>" autocomplete="off"  required="required"  tabindex="0"/>
...
<td width="8%" align="center" ><span class="style2">
		 ...
		 <input list="destination_name" name="destination" id="destination"  style="width:80px;  height:30px;"  autocomplete="off"  required  >
  <datalist id="destination_name">

	  <? foreign_relation('destination_info','destination_name','destination_name',$_POST['destination'],'1 order by destination_name');?>
...
<input name="referance" type="text" class="input3" id="referance" style="width:60px; height:30px;" value="<?=$_POST['referance'];?>" autocomplete="off"  required="required"  tabindex="0"/>
</span></td>
<td width="6%" align="center"><span class="style2">
<input name="sku_no" type="text" class="input3" id="sku_no" style="width:60px; height:30px;"  value="<?=$_POST['sku_no'];?>" autocomplete="off"  required="required"  tabindex="0"/>
</span></td>
<td width="6%" align="center"><span class="style2">
<input name="pack_type" type="text" class="input3" id="pack_type" style="width:60px; height:30px;" value="<?=$_POST['pack_type'];?>"  autocomplete="off" />
</span></td>
<td width="7%" align="center"><span class="style2">
<input  name="color" type="text" class="input3" id="color" style="width:60px; height:30px;" value="<?=$_POST['color'];?>"  autocomplete="off"  required="required"  tabindex="0"/>
</span></td>
<td width="8%" align="center" ><span class="style2"> 


<input  name="size" type="text" class="input3" id="size" style="width:60px; height:30px;"    value="<?=$_POST['size'];?>" autocomplete="off"  tabindex="0"/>
...
<select  name="printing_info" id="printing_info"  style="width:80px; height:30px;" required>
  ...
  <option></option>
      ...
      <? foreign_relation('printing_information','id','printing_information',$_POST['printing_info'],'1');?>
		 </select>
...
<input list="additional_information" name="additional" id="additional"  style="width:100px;  height:30px;"  onchange="getData2('additional_charge_ajax.php', 'additional_filter', this.value, document.getElementById('additional').value);"  autocomplete="off"   >
  <datalist id="additional_information">

	  <? foreign_relation('additional_information','CONCAT(id, "->", additional_information)','additional_information',$_POST['additional'],
	  'dealer_code="'.$dealer_code.'" and buyer_code="'.$buyer_code.'" order by additional_information');?>
...
<select  name="measurement_unit" id="measurement_unit"  style="width:60px; height:30px;" required>
      ...
      <? foreign_relation('measurement_unit','unit_name','unit_name',$_POST['measurement_unit'],'1');?>
		 </select>
</span>
...
<tr bgcolor="#CCCCCC">
  <td width="4%" align="center"><span class="style2">
<input   name="L_cm" type="text" class="input3" id="L_cm" style="width:40px; height:30px;"  value="<?=$_POST['L_cm'];?>"  autocomplete="off"  required="required"  onchange="count_formula()" tabindex="0"/>
</span></td>


  <td width="4%" align="center">
  <span class="style2">
<input  name="W_cm" type="text" class="input3" id="W_cm" style="width:40px; height:30px;"  value="<?=$_POST['W_cm'];?>"  autocomplete="off"  required="required"  onchange="count_formula()" tabindex="0"/>
</span>  </td>
  <td width="8%" align="center">
  <span class="style2">
<input name="H_cm" type="text" class="input3" id="H_cm" style="width:40px; height:30px;"  value="<?=$_POST['H_cm'];?>"  autocomplete="off"  required="required" onchange="count_formula()" tabindex="0"/>
...
<select  name="ply" id="ply"  style="width:50px; height:30px;" required>
  ...
  <option></option>
      ...
      <? foreign_relation('paper_ply','ply','paper_ply',$_POST['ply'],'1');?>
		 </select>
</span></td>
...
<tr bgcolor="#CCCCCC">
	<td> <input name="WL" type="text" class="input3" id="WL" style="width:40px; height:30px;" required="required" onchange="count_formula()" tabindex="0"/></td>
	<td>  <input name="WW" type="text" class="input3" id="WW" style="width:40px; height:30px;" required="required" onchange="count_formula()" tabindex="0"/></td>
</tr>
</table>
</span></span></td>
...
<td width="7%" align="center"><span class="style2">
		 ...
		 <input list="paper_combination" name="combination" id="combination"  style="width:185px;  height:30px;"  onchange="getData2('sqm_rate_ajax.php', 'sqm_filter', this.value, document.getElementById('combination').value);"  autocomplete="off"  required  >
  <datalist id="paper_combination">
	  ...
	  'dealer_code="'.$dealer_code.'" and buyer_code="'.$buyer_code.'" order by paper_combination');?>
...
<td width="8%" align="center">
<span class="style2"><input name="final_price" type="hidden"  readonly="" class="input3" id="final_price" style="width:65px; height:30px;" onchange="count_formula()" />
<input name="unit_price" type="text" class="input3" id="unit_price" readonly=""  style="width:65px; height:30px;" onchange="count_formula()" />
 </span></td>
<td width="8%" align="center">
<span class="style2"> 
<input placeholder="Total Amt" name="total_amt" type="text" class="input3" id="total_amt" style="width:90px; height:30px;" />
</span></td>
<td width="5%" align="center">

<span class="style2">
<select  name="delivery_place" id="delivery_place"  style="width:120px; height:30px;" required="required">
    <option></option>
    <? foreign_relation('delivery_place_info','id','delivery_place',$delivery_place,'dealer_code="'.$dealer_code.'"');?>
  </select> </span></td>
<td width="6%" align="center">
<span class="style2">
 <input  name="delivery_date" type="text" class="input3" id="delivery_date" style="width:90px; height:30px;" value="<?=$_POST['delivery_date'];?>" onchange="count_formula()" />
</span></td>
</tr>
...
//, (a.init_pkt_unit*a.unit_price) as Total,(a.init_pkt_unit-a.inStock_ctn) as Shortage
  ...
  $res='select a.id, a.item_id, s.sub_group_name,  b.item_name, a.additional_info, a.printing_info, a.edit_request,  a.ply, a.paper_combination, a.L_cm, a.W_cm, a.H_cm, a.measurement_unit, a.unit_price, a.total_unit, a.total_amt from sale_do_details a, item_info b, item_sub_group s where b.item_id=a.item_id  and b.sub_group_id=s.sub_group_id and a.do_no='.$$unique_master.' order by a.id';
...
<input type="hidden" name="<?='edit_request#'.$data->id?>" id="<?='edit_request#'.$data->id?>" value="<?=$data->edit_request?>" readonly=""    style="width:80px; height:20px;"/>

<?
$do_production = find_a_field('sale_do_production_issue','sum(total_unit)','order_no='.$data->id);
if ($do_production>0) {
 $do_edit_approval = 1;
}else{
 $do_edit_approval = 0;
...
<span id="ppp<?=$data->id?>"><? if ($data->edit_request==0 && $do_edit_approval==0) {?><input name="<?='edit#'.$data->id?>" type="button" id="Edit" value="Request" style="width:100px; height:30px; color:#000; font-weight:700" onclick="update_edit(<?=$data->id?>);start(this);"  /> <? }?>
<? if ($data->edit_request==1) {?>
<input name="" type="button" id="Edit" value="Pending" style="width:100px; height:30px; background:#FF0000; color:#000; font-weight:700"   /> 
<? }?>

<? if ($data->edit_request==2) {?>
<input name="" type="button" id="Edit" value="Accepted" style="width:100px; background:green; height:30px; color:#000; font-weight:700"   /> 
<? }?>
</span></td>
<td><? if($do_edit_approval==0) {?> <a href="?del=<?=$data->id?>">X</a><? }?></td>
</tr>
...
<form action="confirm_all_edit_request.php" method="post" name="cz" id="cz" onSubmit="if(!confirm('Are You Sure Execute this?')){return false;}">
...
<input name="confirm" type="submit" class="btn1" value="REQUEST ALL" style="width:270px; font-weight:bold; font-size:12px; height:30px; color:#090; float:right" />
