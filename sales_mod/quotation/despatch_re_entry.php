...
if(isset($_POST['confirmm']))
{
		...
		$_POST[$unique]=$$unique;
		$_POST['re_entry_by']=$_SESSION['user']['id'];
		$_POST['re_entry_at']=date('Y-m-d h:s:i');
...
<? $field='warehouse_to'; $table='warehouse';$get_field='warehouse_id';$show_field='warehouse_name';?>
      <div>
		...
		<input name="warehouse_to" type="hidden" id="warehouse_to" value="<?=$$field?>" />
		<input name="warehouse_to2" type="text" id="warehouse_to2" value="<?=find_a_field('warehouse','warehouse_name','warehouse_id='.$$field)?>" readonly="" />
      </div>
    <? $field='need_by';?>
      <div>
...
<input  name="item_id" type="text" id="item_id" value="<?=$item_id?>" style="width:350px;" required="required" onblur="getData2('mr_ajax.php', 'mr', this.value, document.getElementById('warehouse_id').value);"/></td>
...
<td align="center" bgcolor="#CCCCCC"><input name="qty_ctn" type="text" class="input3" id="qty_ctn"  maxlength="100" style="width:120px;" required/></td>
      </tr>
    </table>
<br /><br /><br /><br />
<? 
...
<form action="" method="post" name="cz" id="cz" onSubmit="if(!confirm('Are You Sure Execute this?')){return false;}">
  <table width="100%" border="0">
    <tr>
      ...
      <input name="confirmm" type="submit" class="btn1" value="CONFIRM AND FORWARD REQUSITION" style="width:300px; float:right; font-weight:bold; font-size:12px; height:30px; color:#090" />
