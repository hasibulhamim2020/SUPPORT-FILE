...
$title='Approving Spare Parts Requisition';
...
<select  name="group_for" id="group_for" required>
	...
	<option></option>
      ...
      <div> 
        <label for="<?=$field?>">From Warehouse:</label>
...
<select  name="warehouse_id" id="warehouse_id" required>
	...
	<option></option>
      ...
      <? foreign_relation('warehouse','warehouse_id','warehouse_name',$warehouse_id,'use_type = "PL" order by warehouse_id');?>
		 </select>
      ...
      <div> 
        <label for="<?=$field?>">To Warehouse:</label>
...
<td>&nbsp;
  <?=$data->unit_name?></td>
<td>&nbsp;
  <?=find_a_field('machine_info','machine_short_name','machine_id='.$data->machine_id)?></td>
